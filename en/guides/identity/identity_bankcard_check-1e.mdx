...
To use Bank Card Basic Information Query API, first open the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) and copy your API Token.
...
> 📘 Full documentation: [Bank Card Basic Information Query API →](https://platform.acedata.cloud/documents/identity-bankcard-check-1e)
