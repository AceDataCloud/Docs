---
title: "Bank Card Three Elements Verification API Integration Instructions"
...
To use the API, you need to first apply for the corresponding service on the [Bank Card Three Elements Verification API](https://platform.acedata.cloud/documents/eb9c6677-68db-4549-a207-41f8a1084634) page. After entering the page, click the "Acquire" button, as shown in the image:
...
It can be seen that the authenticity and consistency of the bank card number, name, and account document number information have passed.
...
Through this document, you have learned how to use the Bank Card Three Elements Verification API to verify the authenticity and consistency of bank card number, name, and account document number information. We hope this document can help you better integrate and use the API. If you have any questions, please feel free to contact our technical support team.
