...
To use Bank Card Three Elements Verification API, first open the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) and copy your API Token.
...
> 📘 Full documentation: [Bank Card Three Elements Verification API →](https://platform.acedata.cloud/documents/identity-bankcard-check-3e)
