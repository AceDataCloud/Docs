...
To use ID Card Portrait Photo Verification API, first open the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) and copy your API Token.
...
> 📘 Full documentation: [ID Card Portrait Photo Verification API →](https://platform.acedata.cloud/documents/identity-idcard-check-1e)
