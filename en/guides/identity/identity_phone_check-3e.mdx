...
To use Mobile Number Three Elements Verification API, first open the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) and copy your API Token.
...
> 📘 Full documentation: [Mobile Number Three Elements Verification API →](https://platform.acedata.cloud/documents/identity-phone-check-3e)
