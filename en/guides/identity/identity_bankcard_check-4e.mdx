...
This article will introduce a Bank Card Four Elements Verification API integration guide, which can be used to input bank card number, name, account document number, and account phone number to verify the authenticity and consistency of the information.

## Application Process

To use the Bank Card Four Elements Verification API, first go to the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) to obtain your API Token for future use.
...
> 📘 Complete documentation: [Bank Card Four Elements Verification API →](https://platform.acedata.cloud/documents/identity-bankcard-check-4e)
...
- `encryption`: optional, sensitive field encryption parameter (if encrypted text needs to be sent).
...
Through this document, you have learned how to use the Bank Card Four Elements Verification API for inputting bank card number, name, account document number, and account phone number to verify the authenticity and consistency of the information. We hope this document can help you better integrate and use this API. If you have any questions, please feel free to contact our technical support team.
