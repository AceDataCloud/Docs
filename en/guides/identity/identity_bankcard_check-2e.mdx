...
To use the Bank Card Two-Factor Verification API, first go to the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) to obtain your API Token for future use.
...
> 📘 Complete documentation: [Bank Card Two-Factor Verification API →](https://platform.acedata.cloud/documents/identity-bankcard-check-2e)
...
It can be seen that the authenticity and consistency of the name and bank card number of this bank card have passed.
...
Through this document, you have learned how to use the Bank Card Two-Factor Verification API to verify the authenticity and consistency of names and bank card numbers. We hope this document can help you better integrate and use this API. If you have any questions, please feel free to contact our technical support team.
