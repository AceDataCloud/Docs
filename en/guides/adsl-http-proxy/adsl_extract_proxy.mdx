...
description: "ADSL Direct Connection Proxy integration guide - Ace Data Cloud"
---
...
To use the extraction of ADSL IPs and add IPs to the ADSL Proxy whitelist, you can first go to the [ADSL Proxy Extract API](https://platform.acedata.cloud/documents/adsl-extract) and [ADSL Proxy Whitelist API](https://platform.acedata.cloud/documents/adsl-whitelist) pages and click the "Acquire" button to obtain the credentials needed for the request:
...
Next, you can fill in the corresponding content on the [ADSL Proxy Extract API](https://platform.acedata.cloud/documents/adsl-extract) interface. Below is a demonstration of how to extract ADSL IPs.
