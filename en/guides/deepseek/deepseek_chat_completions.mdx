...
description: "DeepSeek AI integration guide - Ace Data Cloud"
---
...
To use DeepSeek Chat Completion API, first open the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) and copy your API Token.
...
> 📘 Full documentation: [DeepSeek Chat Completion API →](https://platform.acedata.cloud/documents/deepseek-chat-completions)
