...
To use Producer Audios Generation API, first open the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) and copy your API Token.
...
If you want to continue writing a song that you uploaded, you can set the `action` parameter to `upload_extend` and input the ID of the song you want to continue writing. The song ID can be obtained using the [Producer Upload API](https://platform.acedata.cloud/documents/producer-upload), as shown in the image below:
...
If you want to continue replacing a section of a song you uploaded, you can set the `action` parameter to `upload_replace_section` and input the ID of the song you need to continue writing. The song ID can be obtained using the [Producer Upload API](https://platform.acedata.cloud/documents/producer-upload), as shown in the image below:
