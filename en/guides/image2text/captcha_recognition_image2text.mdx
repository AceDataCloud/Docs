...
Then we need to convert the captcha image to a Base64 encoded captcha image. It is recommended to use the Google Chrome extension FeHelper for the conversion. The specific usage method can refer to the following images:
