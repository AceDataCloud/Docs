...
To use Midjourney Translate API, first open the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) and copy your API Token.
...
> 📘 Full documentation: [Midjourney Translate API →](https://platform.acedata.cloud/documents/e067d19b-7a66-4458-a45f-0fe88c1d5d34)
