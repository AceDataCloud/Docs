...
- `started_at`, `finished_at`: the time (ISO-8601 UTC) when this request started processing and produced results.
- `elapsed`: the total time taken for this processing (in seconds).
