---
title: "CAPTCHA Task Query API (Server-side Asynchronous Task) Integration Instructions"
...
- `elapsed`, the time taken for task processing, in seconds (float, rounded to 3 decimal places). This field will not be returned while still processing.
