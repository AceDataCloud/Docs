...
1. Confirm that the environment variables are set correctly (in `~/.claude/settings.json` or your Shell configuration file)
2. Confirm that the API token is valid (can be viewed in the [console](https://platform.acedata.cloud/console))
3. Ensure network access to `https://api.acedata.cloud`
