...
| Version | model           | Launch Date   | prompt Limit | lyric Limit | style Limit | Maximum Song Duration |
| ------- | --------------- | -------------- | ------------ | ----------- | ----------- | --------------------- |
...
| v4      | chirp-v4        | 2024.12.17     | 200          | 3000        | 200         | 150 seconds           |
| v3.5    | chirp-v3-5      | ---            | 200          | 3000        | 200         | 120 seconds           |
