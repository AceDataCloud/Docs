...
SUNO allows us to perform secondary creation on generated music, obtaining lyrics and audio timelines. This document explains how to integrate the related API.
...
An excerpt of the result is as follows:
