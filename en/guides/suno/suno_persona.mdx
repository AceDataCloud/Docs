...
Here, the `audio_id` we input is `https://cdn.acedata.cloud/2qhzs3.png`, which can refer to the [Suno Audios Generation API](https://platform.acedata.cloud/documents/suno-audios) for custom song generation, and finally obtain the `audio_id`.
