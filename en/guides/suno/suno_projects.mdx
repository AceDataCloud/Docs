...
| `retrieve`         | Sync  | Read the project and the complete editable `state` |
| `save`             | Sync  | Save the complete project state              |
| `upload`           | Async | Initialize an asset that can be added to a project from an HTTPS audio URL |
...
| `commit_candidate` | Async | Commit the selected candidate to a project   |
| `remove_track`     | Sync  | Delete a specified track                     |
