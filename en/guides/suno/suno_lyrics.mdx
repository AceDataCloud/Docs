---
title: "Suno Lyrics Generation API Integration Guide"
description: "Suno Music Generation Integration Guide - Ace Data Cloud"
---

If you want to customize song creation but don't want to write lyrics yourself, you can use the lyrics generation API provided by AceDataCloud to generate lyrics through prompts. The API is the [Suno Lyrics Generation API](https://platform.acedata.cloud/documents/514d82dc-f7ab-4638-9f21-8b9275916b08).

The main input parameter for this API is `prompt`, with an optional `model` (default is chirp-v3). An example input is as follows:
...
Once you have the lyrics, you can use the [Suno Audios Generation API](https://platform.acedata.cloud/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) to generate custom songs.