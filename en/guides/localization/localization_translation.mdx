...
To use Localization Translate API, first open the [Ace Data Cloud Console](https://platform.acedata.cloud/console/applications) and copy your API Token.
...
> 📘 Full documentation: [Localization Translate API →](https://platform.acedata.cloud/documents/localization-translate)
