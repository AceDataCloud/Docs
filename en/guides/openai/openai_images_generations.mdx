...
The `callback_url` asynchronous callback mechanism is equally effective for nano-banana, and the calling process is completely consistent with other models. For details, see the section [Asynchronous Callback](#asynchronous-callback) below.
