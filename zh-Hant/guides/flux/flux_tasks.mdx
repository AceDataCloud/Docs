...
要使用 Flux Tasks API，需要先到 申請頁面 [Flux Images Generation API ](https://platform.acedata.cloud/documents/flux-images)申請相應的服務，然後複製 Flux Images Generation API的任務ID，如圖所示：

<p><img src="https://cdn.acedata.cloud/7furhb.png" width="500" className="m-auto" /></p>

最後進入Flux Tasks API頁面 [Flux Tasks API ](https://platform.acedata.cloud/documents/flux-tasks)申請相應的服務，進入頁面之後，點擊「Acquire」按鈕，如圖所示
