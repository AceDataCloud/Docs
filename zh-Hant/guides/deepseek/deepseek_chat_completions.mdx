...
要使用 DeepSeek Chat Completion API，首先可以到 [DeepSeek Chat Completion API](https://platform.acedata.cloud/documents/deepseek-chat-completions) 頁面點擊「Acquire」按鈕，獲取請求所需要的憑證：
