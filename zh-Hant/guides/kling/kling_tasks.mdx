...
Kling Tasks API 可以用於查詢 Kling Videos Generation API 的結果。關於怎樣使用 Kling Videos Generation API，請參考文檔 [Kling Videos Generation API ](https://platform.acedata.cloud/documents/kling-videos)。

我們以 Kling Videos Generation API 服務返回的任務ID一個為例，演示如何使用該 API。假設我們有一個任務ID：20068983-0cc9-4c6a-aeb6-9c6a3c668be0，接下來演示如何通過傳入一個任務ID來。
