...
payload = {
    "model": "gpt-image-2",
    "prompt": "一个由三层架子组成的木制书架：在顶层，应该有一本书。在第二层，应该有三本书。在底层，应该有七本书。柔和的暖光，照片真实感，舒适的图书馆氛围。",
    "size": "1024x1024"
}
```
...
```json
{
  ...
  "data": [
    {
      "revised_prompt": "一隻可愛的海獺寶寶在水中愉快地躺著，牠的毛看起來光滑而柔軟。牠的一隻小爪子好奇地伸出，臉上流露出純粹的喜悅和溫暖，仰望著天空。牠的身體周圍有泡泡，因為牠在水中快樂地旋轉。微風輕拂著牠的毛，使牠看起來更加迷人。這個場景描繪了海洋生物的寧靜與魅力。",
...
```json
{
  ...
  "data": [
    {
      "revised_prompt": "一幅迷人的小海獺描绘。海獺安静地仰卧在温柔的蓝色海浪中。小海獺的毛发是柔和的灰棕色混合，微微在柔和的阳光下闪烁。它的小爪子轻轻抬起，似乎在与看不见的物体玩耍。它圆圆的、富有表现力的眼睛充满好奇，闪烁着生命和纯真的光芒。使用现实主义风格来唤起海獺的自然栖息地和它可爱的毛茸茸的外表。",
