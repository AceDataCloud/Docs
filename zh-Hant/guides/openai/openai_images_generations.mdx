...
提示詞中可以使用電影術語（35mm 膠片、淺景深、霓虹光等）來精確控制氛圍與質感。
...
```json
{
  ...
  "data": [
    {
      "revised_prompt": "一隻可愛的海獺寶寶正愉快地躺在水中，毛發看起來光滑柔軟。它的一隻小爪子好奇地伸出，臉上帶著純真的喜悅和溫暖的表情，仰望著天空。它的身體周圍環繞著因為在水中嬉戲而產生的泡泡。微風輕拂著它的毛發，使它看起來更加迷人。這個場景描繪了海洋生物的寧靜與魅力。",
