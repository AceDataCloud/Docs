...
要使用 OpenAI Chat Completion API，首先可以到 [OpenAI Chat Completion API](https://platform.acedata.cloud/documents/openai-chat-completions) 頁面點擊「Acquire」按鈕，獲取請求所需要的憑證：
