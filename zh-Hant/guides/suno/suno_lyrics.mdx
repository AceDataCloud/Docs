...
如果你想自訂生成歌曲，但又不太想自己編寫歌詞，可以使用 AceDataCloud 提供的歌詞生成 API 來透過 prompt 生成歌詞，API 是 [Suno Lyrics Generation API](https://platform.acedata.cloud/documents/suno-lyrics)。
