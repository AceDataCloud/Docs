...
- `duration`：期望的歌曲時長，單位秒，需為整數，通常建議在 10 到 360 之間。該參數主要用於自定義模式（`custom` 為 `true`）的歌曲生成，部分模型或操作可能不支持，此時該值會被忽略或返回錯誤。這是目標時長，實際成品時長以響應中的 `duration` 字段為準，可能有小幅偏差。
...
> ⚠️ **注意**：`replace_section` 單獨使用時**只會返回新生成的"替換片段"本身**（即被替換那一段的新音頻，時長大約等於 `replace_section_end - replace_section_start`，並附帶少量上下文），**並並不會返回拼接好的整首歌曲**。要得到與原曲拼接後的完整成品，需要在 `replace_section` 成功後，針對返回的片段 ID 再發起一次 [音樂拼接](#音樂拼接) 任務。完整流程見下文。
...
可以看到返回的兩條音頻時長（45.16 秒、33.8 秒）遠短於原曲（94.12 秒），它們就是替換片段本身（包含一點點前後上下文用於過渡），並**不是**整首拼接後的歌曲。從兩條候選中挑選一條滿意的即可，下一步就基於這條片段做拼接。
...
需要注意的是，請求中的 `duration` 是**期望時長**，而響應 `data` 中每首歌曲的 `duration` 字段是該首歌曲的**實際時長**。兩者名稱相同但含義不同：`duration` 是一個傾向性提示而非硬性約束，模型會參考它但不保證達到，實測中實際時長通常短於期望值，同一次請求返回的兩首歌曲時長也可能相差較大。歌詞長度、風格和模型都會影響最終成品，若需要較長的成品，建議同時提供更完整的歌詞。
...
{"success":true,"task_id":"1af4b454-ce84-4512-a0a2-de3f8574ecd8","trace_id":"4440342a-41c4-4140-8bb1-3537a598ca2e","data":[{"id":"1f610752-f426-4fd5-89a8-ba2ad0370881","title":"雪花與槲寄生","image_url":"https://cdn2.suno.ai/image_1f610752-f426-4fd5-89a8-ba2ad0370881.jpeg","image_large_url":"https://cdn2.suno.ai/image_large_1f610752-f426-4fd5-89a8-ba2ad0370881.jpeg","lyric":"[Verse]\n燈飾又纏在樹上\n貓咪把花環弄翻了\n餅乾在烤箱裡燒焦了\n但我仍然咧嘴笑著\n[Prechorus]\n雪花像閃光粉一樣在空中飄落\n我有種感覺，今年會過得很快\n[Chorus]\n雪花與槲寄生\n無論我走到哪裡\n我知道\n愛是禮物\n那光芒\n雪花與槲寄生\n[Verse 2]\n奶奶唱得有點跑調\n孩子們笑得太大聲\n狗狗偷了一隻火雞腿\n混亂是一個聖誕人潮\n[Prechorus]\n但火爐在噼啪作響\n溫暖而明亮\n而我的心今晚是一支蠟燭\n[Chorus]\n雪花與槲寄生\n無論我走到哪裡\n我知道\n愛是禮物\n那光芒\n雪花與槲寄生","audio_url":"https://cdn1.suno.ai/1f610752-f426-4fd5-89a8-ba2ad0370881.mp3","video_url":"","created_at":"2025-12-13T11:29:25.101Z","model":"chirp-v5","state":"succeeded","prompt":"一首聖誕歌曲","style":"振奮人心，管弦樂伴隨鈴聲和木吉他","duration":129.92},{"id":"d1a3109d-799b-401e-b032-4b501bcf26f3","title":"雪花與槲寄生","image_url":"https://cdn2.suno.ai/image_d1a3109d-799b-401e-b032-4b501bcf26f3.jpeg","image_large_url":"https://cdn2.suno.ai/image_large_d1a3109d-799b-401e-b032-4b501bcf26f3.jpeg","lyric":"[Verse]\n燈飾又纏在樹上\n貓咪把花環弄翻了\n餅乾在烤箱裡燒焦了\n但我仍然咧嘴笑著\n[Prechorus]\n雪花像閃光粉一樣在空中飄落\n我有種感覺，今年會過得很快\n[Chorus]\n雪花與槲寄生\n無論我走到哪裡\n我知道\n愛是禮物\n那光芒\n雪花與槲寄生\n[Verse 2]\n奶奶唱得有點跑調\n孩子們笑得太大聲\n狗狗偷了一隻火雞腿\n混亂是一個聖誕人潮\n[Prechorus]\n但火爐在噼啪作響\n溫暖而明亮\n而我的心今晚是一支蠟燭\n[Chorus]\n雪花與槲寄生\n無論我走到哪裡\n我知道\n愛是禮物\n那光芒\n雪花與槲寄生","audio_url":"https://cdn1.suno.ai/d1a3109d-799b-401e-b032-4b501bcf26f3.mp3","video_url":"","created_at":"2025-12-13T11:29:25.101Z","model":"chirp-v5","state":"succeeded","prompt":"一首聖誕歌曲","style":"振奮人心，管弦樂伴隨鈴聲和木吉他","duration":127.16}]}
