...
Suno Tasks API 可以用於查詢 Suno Audios Generation API 和 Suno Lyrics Generation API 兩個 API 的結果。關於怎樣使用 Suno Audios Generation API，請參考文檔 [Suno Audios Generation API ](https://platform.acedata.cloud/documents/suno-audios-integration)。關於怎樣使用 Suno Lyrics Generation API，請參考 [Suno Lyrics Generation API ](https://platform.acedata.cloud/documents/suno-lyrics-generation-integration)。
