...
要使用 Luma Tasks API，需要先到 申請頁面 [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) 申請相應的服務，然後複製 Luma Videos Generation API 的任務ID，如圖所示：

![](https://cdn.acedata.cloud/ynk4ow.png)

最後進入 Tasks API 頁面 [Luma Tasks API](https://platform.acedata.cloud/documents/luma-tasks) 申請相應的服務，進入頁面之後，點擊「Acquire」按鈕，如圖所示：
