...
要使用 API，需要先到 [AI Chat v2 API](https://platform.acedata.cloud/documents/aichat2-conversations) 對應頁面申請對應的服務，進入頁面之後，點擊「Acquire」按鈕即可獲取請求所需要的憑證。
...
如果你已經在使用 [`/aichat/conversations`](https://platform.acedata.cloud/documents/aichat-conversations)，遷移到 v2 幾乎不需要改程式碼：
