...
使用前，請在 Ace Data Cloud 平台中進入 [Nano Banana Images API](https://platform.acedata.cloud/documents/nano-banana-images) 並點擊 Acquire 申請開通。首次申請通常會有免費額度可用。開通完成後，即可在平台中獲取到用於調用 API 的 Bearer Token。
