...
要使用 Midjourney Describe API，需要先到 申請頁面 [Midjourney Describe API ](https://platform.acedata.cloud/documents/midjourney-describe)申請相應的服務，進入頁面之後，點擊「Acquire」按鈕，如圖所示：
