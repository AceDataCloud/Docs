...
要使用 Midjourney Translate API，需要先到 申請頁面 [Midjourney Translate API ](https://platform.acedata.cloud/documents/midjourney-translate)申請相應的服務，進入頁面之後，點擊「Acquire」按鈕，如圖所示：
