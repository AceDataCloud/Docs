...
要使用 銀行卡三要素核驗 API，首先到 [Ace Data Cloud 控制台](https://platform.acedata.cloud/console/applications) 獲取您的 API Token，留作備用。
...
> 📘 完整文檔：[銀行卡三要素核驗 API →](https://platform.acedata.cloud/documents/identity-bankcard-check-3e)
