...
要使用 銀行卡基礎信息查詢 API，首先到 [Ace Data Cloud 控制台](https://platform.acedata.cloud/console/applications) 獲取您的 API Token，留作備用。
...
> 📘 完整文檔：[銀行卡基礎信息查詢 API →](https://platform.acedata.cloud/documents/identity-bankcard-check-1e)

## 基本使用

首先先了解下基本的使用方式，就是輸入銀行卡號碼，便可獲得處理後驗證結果，首先需要簡單地傳遞一個 `bank_card` 字段，我們接下來就可以在界面上填寫對應的內容，如圖所示：
