...
要使用 Wan Tasks API，需要先到 申請頁面 [Wan Videos Generation API](https://platform.acedata.cloud/documents/wan-videos) 申請相應的服務，然後複製 Wan Videos Generation API 的任務ID，如圖所示：

<p><img src="https://cdn.acedata.cloud/om6p6g.png" width="500" className="m-auto" /></p>

最後進入 Tasks API 頁面 [Wan Tasks API](https://platform.acedata.cloud/documents/wan-tasks) 申請相應的服務，進入頁面之後，點擊「Acquire」按鈕，如圖所示：
