...
Gemini Tasks API 的主要功能是通過輸入 Gemini Videos Generation API 生成的任務 ID 來查詢該任務的執行情況。

本文檔將詳細介紹 Gemini Tasks API 的對接說明，幫助您輕鬆集成並查詢 Gemini Videos Generation API 的任務執行情況。
