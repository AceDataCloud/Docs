...
Se você deseja continuar cantando uma música que você enviou, pode definir o parâmetro `action` como `upload_cover` e inserir o ID da música que precisa continuar cantando. O ID da música pode ser obtido usando a [API de Upload do Produtor](https://platform.acedata.cloud/documents/producer-upload), como mostrado na imagem abaixo:
...
Se você quiser continuar a música que enviou, pode definir o parâmetro `action` como `upload_extend` e inserir o ID da música que deseja continuar. O ID da música pode ser obtido usando a [API de Upload do Produtor](https://platform.acedata.cloud/documents/producer-upload), conforme mostrado na imagem abaixo:
