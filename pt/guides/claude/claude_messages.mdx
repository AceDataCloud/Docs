...
Para usar a API Claude Messages, primeiro você pode acessar a página [Claude Messages API](https://platform.acedata.cloud/documents/claude-chat-completions) e clicar no botão "Acquire" para obter as credenciais necessárias para a solicitação:
