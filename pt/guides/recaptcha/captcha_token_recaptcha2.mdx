...
Para usar a API, é necessário primeiro acessar a página correspondente da [API de Reconhecimento do Protocolo Recaptcha2](https://platform.acedata.cloud/documents/captcha-token-recaptcha2) para solicitar o serviço correspondente. Ao entrar na página, clique no botão "Adquirir", conforme mostrado na imagem:
