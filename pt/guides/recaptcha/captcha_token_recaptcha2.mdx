...
Este documento irá apresentar uma integração da API de reconhecimento do protocolo Recaptcha2, que permite aos usuários evitar a identificação e seleção de imagens de captcha do Recaptcha2, bastando enviar a Chave do Site para realizar a decodificação automática em segundo plano e completar a verificação.
...
Primeiro, entenda a forma básica de uso, que consiste em inserir a URL do site que precisa processar o captcha, e você poderá obter o resultado processado. Primeiro, é necessário passar um campo `website_url`, nosso site de exemplo é: `https://www.google.com/recaptcha/api2/demo`, precisamos obter a `website_key` na página `website_url`, para isso, abra esta página, pressione F12 para acessar o console e, em seguida, faça uma busca global na página Element por `recaptcha-demo`, e podemos obter o seguinte resultado:
