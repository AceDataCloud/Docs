...
- `started_at`, `finished_at`: os horários de início e término do processamento desta solicitação (ISO-8601 UTC).
- `elapsed`: o tempo total gasto para este processamento (em segundos).
