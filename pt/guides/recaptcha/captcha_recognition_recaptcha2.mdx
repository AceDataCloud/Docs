...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Reconhecimento de Imagem Recaptcha2](https://platform.acedata.cloud/documents/captcha-recognition-recaptcha2) para solicitar o serviço correspondente. Após acessar a página, clique no botão "Acquire", como mostrado na imagem abaixo:
