...
Para usar a API DeepSeek Chat Completion, primeiro você pode acessar a página [DeepSeek Chat Completion API](https://platform.acedata.cloud/documents/deepseek-chat-completions) e clicar no botão "Acquire" para obter as credenciais necessárias para a solicitação:
