...
- `extension`: forma personalizada de apresentação do resultado da tradução.
...
Através deste documento, você aprendeu como usar a API de Tradução de Localização para traduzir facilmente o texto de entrada para um idioma específico, além de suportar formas específicas de apresentar os resultados da tradução. Esperamos que este documento ajude você a integrar e usar melhor essa API. Se tiver alguma dúvida, entre em contato com nossa equipe de suporte técnico.
