...
Para usar a API de Vídeos da Luma, primeiro você pode acessar a página [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) e clicar no botão "Acquire" para obter as credenciais necessárias para a solicitação:
