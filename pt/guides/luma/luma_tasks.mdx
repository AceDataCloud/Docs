...
Para usar a API Luma Tasks, você precisa primeiro ir à página de solicitação [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) para solicitar o serviço correspondente e, em seguida, copiar o ID da tarefa da API Luma Videos Generation, como mostrado na imagem:

![](https://cdn.acedata.cloud/ynk4ow.png)

Por fim, acesse a página da API Tasks [Luma Tasks API](https://platform.acedata.cloud/documents/luma-tasks) para solicitar o serviço correspondente. Após acessar a página, clique no botão "Acquire", como mostrado na imagem:
...
A API Luma Tasks pode ser usada para consultar os resultados da API Luma Videos Generation. Para saber como usar a API Luma Videos Generation, consulte o documento [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos-integration).
