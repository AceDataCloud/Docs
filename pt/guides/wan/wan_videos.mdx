...
Para usar a API, você precisa primeiro acessar a página correspondente da [Wan Videos Generation API](https://platform.acedata.cloud/documents/wan-videos) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Acquire", conforme mostrado na imagem:
