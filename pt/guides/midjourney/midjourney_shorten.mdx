...
Para usar a API Midjourney Shorten, é necessário solicitar o serviço na página [Midjourney Shorten API](https://platform.acedata.cloud/documents/midjourney-shorten). Ao acessar a página, clique no botão "Acquire".
