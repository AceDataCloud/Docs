...
Para usar a API Midjourney Describe, você precisa primeiro ir à página de solicitação [Midjourney Describe API](https://platform.acedata.cloud/documents/midjourney-describe) para solicitar o serviço correspondente. Ao entrar na página, clique no botão "Acquire", conforme mostrado na imagem:
