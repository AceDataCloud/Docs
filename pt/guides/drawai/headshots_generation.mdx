...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Criação de Fotos de Identidade com IA](https://platform.acedata.cloud/documents/headshots-generate) e solicitar o serviço desejado. Após acessar a página, clique no botão "Acquire", conforme mostrado na imagem:
