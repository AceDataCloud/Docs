...
Para usar a API, é necessário solicitar o serviço correspondente na página [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos). Após acessar, clique no botão "Acquire", conforme mostrado:
