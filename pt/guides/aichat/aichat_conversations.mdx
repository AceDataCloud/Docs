...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Perguntas e Respostas](https://platform.acedata.cloud/documents/aichat-conversations) e solicitar o serviço correspondente. Após entrar na página, clique no botão "Acquire", conforme mostrado na imagem:
