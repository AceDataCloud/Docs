...
Para usar a API Flux Images Generation, primeiro acesse o [console Ace Data Cloud](https://platform.acedata.cloud/console/applications) para obter seu Token de API, que deve ser guardado para uso futuro.
...
Esta operação é para consultar detalhes de tarefas de imagem para vários IDs de tarefa, diferentemente do anterior, onde a ação deve ser selecionada como retrieve_batch.
