...
Para usar a API Flux Tasks, você precisa primeiro ir à página de solicitação [Flux Images Generation API](https://platform.acedata.cloud/documents/flux-images) para solicitar o serviço correspondente e, em seguida, copiar o ID da tarefa da API Flux Images Generation, como mostrado na imagem:

<p><img src="https://cdn.acedata.cloud/7furhb.png" width="500" className="m-auto" /></p>

Por fim, acesse a página da API Flux Tasks [Flux Tasks API](https://platform.acedata.cloud/documents/flux-tasks) para solicitar o serviço correspondente. Após acessar a página, clique no botão "Acquire", como mostrado na imagem.
