...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Geração de Imagens Flux](https://platform.acedata.cloud/documents/flux-images) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Adquirir", conforme mostrado na imagem:
