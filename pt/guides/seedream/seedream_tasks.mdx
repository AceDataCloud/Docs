...
Esta operação é para consultar detalhes de várias IDs de tarefa, diferindo do acima, pois é necessário selecionar a ação como retrieve_batch.
...
- `items`，批量任务的所有具体详情信息。Ele é um array, cada elemento do array tem o mesmo formato do resultado de consulta de uma única tarefa.
- `count`，此处批量查询任务的个数。
