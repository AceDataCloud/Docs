...
Para usar a API, você precisa primeiro solicitar o serviço correspondente na página da [API de Geração de Movimento Kling](https://platform.acedata.cloud/documents/kling-motion). Após acessar a página, clique no botão "Adquirir", conforme mostrado na imagem:
