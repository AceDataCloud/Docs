...
Para usar a API, é necessário solicitar o serviço na página correspondente do [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos). Ao acessar a página, clique no botão "Acquire", conforme mostrado na imagem:
