...
Para usar a API OpenAI Embeddings, primeiro você pode acessar a página [OpenAI Embeddings API](https://platform.acedata.cloud/documents/openai-embeddings) e clicar no botão "Acquire" para obter as credenciais necessárias para a solicitação:
