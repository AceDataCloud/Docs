...
Para usar a OpenAI Images Edits API, acesse a página [OpenAI Images Edits API](https://platform.acedata.cloud/documents/251f1efa-aaa6-462e-8af4-66854b1bc94d) e clique no botão "Acquire" para obter as credenciais necessárias para as requisições:
