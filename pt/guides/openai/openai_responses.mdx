...
Para usar a API de Respostas da OpenAI, primeiro você pode acessar a página [API de Respostas da OpenAI](https://platform.acedata.cloud/documents/openai-responses) e clicar no botão "Adquirir" para obter as credenciais necessárias para a solicitação:
