...
Para usar a API OpenAI Chat Completion, primeiro você pode acessar a página [OpenAI Chat Completion API](https://platform.acedata.cloud/documents/openai-chat-completions) e clicar no botão "Acquire" para obter as credenciais necessárias para a solicitação:
