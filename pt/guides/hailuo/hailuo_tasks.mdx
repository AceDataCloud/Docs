...
Este documento irá detalhar as instruções de integração da API de Tarefas Hailuo, ajudando você a integrar facilmente e aproveitar ao máximo as poderosas funcionalidades dessa API. Com a API de Tarefas Hailuo, você pode facilmente consultar o status de execução das tarefas da API de Geração de Vídeos Hailuo.

## Processo de Solicitação

Para usar a API de Geração de Vídeos Hailuo, primeiro acesse o [Console da Ace Data Cloud](https://platform.acedata.cloud/console/applications) para obter seu Token de API, que deve ser guardado para uso futuro.
...
> 📘 Documentação Completa: [API de Geração de Vídeos Hailuo →](https://platform.acedata.cloud/documents/hailuo-videos-integration)

## Exemplo de Solicitação

A API de Tarefas Hailuo pode ser usada para consultar os resultados da API de Geração de Vídeos Hailuo. Para saber como usar a API de Geração de Vídeos Hailuo, consulte a documentação [API de Geração de Vídeos Hailuo](https://platform.acedata.cloud/documents/hailuo-videos-generation-integration).

Usaremos um exemplo de ID de tarefa retornado pelo serviço da API de Geração de Vídeos Hailuo. Suponha que temos um ID de tarefa: 58cc618b-9639-4ee7-add2-d2fcf260d9a3, a seguir, demonstraremos como passar esse ID de tarefa.
