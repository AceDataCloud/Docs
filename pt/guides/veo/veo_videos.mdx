...
Para usar a API, você precisa primeiro acessar a página correspondente da [API Veo Videos Generation](https://platform.acedata.cloud/documents/veo-videos) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Acquire", conforme mostrado na imagem:
