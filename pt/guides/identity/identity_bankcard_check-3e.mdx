...
Para usar a API, é necessário primeiro acessar a página correspondente da [API de Verificação dos Três Elementos do Cartão Bancário](https://platform.acedata.cloud/documents/identity-bankcard-check-3e) e solicitar o serviço correspondente. Após entrar na página, clique no botão "Adquirir", como mostrado na imagem:
