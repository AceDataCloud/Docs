...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Identificação e Verificação de Informações do CPF](https://platform.acedata.cloud/documents/identity-idcard-ocr) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Adquirir", como mostrado na imagem:
