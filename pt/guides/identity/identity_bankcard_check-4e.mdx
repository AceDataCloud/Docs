...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Verificação dos Quatro Elementos do Cartão Bancário](https://platform.acedata.cloud/documents/identity-bankcard-check-4e) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Adquirir", conforme mostrado na imagem:
