...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Consulta de Status de Número de Telefone](https://platform.acedata.cloud/documents/identity-phone-check-1e) e solicitar o serviço correspondente. Após acessar a página, clique no botão "Adquirir", conforme mostrado na imagem:
