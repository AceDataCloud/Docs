...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Verificação de Três Elementos do Número de Telefone](https://platform.acedata.cloud/documents/identity-phone-check-3e) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Adquirir", como mostrado na imagem:
