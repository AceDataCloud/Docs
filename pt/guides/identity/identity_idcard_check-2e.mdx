...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Informação de Identidade e Verificação de Validade](https://platform.acedata.cloud/documents/identity-idcard-check-2e) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Adquirir", conforme mostrado na imagem:
