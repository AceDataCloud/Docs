...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Verificação de Dois Fatores de Número de Telefone](https://platform.acedata.cloud/documents/identity-phone-check-2e) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Adquirir", conforme mostrado na imagem:
