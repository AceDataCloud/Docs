...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Reconhecimento do Protocolo hCaptcha](https://platform.acedata.cloud/documents/captcha-token-hcaptcha) para solicitar o serviço correspondente. Ao entrar na página, clique no botão "Adquirir", conforme mostrado na imagem:
