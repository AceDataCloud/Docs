...
Este artigo apresentará uma descrição da integração da API de reconhecimento do protocolo hCaptcha, que permite aos usuários completar a verificação sem precisar identificar e clicar nas imagens do captcha, bastando enviar a Chave do Site para realizar a decodificação automática em segundo plano.

## Processo de Solicitação

Para usar a API de reconhecimento do protocolo hCaptcha, primeiro acesse o [Painel de Controle da Ace Data Cloud](https://platform.acedata.cloud/console/applications) para obter seu Token de API, que deve ser guardado para uso futuro.

![](https://cdn.acedata.cloud/5hmkdg.jpg)

Se você ainda não estiver logado ou registrado, será redirecionado automaticamente para a página de login, onde será convidado a se registrar e logar; após isso, você será retornado à página atual.
