...
Este artigo apresentará uma descrição da integração da API de reconhecimento do protocolo hCaptcha, que permite aos usuários realizar a validação sem precisar identificar e clicar nas imagens do captcha hCaptcha, bastando enviar a Chave do Website para realizar a decodificação automática em segundo plano e completar a validação.
