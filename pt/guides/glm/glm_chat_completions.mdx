...
Esta interface suporta resposta em fluxo (Server-Sent Events), o que é muito útil para integração com páginas da web, permitindo que a página exiba o resultado palavra por palavra.
