...
Para usar a API, é necessário solicitar o serviço correspondente na página do [Fish Model API](https://platform.acedata.cloud/services/fish). Após acessar a página, clique no botão "Acquire".
