...
Para usar a API, você precisa primeiro acessar a página correspondente da [Fish Audios Generation API](https://platform.acedata.cloud/documents/fish-audios) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Acquire", como mostrado na imagem:
