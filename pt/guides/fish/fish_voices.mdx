...
Para usar a API, você precisa primeiro acessar a página correspondente da [Fish Voices Generation API](https://platform.acedata.cloud/documents/fish-voices) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Acquire", conforme mostrado na imagem:
