...
Para usar a API de QR Code Artístico, primeiro você pode acessar a página da [API de QR Code Artístico](https://data.zhishuyun.com/documents/qrart-generate "API de QR Code Artístico") e clicar no botão "Obter":
