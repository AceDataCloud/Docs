...
Com o ID do personagem de voz, podemos usar a [Suno Audios Generation API](https://platform.acedata.cloud/documents/suno-audios) para gerar música. Defina `action` como `generate` e `persona_id` como o ID retornado acima; a música gerada será cantada com a voz clonada.
