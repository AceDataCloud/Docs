...
Usaremos um exemplo de ID de tarefa retornado pelo serviço Suno Audios Generation API para demonstrar como usar essa API. Suponha que temos um ID de tarefa: eae26f89-b64b-404d-a80c-761996660b1c, a seguir, demonstraremos como passar um ID de tarefa.
...
Esta é uma consulta para detalhes de tarefas de canção com múltiplos IDs, diferente do acima, onde a ação deve ser selecionada como retrieve_batch.
