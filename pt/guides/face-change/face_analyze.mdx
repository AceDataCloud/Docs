...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Localização de Caracteres Faciais](https://platform.acedata.cloud/documents/face-analyze) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Acquire", conforme mostrado na imagem abaixo:
