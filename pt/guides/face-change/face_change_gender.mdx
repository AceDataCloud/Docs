...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Conversão de Gênero Facial](https://platform.acedata.cloud/documents/face-change-gender) para solicitar o serviço correspondente. Após acessar a página, clique no botão "Acquire", conforme mostrado na imagem abaixo:
