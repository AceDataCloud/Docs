...
Para usar a API Face Swap, você precisa primeiro ir à página de solicitação [Face Swap API](https://platform.acedata.cloud/documents/face-swap) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Acquire", conforme mostrado na imagem:
