...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Embelezamento Facial](https://platform.acedata.cloud/documents/face-beautify) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Adquirir", conforme mostrado na imagem abaixo:
