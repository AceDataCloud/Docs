...
<CardGroup cols={2}>
  <Card title="دردشة الذكاء الاصطناعي" icon="comments" href="/guides/claude/claude_chat_completions">
    الوصول إلى نماذج مثل Claude و GPT و Gemini و Grok و Kimi وغيرها عبر واجهة متوافقة مع OpenAI.
  </Card>
...
- **متوافق مع OpenAI** — يمكن استدعاء Claude و Gemini وغيرها مباشرة عبر واجهة OpenAI
