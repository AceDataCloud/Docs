...
يمكننا أن نرى أننا حصلنا على نتيجة معالجة Recaptcha3، ثم يمكننا استخدامها في POST أو GET لمحاكاة الإرسال إلى الموقع المستهدف، تستخدم لمرة واحدة، صلاحيتها 120 ثانية، يُنصح باستخدامها خلال 60 ثانية. فيما يلي سنقدم باختصار طريقة لتقديم الـ token الناتج إلى الموقع المستهدف:
