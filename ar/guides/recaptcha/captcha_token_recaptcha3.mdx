...
**يمكن استخدام رمز API واحد لاستدعاء جميع خدمات المنصة، دون الحاجة لتقديم طلب منفصل لكل خدمة.** ستتم منحك رصيد مجاني عند التقديم لأول مرة، يمكنك تجربته مجانًا؛ وعند نفاد الرصيد، يمكنك إعادة شحن الرصيد العام في [لوحة التحكم](https://platform.acedata.cloud/console/coin).
...
بعد الاختيار، يمكن ملاحظة أنه تم أيضًا إنشاء كود مطابق على الجانب الأيمن، كما هو موضح في الصورة أدناه:
...
يمكننا أن نرى أننا حصلنا على نتيجة معالجة Recaptcha3، ثم يمكننا استخدامها في POST أو GET لمحاكاة الإرسال إلى الموقع المستهدف، وهي صالحة للاستخدام مرة واحدة، ومدة صلاحيتها 120 ثانية، يُنصح باستخدامها خلال 60 ثانية. فيما يلي سنقدم بإيجاز طريقة لتقديم الـ token الناتج إلى الموقع المستهدف:
