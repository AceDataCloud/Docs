...
ستتناول هذه المقالة كيفية دمج واجهة برمجة التطبيقات للتعرف على الصور Recaptcha2، والتي يمكن من خلالها التعرف على محتوى المدخلات من المستخدم وصورة كود Recaptcha2، وأخيرًا إرجاع إحداثيات الصورة الصغيرة التي يجب النقر عليها لإكمال التحقق.

## عملية التقديم

لاستخدام واجهة برمجة التطبيقات للتعرف على الصور Recaptcha2، يجب أولاً الذهاب إلى [لوحة تحكم Ace Data Cloud](https://platform.acedata.cloud/console/applications) للحصول على رمز API الخاص بك، احتفظ به للاستخدام لاحقًا.
