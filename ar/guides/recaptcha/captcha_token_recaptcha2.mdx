...
أولاً، نحتاج إلى معرفة كيفية إرسال الموقع لطلبات POST، حتى نتمكن من تمرير الـ token الذي تم إنشاؤه. نحتاج أولاً إلى فتح وحدة التحكم F12، ثم نقوم بالتحقق يدويًا، وأخيرًا يمكننا رؤية أن الموقع أرسل طلب POST. نحتاج فقط إلى فحص بناء طلب POST هذا، والعملية المحددة كما يلي:
