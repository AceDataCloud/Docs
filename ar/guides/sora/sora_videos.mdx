...
لاستخدام الواجهة، يجب أولاً التقديم للحصول على الخدمة من خلال صفحة [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos). بعد الدخول إلى الصفحة، اضغط على زر "Acquire" كما هو موضح في الصورة:
