...
إذا كنت ترغب في الاستمرار في ترجمة الأغاني التي قمت بتحميلها، يمكنك تعيين المعامل `action` إلى `upload_cover`، وإدخال ID الأغنية التي تحتاج إلى الاستمرار في ترجمتها، يمكن الحصول على ID الأغنية باستخدام [Producer Upload API](https://platform.acedata.cloud/documents/producer-upload) كما هو موضح في الصورة أدناه:
...
إذا كنت ترغب في متابعة كتابة الأغاني التي قمت بتحميلها، يمكنك تعيين المعامل `action` إلى `upload_extend`، وإدخال معرف الأغنية التي تحتاج إلى متابعة كتابتها، يمكن الحصول على معرف الأغنية باستخدام [Producer Upload API](https://platform.acedata.cloud/documents/producer-upload) كما هو موضح في الصورة أدناه:
...
إذا كنت ترغب في الاستمرار في استبدال مقطع من الأغاني التي قمت بتحميلها، يمكنك تعيين معلمة `action` إلى `upload_replace_section`، وإدخال ID الأغنية التي تحتاج إلى الاستمرار في كتابتها، يمكن الحصول على ID الأغنية باستخدام [Producer Upload API](https://platform.acedata.cloud/documents/producer-upload) كما هو موضح في الصورة أدناه:
