---
title: "واجهة API لتوليد كلمات الأغاني Producer"
description: "Producer Music Generation API guide - Ace Data Cloud"
---

تسمح لنا Producer بتوليد كلمات الأغاني من خلال كلمات مفتاحية، وتشرح هذه الوثيقة كيفية توصيل API ذات الصلة.

تحتوي هذه الواجهة على معلمة إدخال واحدة، وهي `prompt`، وهي الكلمة المفتاحية لتوليد كلمات الأغاني.

هنا، الكلمة المفتاحية المدخلة هي `A song about winter`، وهي الكلمة المفتاحية لتوليد كلمات الأغاني.
...
يمكنك أن ترى أن حقل `lyrics` في `data` هو محتوى كلمات الأغاني المولدة.
