...
لاستخدام واجهة برمجة تطبيقات إكمال الدردشة Claude، يمكنك أولاً زيارة صفحة [واجهة برمجة تطبيقات إكمال الدردشة Claude](https://platform.acedata.cloud/documents/claude-chat-completions) والنقر على زر "Acquire" للحصول على الشهادات المطلوبة للطلب:
