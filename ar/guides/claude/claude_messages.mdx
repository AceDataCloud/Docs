...
لاستخدام واجهة برمجة تطبيقات رسائل كلود، يمكنك أولاً زيارة صفحة [واجهة برمجة تطبيقات رسائل كلود](https://platform.acedata.cloud/documents/claude-chat-completions) والنقر على زر "Acquire" للحصول على الشهادات المطلوبة للطلب:
