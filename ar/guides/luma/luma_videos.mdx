...
لاستخدام واجهة برمجة تطبيقات Luma Videos، يمكنك أولاً زيارة صفحة [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) والنقر على زر "Acquire" للحصول على الشهادات المطلوبة:
