...
لاستخدام واجهة برمجة تطبيقات Luma Tasks، يجب أولاً زيارة صفحة التقديم [واجهة برمجة تطبيقات Luma Videos Generation](https://platform.acedata.cloud/documents/luma-videos) لتقديم الطلب للخدمة المناسبة، ثم نسخ معرف المهمة من واجهة برمجة تطبيقات Luma Videos Generation، كما هو موضح في الصورة:

![](https://cdn.acedata.cloud/ynk4ow.png)

أخيرًا، انتقل إلى صفحة واجهة برمجة تطبيقات Tasks [واجهة برمجة تطبيقات Luma Tasks](https://platform.acedata.cloud/documents/luma-tasks) لتقديم الطلب للخدمة المناسبة، بعد دخول الصفحة، انقر على زر "Acquire"، كما هو موضح في الصورة:
