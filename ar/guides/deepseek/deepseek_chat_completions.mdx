...
description: "DeepSeek AI API guide - Ace Data Cloud"
---
...
لاستخدام DeepSeek Chat Completion API، يمكنك أولاً زيارة صفحة [DeepSeek Chat Completion API](https://platform.acedata.cloud/documents/deepseek-chat-completions) والنقر على زر "Acquire" للحصول على الشهادات المطلوبة:
