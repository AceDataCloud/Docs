...
لاستخدام API، يجب أولاً الذهاب إلى [hCaptcha بروتوكول التعرف على API](https://platform.acedata.cloud/documents/captcha-token-hcaptcha) وتقديم طلب الخدمة المناسبة، بعد الدخول إلى الصفحة، انقر على زر "Acquire" كما هو موضح في الصورة:
