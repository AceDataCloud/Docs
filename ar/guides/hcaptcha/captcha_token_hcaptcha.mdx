...
ستقدم هذه المقالة شرحًا لتوصيل بروتوكول التعرف على hCaptcha API، والذي يسمح للمستخدمين بالتحقق من رموز التحقق hCaptcha دون الحاجة إلى التعرف عليها أو النقر على صورها، بل يكفي تقديم مفتاح الموقع لتحقيق فك التشفير التلقائي في الخلفية وإكمال التحقق.
...
- `rqdata`: اختياري. قد تقدم تحديات hCaptcha Enterprise `data-rqdata` في الصفحة، عند مواجهة مثل هذه التحديات، املأ قيمتها الأصلية؛ لا حاجة لملء hCaptcha العادية.
