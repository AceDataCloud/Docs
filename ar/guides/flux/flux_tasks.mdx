...
لاستخدام واجهة برمجة تطبيقات مهام Flux، يجب أولاً الذهاب إلى صفحة التقديم [واجهة برمجة تطبيقات توليد صور Flux](https://platform.acedata.cloud/documents/flux-images) لتقديم الطلب للخدمة المناسبة، ثم نسخ معرف المهمة من واجهة برمجة تطبيقات توليد صور Flux، كما هو موضح في الصورة:

<p><img src="https://cdn.acedata.cloud/7furhb.png" width="500" className="m-auto" /></p>

أخيرًا، انتقل إلى صفحة واجهة برمجة تطبيقات مهام Flux [واجهة برمجة تطبيقات مهام Flux](https://platform.acedata.cloud/documents/flux-tasks) لتقديم الطلب للخدمة المناسبة، بعد دخول الصفحة، انقر على زر "Acquire"، كما هو موضح في الصورة
