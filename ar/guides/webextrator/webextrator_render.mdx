...
**يمكن استخدام رمز API واحد لاستدعاء جميع خدمات المنصة، دون الحاجة لتقديم طلب لكل خدمة على حدة.** ستمنحك أول مرة طلب مجانية، يمكنك تجربتها مجانًا؛ عند نفاد الرصيد، يمكنك إعادة شحن الرصيد العام في [لوحة التحكم](https://platform.acedata.cloud/console/coin).
...
| `wait_for_selector` | string   |  ❌  | —                            | انتظر ظهور محدد CSS، أكثر استقرارًا من `networkidle`.                          |
