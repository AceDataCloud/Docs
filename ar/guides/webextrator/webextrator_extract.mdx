...
2. **استخراج LLM المصنف** — يتم تفعيله فقط عندما لا يتم العثور على schema.org. اختر Schema حسب نوع الصفحة، تحقق صارم باستخدام Zod.
...
> ولن يتم إهدار استدعاء LLM. أنت **تحصل مجانًا** على نتائج مصنفة.
...
```json
{
  ...
  "data": {
    ...
    "contentType": "article",
    "title": "Diffbot",
    "description": "شركة أمريكية متخصصة في التعلم الآلي وإدارة المعرفة",
