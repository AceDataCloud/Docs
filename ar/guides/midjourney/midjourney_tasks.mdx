...
لاستخدام واجهة برمجة تطبيقات مهام Midjourney، تحتاج أولاً إلى زيارة صفحة التقديم [Midjourney Imagine API](https://platform.acedata.cloud/documents/midjourney-imagine) لتقديم الطلب للخدمة المناسبة، ثم نسخ معرف المهمة من واجهة برمجة التطبيقات كما هو موضح في الصورة:

<p><img src="https://cdn.acedata.cloud/lx4mwb.png" width="500" className="m-auto" /></p>

أخيرًا، انتقل إلى صفحة واجهة برمجة تطبيقات المهام [Midjourney Tasks API](https://platform.acedata.cloud/documents/midjourney-tasks) لتقديم الطلب للخدمة المناسبة، بعد دخول الصفحة، انقر على زر "Acquire" كما هو موضح في الصورة:
