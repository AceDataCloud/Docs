...
لاستخدام Midjourney Shorten API، يجب أولاً التقديم عبر صفحة التقديم [Midjourney Shorten API](https://platform.acedata.cloud/documents/midjourney-shorten)، وبعد الدخول إلى الصفحة، اضغط على زر "Acquire".
