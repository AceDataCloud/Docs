...
لاستخدام واجهة برمجة تطبيقات Midjourney Imagine، يمكنك أولاً زيارة صفحة [Midjourney Imagine API](https://platform.acedata.cloud/documents/midjourney-imagine "Midjourney Imagine API") والنقر على زر "Acquire" للحصول على الشهادات المطلوبة:
