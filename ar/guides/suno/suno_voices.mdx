...
بعد الحصول على معرف الشخصية الصوتية، يمكننا استخدام [واجهة برمجة تطبيقات توليد الصوتيات Suno](https://platform.acedata.cloud/documents/suno-audios) لتوليد الموسيقى. قم بتعيين `action` إلى `generate`، و`persona_id` إلى معرف الشخصية الصوتية الذي تم إرجاعه أعلاه، وسيتم أداء الأغنية باستخدام الصوت المستنسخ.
