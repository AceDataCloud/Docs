...
لاستخدام واجهة برمجة التطبيقات، تحتاج أولاً إلى زيارة صفحة [واجهة برمجة تطبيقات الإجابة على الأسئلة بالذكاء الاصطناعي](https://platform.acedata.cloud/documents/aichat-conversations) وتقديم طلب للحصول على الخدمة المناسبة. بعد دخول الصفحة، انقر على زر "Acquire"، كما هو موضح في الصورة:
