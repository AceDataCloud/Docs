...
واجهة برمجة التطبيقات AI Chat v2 (`/aichat2/conversations`) هي الجيل الجديد من واجهات المحادثة، وهي نسخة مطورة بالكامل من [AI Chat API](https://platform.acedata.cloud/documents/aichat-conversations). تعتمد على بساطة الإصدار v1 وإدارة المحادثات متعددة الجولات، مع التوسعات التالية:
...
لاستخدام API، يجب التقديم أولاً عبر صفحة [AI Chat v2 API](https://platform.acedata.cloud/documents/aichat2-conversations)، بعد الدخول اضغط زر "Acquire" للحصول على بيانات الاعتماد اللازمة للطلبات.
...
إذا كنت تستخدم [`/aichat/conversations`](https://platform.acedata.cloud/documents/aichat-conversations)، الترحيل إلى v2 لا يتطلب تعديل كبير:
