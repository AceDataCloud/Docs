...
قبل الاستخدام، يرجى الدخول إلى [واجهة برمجة تطبيقات صور نانو موز](https://platform.acedata.cloud/documents/nano-banana-images) في منصة Ace Data Cloud والنقر على Acquire لتقديم طلب فتح. عادةً ما يتوفر حد مجاني للاستخدام عند التقديم لأول مرة. بعد الانتهاء من الفتح، يمكنك الحصول على رمز Bearer Token لاستخدامه في استدعاء واجهة برمجة التطبيقات.
