...
يمكن استخدام واجهة برمجة تطبيقات مهام نانو موز لاستعلام نتائج واجهة برمجة تطبيقات صور نانو موز. لمزيد من المعلومات حول كيفية استخدام واجهة برمجة تطبيقات صور نانو موز، يرجى الرجوع إلى الوثيقة [واجهة برمجة تطبيقات صور نانو موز](https://platform.acedata.cloud/documents/veo-videos).
