...
لاستخدام OpenAI Chat Completion API، يمكنك أولاً زيارة صفحة [OpenAI Chat Completion API](https://platform.acedata.cloud/documents/openai-chat-completions) والنقر على زر "Acquire" للحصول على الشهادات المطلوبة:
