...
لاستخدام API، يجب أولاً التقديم للحصول على الخدمة المناسبة من خلال صفحة [Fish TTS API](https://platform.acedata.cloud/services/fish). بعد الدخول إلى الصفحة، اضغط على زر "Acquire".
...
يمكنك أيضًا استخدام [Fish Tasks API](https://platform.acedata.cloud/documents/fish-tasks) للاستعلام عن حالة المهمة بشكل نشط عبر `task_id`.
