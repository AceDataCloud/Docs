...
لاستخدام API، يجب أولاً التقديم للحصول على الخدمة المناسبة عبر صفحة [Fish Model API](https://platform.acedata.cloud/services/fish)، وعند الدخول إلى الصفحة، اضغط على زر "Acquire".
