...
شرح الفوترة: في الوضع غير المتزامن، لا يتم احتساب رسوم لإنشاء المهمة أو الاستعلام عن "قيد المعالجة"؛ **يتم احتساب الرسوم مرة واحدة فقط عند الحصول على نتيجة التعرف بنجاح** (بأسعار متطابقة مع الوضع المتزامن). لذلك، لن تؤدي إلغاء المهام التي لم تكتمل بعد إلى تكبد أي رسوم. `/captcha/tasks` متاحة لجميع واجهات التحقق من الرموز (token و recognition series) ويمكن استخدام نفس `task_id` للاستعلام.
