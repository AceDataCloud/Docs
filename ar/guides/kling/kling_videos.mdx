...
لاستخدام API، يجب أولاً التقدم للحصول على الخدمة المناسبة من خلال صفحة [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos). بعد الدخول إلى الصفحة، اضغط على زر "Acquire" كما هو موضح في الصورة:
