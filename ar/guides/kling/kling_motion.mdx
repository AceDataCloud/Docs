...
لاستخدام واجهة برمجة التطبيقات، يجب أولاً الذهاب إلى [واجهة برمجة تطبيقات توليد حركة كلينغ](https://platform.acedata.cloud/documents/kling-motion) وتقديم طلب للحصول على الخدمة المناسبة. بعد الدخول إلى الصفحة، انقر على زر "Acquire"، كما هو موضح في الصورة:
