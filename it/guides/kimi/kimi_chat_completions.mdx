...
Kimi è una serie di modelli AI lanciata da Moonshot. L'attuale modello raccomandato `kimi-k3` è orientato alla programmazione a lungo termine, agli agenti, al ragionamento complesso e al lavoro di conoscenza, ed è accessibile tramite l'API Chat Completions compatibile con OpenAI.
...
- [Create Chat Completion](https://platform.kimi.ai/docs/api/chat): richieste, risposte e definizioni dei campi OpenAPI ufficiali di Moonshot Chat Completions.
