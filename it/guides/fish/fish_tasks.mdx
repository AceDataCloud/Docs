...
Per utilizzare l'API Fish Tasks, è necessario prima andare alla pagina di richiesta [Fish Audios Generation API](https://platform.acedata.cloud/documents/fish-audios) per richiedere il servizio corrispondente, quindi copiare l'ID dell'attività dell'API Fish Audios Generation, come mostrato nell'immagine:
