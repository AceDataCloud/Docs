...
Prendiamo come esempio un ID attività restituito dal servizio Fish Audios Generation API, per dimostrare come utilizzare questa API. Supponiamo di avere un ID attività: 2725a2d3-f87e-4905-9c53-9988d5a7b2f5, e ora dimostreremo come passare un ID attività.
...
- `response`, informazioni sulla risposta nell'attività; in caso di successo finale, il `cost.amount` è il credito effettivamente addebitato per questa sintesi.
