...
Per utilizzare l'API, è necessario prima richiedere il servizio corrispondente nella pagina [Fish TTS API](https://platform.acedata.cloud/services/fish). Dopo essere entrati nella pagina, cliccare sul pulsante "Acquire".
...
È inoltre possibile utilizzare la [Fish Tasks API](https://platform.acedata.cloud/documents/fish-tasks) per interrogare attivamente lo stato del task tramite `task_id`.
