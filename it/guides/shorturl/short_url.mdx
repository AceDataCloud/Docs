...
Questo documento presenterà un'istruzione per l'integrazione dell'API Short URL, che può convertire URL lunghi in URL brevi.

## Processo di richiesta

Per utilizzare l'API Short URL, prima di tutto vai al [Pannello di controllo di Ace Data Cloud](https://platform.acedata.cloud/console/applications) per ottenere il tuo API Token, da conservare per uso futuro.
...
> 📘 Documentazione completa: [Short URL API →](https://platform.acedata.cloud/documents/shorturl)

## Utilizzo di base

Prima di tutto, è importante comprendere il modo di utilizzo di base, che consiste nell'inserire l'URL lungo da convertire per ottenere il risultato elaborato; è necessario semplicemente passare un campo `content`. Possiamo quindi compilare il contenuto corrispondente nell'interfaccia, come mostrato nell'immagine:
...
Cliccando sul pulsante "Try" possiamo effettuare un test; come mostrato nell'immagine sopra, abbiamo ottenuto il seguente risultato:
...
Si può notare che l'URL lungo originale `https://platform.acedata.cloud/documents/shorturl` è stato convertito con successo nell'URL breve `https://surl.id/1uHCs01xa5`.
...
Attraverso questo documento, hai appreso come utilizzare l'API Short URL per convertire URL lunghi in URL brevi. Speriamo che questo documento possa aiutarti a integrare e utilizzare meglio questa API. Se hai domande, non esitare a contattare il nostro team di supporto tecnico.
