...
Prendiamo come esempio un ID attività restituito dal servizio SeeDance Video Generation, per dimostrare come utilizzare questa API. Supponiamo di avere un ID attività: 20068983-0cc9-4c6a-aeb6-9c6a3c668be0, e ora dimostriamo come passare un ID attività.
...
```json
{
    ...
    "request": {
        ...
        "content": [
            {
                "type": "text",
                "text": "Multiple shots. A detective enters a dimly lit room. He examines clues on the table, picking up an item from the table. The shot shifts to him in thought. --ratio 16:9"
            }
        ],
        "callback_url": "dummy"
    },
