...
Per utilizzare l'API Luma Tasks, è necessario prima andare alla pagina di richiesta [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) per richiedere il servizio corrispondente, quindi copiare l'ID dell'attività dell'API Luma Videos Generation, come mostrato nell'immagine:

![](https://cdn.acedata.cloud/ynk4ow.png)

Infine, accedi alla pagina dell'API Tasks [Luma Tasks API](https://platform.acedata.cloud/documents/luma-tasks) per richiedere il servizio corrispondente. Una volta entrato nella pagina, fai clic sul pulsante "Acquire", come mostrato nell'immagine:
...
L'API Luma Tasks può essere utilizzata per interrogare i risultati dell'API Luma Videos Generation. Per informazioni su come utilizzare l'API Luma Videos Generation, fare riferimento al documento [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos-integration).
