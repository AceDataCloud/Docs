...
Il risultato restituito contiene diversi campi, il campo request è il corpo della richiesta inviato per avviare l'attività, mentre il campo response è il corpo della risposta restituito al termine dell'attività, i cui risultati sono coerenti con quelli della richiesta e risposta dell'API Luma Videos Generation. La descrizione dei campi è la seguente.

- `id`, l'ID dell'attività video generata, utilizzato per identificare univocamente questa attività di generazione video.
- `video_id`, l'identificatore unico del video nell'attività video interrogata, necessario per ulteriori operazioni sul video in futuro.
