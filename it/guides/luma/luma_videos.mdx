...
Per utilizzare l'API Luma Videos, puoi prima visitare la pagina [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) e cliccare sul pulsante "Acquire" per ottenere le credenziali necessarie per la richiesta:
