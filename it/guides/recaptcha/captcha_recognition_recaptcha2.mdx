...
Per utilizzare l'API, è necessario prima richiedere il servizio corrispondente sulla pagina [API di riconoscimento delle immagini Recaptcha2](https://platform.acedata.cloud/documents/captcha-recognition-recaptcha2), una volta entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
