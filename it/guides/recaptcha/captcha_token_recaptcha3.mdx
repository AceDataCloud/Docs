...
I risultati della richiesta contengono diversi campi, descritti di seguito:
...
Possiamo vedere che, tra cui `success` indica il risultato della verifica, quindi abbiamo superato con successo la verifica del Recaptcha3.
