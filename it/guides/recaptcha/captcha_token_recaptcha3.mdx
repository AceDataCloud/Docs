...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente dell'[API di riconoscimento del protocollo Recaptcha3](https://platform.acedata.cloud/documents/captcha-token-recaptcha3) per richiedere il servizio corrispondente. Una volta entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
