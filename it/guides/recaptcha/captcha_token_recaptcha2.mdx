...
Per utilizzare l'API, è necessario prima visitare la pagina corrispondente all' [API di riconoscimento del protocollo Recaptcha2](https://platform.acedata.cloud/documents/captcha-token-recaptcha2) per richiedere il servizio corrispondente. Una volta entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
