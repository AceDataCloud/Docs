...
L'API AI Chat v2 (`/aichat2/conversations`) è la nuova generazione dell'interfaccia di conversazione, un aggiornamento completo rispetto a [AI Chat API](https://platform.acedata.cloud/documents/aichat-conversations). Basata sulla semplicità e gestione di conversazioni multi-turno di v1, estende le funzionalità con:
...
Per usare l’API, visita la pagina corrispondente di [AI Chat v2 API](https://platform.acedata.cloud/documents/aichat2-conversations) e clicca sul pulsante «Acquire» per ottenere le credenziali necessarie.
...
Se usi già [`/aichat/conversations`](https://platform.acedata.cloud/documents/aichat-conversations), la migrazione a v2 richiede quasi nessuna modifica:
