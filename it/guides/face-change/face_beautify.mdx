...
Per utilizzare l'API, è necessario prima richiedere il servizio corrispondente sulla pagina [API di bellezza del volto](https://platform.acedata.cloud/documents/face-beautify). Dopo essere entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
