...
Per utilizzare l'API Face Swap, è necessario prima andare alla pagina di richiesta [Face Swap API](https://platform.acedata.cloud/documents/face-swap) per richiedere il servizio corrispondente. Una volta entrati nella pagina, clicca sul pulsante "Acquire", come mostrato nell'immagine:
