...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente dell'[API di rilevamento statico del volto (versione ad alta precisione)](https://platform.acedata.cloud/documents/face-detect-live) per richiedere il servizio corrispondente. Una volta entrati nella pagina, fare clic sul pulsante "Acquire", come mostrato nell'immagine:
