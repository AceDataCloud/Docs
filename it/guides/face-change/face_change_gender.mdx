...
Per utilizzare l'API, è necessario prima richiedere il servizio corrispondente sulla pagina [API di conversione del genere facciale](https://platform.acedata.cloud/documents/face-change-gender). Dopo essere entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
