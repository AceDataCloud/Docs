...
Per utilizzare l'API, è necessario prima richiedere il servizio corrispondente sulla pagina dell'[API di cambiamento dell'età del volto](https://platform.acedata.cloud/documents/face-change-age). Una volta entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
