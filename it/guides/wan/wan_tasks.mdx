...
Questo documento fornirà una descrizione dettagliata dell'integrazione dell'API Wan Tasks, aiutandoti a integrare facilmente e sfruttare appieno le potenti funzionalità di questa API. Con l'API Wan Tasks, puoi facilmente interrogare lo stato di esecuzione delle attività dell'API Wan Videos Generation.
...
Prendiamo come esempio un ID di attività restituito dal servizio Wan Videos Generation, per dimostrare come utilizzare questa API. Supponiamo di avere un ID di attività: a4bca552-d964-46a1-8ff7-fd922f916582, e ora dimostriamo come passare un ID di attività.
