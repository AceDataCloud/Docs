...
Prendiamo come esempio un ID di attività restituito dal servizio Kling Videos Generation, per dimostrare come utilizzare questa API. Supponiamo di avere un ID di attività: 20068983-0cc9-4c6a-aeb6-9c6a3c668be0, e ora dimostreremo come passare un ID di attività.
...
Attraverso questo documento, hai compreso come utilizzare l'API Kling Tasks per interrogare i dettagli specifici di singoli o batch di video. Speriamo che questo documento possa aiutarti a integrare e utilizzare meglio questa API. Se hai domande, non esitare a contattare il nostro team di supporto tecnico.
