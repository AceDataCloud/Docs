...
Per utilizzare l'API, è necessario prima richiedere il servizio sulla pagina corrispondente di [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos). Una volta aperta la pagina, cliccare sul pulsante «Acquire», come mostrato:
