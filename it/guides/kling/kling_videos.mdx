...
| Modello               | Modalità        | `end_image_url` (fotogramma finale) | `generate_audio` (audio) | `camera_control` (controllo della camera) | Note                                           |
| --------------------- | --------------- | -------------------- | -------------------- | -------------------- | -------------------------------------------- |
...
| `kling-v2-6`         | std            | ❌                    | ❌                    | ❌                    |                                              |
| `kling-v2-6`         | pro            | ✅                    | ✅                    | ❌                    | Unico modello non v3 che supporta audio contemporaneamente                             |
