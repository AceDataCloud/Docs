...
Per utilizzare l'API di traduzione Localization, è necessario prima richiedere il servizio appropriato nella pagina di richiesta [API di traduzione Localization](https://platform.acedata.cloud/documents/localization-translate), dopo essere entrati nella pagina, clicca sul pulsante "Acquire", come mostrato nell'immagine:
