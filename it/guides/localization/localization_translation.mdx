...
- `extension`: la forma di visualizzazione del risultato della traduzione.
- `model`: il grande modello utilizzato per la traduzione, di default è gpt-3.5.
...
Si può notare che nel risultato c'è un campo `data`, che contiene il testo tradotto in cinese, restituendolo anche in formato markdown, con le seguenti altre informazioni:
