...
- `started_at`, `finished_at`: il tempo di inizio e di produzione del risultato per questa richiesta (ISO-8601 UTC).
- `elapsed`: il tempo totale impiegato per questa elaborazione (in secondi).
