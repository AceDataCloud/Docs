...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente dell'[API di riconoscimento delle immagini hCaptcha](https://platform.acedata.cloud/documents/recognition-hcaptcha-integration) per richiedere il servizio corrispondente. Una volta entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
