...
Per utilizzare l'API Midjourney Shorten, è necessario prima richiedere il servizio sulla pagina [Midjourney Shorten API](https://platform.acedata.cloud/documents/midjourney-shorten). Una volta entrati nella pagina, cliccare sul pulsante "Acquire".
