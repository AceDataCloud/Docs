...
Per utilizzare l'API, è necessario prima richiedere il servizio corrispondente sulla pagina [API di riconoscimento e verifica delle informazioni della carta d'identità](https://platform.acedata.cloud/documents/identity-idcard-ocr); una volta entrati nella pagina, fare clic sul pulsante "Acquire", come mostrato nell'immagine:
