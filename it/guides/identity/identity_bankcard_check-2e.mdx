...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente dell'[API di verifica a due fattori della carta bancaria](https://platform.acedata.cloud/documents/identity-bankcard-check-2e) per richiedere il servizio corrispondente. Una volta entrati nella pagina, fare clic sul pulsante "Acquire", come mostrato nell'immagine:

![](https://cdn.acedata.cloud/q6ytrc.png)

Se non si è ancora effettuato il login o la registrazione, si verrà automaticamente reindirizzati alla pagina di login per invitare a registrarsi e accedere. Dopo aver effettuato il login o la registrazione, si verrà automaticamente riportati alla pagina corrente.
...
Si può notare che la veridicità e la coerenza del nome e del numero della carta bancaria sono state verificate con successo.
