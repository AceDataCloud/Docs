...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente dell'[API di verifica dei tre elementi della carta bancaria](https://platform.acedata.cloud/documents/identity-bankcard-check-3e) per richiedere il servizio corrispondente. Una volta entrati nella pagina, fare clic sul pulsante "Acquire", come mostrato nell'immagine:
