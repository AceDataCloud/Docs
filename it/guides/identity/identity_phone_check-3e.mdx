...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente [Verifica dei tre elementi del numero di telefono API](https://platform.acedata.cloud/documents/identity-phone-check-3e) per richiedere il servizio corrispondente. Una volta entrati nella pagina, fare clic sul pulsante "Acquire", come mostrato nell'immagine:
