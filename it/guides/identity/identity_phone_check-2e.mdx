...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente dell'[API di verifica a due fattori del numero di cellulare](https://platform.acedata.cloud/documents/identity-phone-check-2e) per richiedere il servizio corrispondente. Una volta entrati nella pagina, fare clic sul pulsante "Acquire", come mostrato nell'immagine:
