...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente dell'[API di verifica dello stato del numero di telefono](https://platform.acedata.cloud/documents/identity-phone-check-1e) per richiedere il servizio corrispondente, una volta entrati nella pagina, fare clic sul pulsante "Acquire", come mostrato nell'immagine:
