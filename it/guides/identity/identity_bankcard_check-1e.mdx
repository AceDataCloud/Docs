...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente dell'[API di consultazione delle informazioni di base della carta bancaria](https://platform.acedata.cloud/documents/identity-bankcard-check-1e) per richiedere il servizio corrispondente. Una volta entrati nella pagina, fare clic sul pulsante "Acquire", come mostrato nell'immagine:
