...
- **Modello (model)** (opzionale):
  ...
  - `nano-banana:official`, `nano-banana-2-lite:official`, `nano-banana-2:official`, `nano-banana-pro:official`: versioni ufficiali dei modelli, con qualità e stabilità superiori, con fatturazione diversa
- **Callback Asincrono**: opzionale, per ricevere notifiche e risultati al completamento del compito tramite `callback_url`
...
- **Opzionale**: `model` (predefinito `nano-banana`, opzionale `nano-banana-2-lite`, `nano-banana-2`, `nano-banana-pro`, o la versione ufficiale corrispondente `:official`), `aspect_ratio` (rapporto d'aspetto, come `1:1`, `16:9`), `resolution` (risoluzione, come `1K`, `2K`, `4K`; `nano-banana-2-lite` supporta solo `1K`), `callback_url` (per callback asincrona)
