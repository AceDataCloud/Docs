...
Prima di utilizzare, accedi alla piattaforma Ace Data Cloud e vai a [Nano Banana Images API](https://platform.acedata.cloud/documents/nano-banana-images) e clicca su Acquire per richiedere l'attivazione. La prima richiesta di solito avrà un credito gratuito disponibile. Una volta completata l'attivazione, potrai ottenere il Bearer Token necessario per chiamare l'API.
