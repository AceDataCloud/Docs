...
Per utilizzare l'API Flux Tasks, è necessario prima andare alla pagina di richiesta [Flux Images Generation API](https://platform.acedata.cloud/documents/flux-images) per richiedere il servizio corrispondente, quindi copiare l'ID dell'attività dell'API Flux Images Generation, come mostrato nell'immagine:

<p><img src="https://cdn.acedata.cloud/7furhb.png" width="500" className="m-auto" /></p>

Infine, accedi alla pagina dell'API Flux Tasks [Flux Tasks API](https://platform.acedata.cloud/documents/flux-tasks) per richiedere il servizio corrispondente. Una volta entrato nella pagina, fai clic sul pulsante "Acquire", come mostrato nell'immagine.
