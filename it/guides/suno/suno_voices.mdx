...
Con l'ID del personaggio vocale, possiamo utilizzare la [Suno Audios Generation API](https://platform.acedata.cloud/documents/suno-audios) per generare musica. Impostiamo `action` su `generate` e `persona_id` sull'ID del personaggio vocale ottenuto; la canzone generata sarà cantata con la voce clonata.
