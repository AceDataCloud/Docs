...
Per utilizzare Claude Messages API, puoi prima andare alla pagina [Claude Messages API](https://platform.acedata.cloud/documents/claude-chat-completions) e cliccare sul pulsante "Acquire" per ottenere le credenziali necessarie per la richiesta:
