...
Per utilizzare l'API, è necessario prima visitare la pagina corrispondente all'[API di riconoscimento dei CAPTCHA alfanumerici](https://platform.acedata.cloud/documents/captcha-recognition-image2text) e richiedere il servizio corrispondente. Una volta entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
