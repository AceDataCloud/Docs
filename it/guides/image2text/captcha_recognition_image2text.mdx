...
Dopo di che, dobbiamo convertire l'immagine del CAPTCHA in un'immagine codificata in Base64. Si consiglia di utilizzare l'estensione per Chrome FeHelper per la conversione; puoi fare riferimento all'immagine sottostante per le istruzioni specifiche:
