...
Dopo, dobbiamo convertire l'immagine del CAPTCHA in un'immagine codificata in Base64. Si consiglia di utilizzare l'estensione per Chrome FeHelper per la conversione; puoi fare riferimento all'immagine sottostante per le istruzioni specifiche:
...
Cliccando sul pulsante "Try" puoi effettuare un test, come mostrato nell'immagine sopra, e otterrai il seguente risultato:
...
- `started_at`, `finished_at`: il tempo di inizio e di completamento della richiesta (ISO-8601 UTC).
