...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente dell'[API per la produzione di foto identificative AI](https://platform.acedata.cloud/documents/headshots-generate) per richiedere il servizio corrispondente. Una volta entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
