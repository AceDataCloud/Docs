...
Per utilizzare l'API, è necessario prima richiedere il servizio corrispondente sulla pagina [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos). Dopo aver aperto la pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
