...
Infine, accedi alla pagina dell'API Tasks [Producer Tasks API](https://platform.acedata.cloud/documents/producer-tasks) per richiedere il servizio corrispondente. Una volta entrato nella pagina, fai clic sul pulsante "Acquire", come mostrato nell'immagine:
