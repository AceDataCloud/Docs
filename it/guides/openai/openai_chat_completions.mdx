...
Per utilizzare l'API OpenAI Chat Completion, è possibile visitare la pagina [OpenAI Chat Completion API](https://platform.acedata.cloud/documents/openai-chat-completions) e fare clic sul pulsante "Acquire" per ottenere le credenziali necessarie per la richiesta:
