...
Per utilizzare l'API OpenAI Responses, puoi prima andare alla pagina [OpenAI Responses API](https://platform.acedata.cloud/documents/openai-responses) e fare clic sul pulsante "Acquire" per ottenere le credenziali necessarie per la richiesta:
