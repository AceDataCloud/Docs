...
Um die Midjourney Shorten API zu nutzen, müssen Sie zunächst auf der Antragsseite [Midjourney Shorten API](https://platform.acedata.cloud/documents/midjourney-shorten) den entsprechenden Dienst beantragen. Nach dem Aufruf der Seite klicken Sie auf die Schaltfläche „Acquire“.
