...
Um die Kunst-QR-Code-API zu nutzen, können Sie zunächst auf die Seite [Kunst-QR-Code API](https://data.zhishuyun.com/documents/qrart-generate "Kunst-QR-Code API") gehen und auf die Schaltfläche „Erhalten“ klicken:
