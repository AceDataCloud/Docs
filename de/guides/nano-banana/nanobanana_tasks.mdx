...
Wir nehmen als Beispiel eine von der Nano Banana Images API zurückgegebene Auftrags-ID und zeigen, wie man diese API verwendet. Angenommen, wir haben eine Auftrags-ID: 4d320ead-4af4-4a55-8f3e-f2afebdf4fd0, im Folgenden zeigen wir, wie man diese Auftrags-ID übergibt.
