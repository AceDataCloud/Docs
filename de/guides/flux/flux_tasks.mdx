...
Um die Flux Tasks API zu nutzen, müssen Sie zunächst auf die Anmeldeseite [Flux Images Generation API](https://platform.acedata.cloud/documents/flux-images) gehen und den entsprechenden Dienst beantragen, dann kopieren Sie die Auftrags-ID der Flux Images Generation API, wie im Bild gezeigt:

<p><img src="https://cdn.acedata.cloud/7furhb.png" width="500" className="m-auto" /></p>

Gehen Sie schließlich zur Flux Tasks API-Seite [Flux Tasks API](https://platform.acedata.cloud/documents/flux-tasks) und beantragen Sie den entsprechenden Dienst. Klicken Sie nach dem Betreten der Seite auf die Schaltfläche „Acquire“, wie im Bild gezeigt.
