...
Wir nehmen als Beispiel eine von der Flux Images Generation API zurückgegebene Auftrags-ID und zeigen, wie man diese API verwendet. Angenommen, wir haben eine Auftrags-ID: 2db0168c-2373-4367-8d9a-9dc778802e8a, im Folgenden zeigen wir, wie man diese Auftrags-ID übergibt.
