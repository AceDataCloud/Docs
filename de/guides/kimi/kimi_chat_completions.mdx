...
Um die Gemini Chat Completion API zu nutzen, können Sie zunächst auf die Seite [Kimi Chat Completion API](https://platform.acedata.cloud/documents/kimi-chat-completions) gehen und auf die Schaltfläche „Acquire“ klicken, um die erforderlichen Anmeldeinformationen zu erhalten:
