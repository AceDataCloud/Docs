...
Um die API zu nutzen, müssen Sie zunächst den entsprechenden Dienst auf der [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos) Seite beantragen. Nach dem Aufruf der Seite klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
