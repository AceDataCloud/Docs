...
Nach erfolgreicher Anfrage gibt die API die Details des Auftrags zurück. Zum Beispiel:
...
Dies ist eine Abfrage von Auftragsdetails für mehrere Auftrags-IDs, im Gegensatz zu oben muss die Aktion auf retrieve_batch gesetzt werden.
...
Nach erfolgreicher Anfrage gibt die API die spezifischen Details aller Batch-Aufträge zurück. Zum Beispiel:
```json
{
    "items": [
        {
