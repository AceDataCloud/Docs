...
Die AI Chat v2 API (`/aichat2/conversations`) ist die nächste Generation der Dialogschnittstelle und stellt eine umfassende Weiterentwicklung der [AI Chat API](https://platform.acedata.cloud/documents/aichat-conversations) dar. Basierend auf der einfachen und gehosteten Mehrfachdialogführung von v1 erweitert sie folgende Funktionen:
...
Um die API zu nutzen, müssen Sie zunächst auf der entsprechenden Seite der [AI Chat v2 API](https://platform.acedata.cloud/documents/aichat2-conversations) den Dienst beantragen. Nach dem Aufruf der Seite klicken Sie auf die Schaltfläche „Acquire“, um die für die Anfrage benötigten Zugangsdaten zu erhalten.
...
Wenn Sie bereits [`/aichat/conversations`](https://platform.acedata.cloud/documents/aichat-conversations) nutzen, ist die Migration zu v2 nahezu ohne Codeänderungen möglich:
