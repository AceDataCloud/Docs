...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [Identitätskarten-Erkennung und Informationsüberprüfungs-API](https://platform.acedata.cloud/documents/identity-idcard-ocr) gehen und den entsprechenden Dienst beantragen. Nachdem Sie die Seite betreten haben, klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
