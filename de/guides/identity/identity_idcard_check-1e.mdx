...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [API zur Verifizierung von Personalausweis-Fotos](https://platform.acedata.cloud/documents/identity-idcard-check-1e) gehen und den entsprechenden Dienst beantragen. Nachdem Sie die Seite betreten haben, klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
