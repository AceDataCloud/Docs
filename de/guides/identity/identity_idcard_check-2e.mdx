...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [Identitätsinformationen und Gültigkeitsprüfung API](https://platform.acedata.cloud/documents/identity-idcard-check-2e) gehen und den entsprechenden Dienst beantragen. Nachdem Sie die Seite betreten haben, klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
