...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [Bankkarten-Zwei-Faktoren-Überprüfungs-API](https://platform.acedata.cloud/documents/identity-bankcard-check-2e) gehen und den entsprechenden Dienst beantragen. Nach dem Betreten der Seite klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
