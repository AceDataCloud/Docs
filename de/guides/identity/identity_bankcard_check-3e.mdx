...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [Bankkarten-Drei-Elemente-Überprüfungs-API](https://platform.acedata.cloud/documents/identity-bankcard-check-3e) gehen und den entsprechenden Dienst beantragen. Nachdem Sie die Seite betreten haben, klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
