...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [Handynummer Drei-Elemente-Überprüfung API](https://platform.acedata.cloud/documents/identity-phone-check-3e) gehen und den entsprechenden Dienst beantragen. Nachdem Sie die Seite betreten haben, klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
