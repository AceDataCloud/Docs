...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [Bankkarten Vier Elemente Verifizierung API](https://platform.acedata.cloud/documents/identity-bankcard-check-4e) gehen und den entsprechenden Dienst beantragen. Nachdem Sie die Seite betreten haben, klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
...
Es ist zu erkennen, dass die Bankkartennummer, der Name, die Ausweisnummer und die Handynummer dieser Bankkarte Echtheit und Konsistenz aufweisen.
