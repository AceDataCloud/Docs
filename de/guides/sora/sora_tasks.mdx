...
Um die Sora Tasks API zu nutzen, müssen Sie zunächst auf die Anmeldeseite [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos) gehen und den entsprechenden Service beantragen, dann kopieren Sie die Task-ID der Sora Videos Generation API, wie im Bild gezeigt:

<p><img src="https://cdn.acedata.cloud/za62pb.png" width="500" className="m-auto" /></p>

Gehen Sie schließlich zur Tasks API-Seite [Sora Tasks API](https://platform.acedata.cloud/documents/sora-tasks), um den entsprechenden Service zu beantragen. Klicken Sie nach dem Betreten der Seite auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
