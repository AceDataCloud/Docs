...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [digitalen englischen CAPTCHA-Erkennungs-API](https://platform.acedata.cloud/documents/captcha-recognition-image2text) gehen und den entsprechenden Dienst beantragen. Nachdem Sie die Seite betreten haben, klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
