...
Um die OpenAI Embeddings API zu nutzen, können Sie zunächst auf die Seite [OpenAI Embeddings API](https://platform.acedata.cloud/documents/openai-embeddings) gehen und auf die Schaltfläche „Acquire“ klicken, um die erforderlichen Anmeldeinformationen zu erhalten:
