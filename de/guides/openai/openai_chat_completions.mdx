...
Um die OpenAI Chat Completion API zu nutzen, können Sie zunächst auf die Seite [OpenAI Chat Completion API](https://platform.acedata.cloud/documents/openai-chat-completions) gehen und auf die Schaltfläche „Acquire“ klicken, um die benötigten Anmeldeinformationen zu erhalten:
