...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [hCaptcha Bildverarbeitungs-API](https://platform.acedata.cloud/documents/recognition-hcaptcha-integration) gehen und den entsprechenden Dienst beantragen. Nach dem Betreten der Seite klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
