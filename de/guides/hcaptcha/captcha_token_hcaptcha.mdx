...
- `token`, das Ergebnis der hCaptcha-Verifizierung nach der Bearbeitung der Aufgabe.
- `started_at`, `finished_at`: Die Zeit, zu der diese Anfrage bearbeitet und das Ergebnis erzeugt wurde (ISO-8601 UTC).
- `elapsed`: Die gesamte Bearbeitungszeit dieser Anfrage (Sekunden).
