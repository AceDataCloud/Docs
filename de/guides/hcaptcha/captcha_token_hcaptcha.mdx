...
Außerdem haben wir den Anfrage-Body festgelegt, einschließlich:
...
Verwenden Sie anschließend diese `task_id`, um `POST /captcha/tasks` (empfohlen alle 3-5 Sekunden) abzufragen, um das Ergebnis zu erhalten:
