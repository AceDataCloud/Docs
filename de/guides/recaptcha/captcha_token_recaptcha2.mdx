...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [Recaptcha2 Protokoll Erkennungs-API](https://platform.acedata.cloud/documents/captcha-token-recaptcha2) gehen und den entsprechenden Dienst beantragen. Nach dem Betreten der Seite klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
