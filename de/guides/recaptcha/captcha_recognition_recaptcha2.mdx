...
- `solution`, das Ergebnis der Verifizierung nach der Bearbeitung des Recaptcha2 CAPTCHA-Bildes.
    ...
    - `objects`, die Bereiche des Recaptcha2 CAPTCHA-Bildes, die den Erkennungsinhalten entsprechen, die Bereiche beginnen bei 0.
...
Durch dieses Dokument haben Sie gelernt, wie Sie die Recaptcha2-Bilderkennung-API verwenden, um die vom Benutzer eingegebenen Erkennungsinhalte und das Recaptcha2-Captcha-Bild zu verarbeiten und schließlich die Koordinaten der kleinen Bilder zurückzugeben, die angeklickt werden müssen, um die Überprüfung abzuschließen. Wir hoffen, dass dieses Dokument Ihnen hilft, die API besser zu integrieren und zu nutzen. Bei Fragen wenden Sie sich bitte jederzeit an unser technisches Support-Team.
