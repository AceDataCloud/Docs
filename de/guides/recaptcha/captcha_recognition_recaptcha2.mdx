...
Durch dieses Dokument haben Sie gelernt, wie Sie die Recaptcha2-Bilderkennung-API verwenden, um den Benutzern die Eingabe des Erkennungsergebnisses und des Recaptcha2-Captcha-Bildes zu ermöglichen, und schließlich die Koordinaten des kleinen Bildes zurückzugeben, das angeklickt werden muss, um die Verifizierung abzuschließen. Wir hoffen, dass dieses Dokument Ihnen hilft, die API besser zu integrieren und zu nutzen. Bei Fragen wenden Sie sich bitte jederzeit an unser technisches Support-Team.
