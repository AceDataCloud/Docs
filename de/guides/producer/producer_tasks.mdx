...
Wir nehmen als Beispiel eine von der Producer Audios Generation API zurückgegebene Auftrags-ID und demonstrieren, wie man diese API verwendet. Angenommen, wir haben eine Auftrags-ID: 1a6ac2ad-10f2-4e2b-b500-66ec27fe82ad, im Folgenden zeigen wir, wie man durch Eingabe einer Auftrags-ID vorgeht.
...
- `started_at`，Zeitpunkt des Beginns der Ausführung der Aufgabe, ISO-8601 UTC-Zeitzeichenfolge.
...
Dies ist eine Abfrage von Aufgabendetails für mehrere Aufgaben-IDs, wobei im Gegensatz zu oben die Aktion auf retrieve_batch gesetzt werden muss.
...
Die Rückgabe enthält mehrere Felder, wobei `items` die spezifischen Detailinformationen der Batch-Aufgaben enthält. Die spezifischen Informationen jeder Aufgabe sind wie oben beschrieben, die Feldinformationen sind wie folgt.

- `items`, alle spezifischen Detailinformationen der Batch-Aufgaben. Es ist ein Array, wobei jedes Element des Arrays das gleiche Format wie das oben abgefragte Ergebnis einer einzelnen Aufgabe hat.
