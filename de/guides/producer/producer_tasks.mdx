...
Gehen Sie schließlich zur Tasks API-Seite [Producer Tasks API](https://platform.acedata.cloud/documents/producer-tasks), um den entsprechenden Dienst zu beantragen. Klicken Sie nach dem Betreten der Seite auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
