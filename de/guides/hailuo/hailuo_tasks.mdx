...
Um die Hailuo Tasks API zu nutzen, müssen Sie zunächst auf die Antragsseite [Hailuo Videos Generation API](https://platform.acedata.cloud/documents/hailuo-videos-integration) gehen und den entsprechenden Dienst beantragen, dann kopieren Sie die Auftrags-ID der Hailuo Videos Generation API, wie im Bild gezeigt:

<p><img src="https://cdn.acedata.cloud/4f9d95.png" width="500" className="m-auto" /></p>

Gehen Sie schließlich zur Tasks API-Seite [Hailuo Tasks API](https://platform.acedata.cloud/documents/hailuo-tasks), um den entsprechenden Dienst zu beantragen. Nachdem Sie die Seite betreten haben, klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
...
Die Hailuo Tasks API kann verwendet werden, um die Ergebnisse der Hailuo Videos Generation API abzufragen. Informationen zur Verwendung der Hailuo Videos Generation API finden Sie im Dokument [Hailuo Videos Generation API](https://platform.acedata.cloud/documents/hailuo-videos-generation-integration).
