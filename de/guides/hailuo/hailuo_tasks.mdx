...
Die Hauptfunktion der Hailuo Tasks API besteht darin, den Ausführungsstatus eines Auftrags abzufragen, indem die Auftrags-ID eingegeben wird, die durch die Hailuo Videos Generation API generiert wurde.
