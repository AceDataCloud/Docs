...
Um die Luma Videos API zu nutzen, können Sie zunächst die Seite [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) besuchen und auf die Schaltfläche „Acquire“ klicken, um die benötigten Anmeldeinformationen zu erhalten:
