...
Um die ADSL-IP zu extrahieren und eine IP-Whitelist für den ADSL Proxy hinzuzufügen, können Sie zunächst auf die Seiten [ADSL Proxy Extract API](https://platform.acedata.cloud/documents/adsl-extract) und [ADSL Proxy Whitelist API](https://platform.acedata.cloud/documents/adsl-whitelist) klicken Sie auf die Schaltfläche „Erwerben“, um die erforderlichen Anmeldeinformationen zu erhalten:
...
Als Nächstes können Sie auf der Seite [ADSL Proxy Extract API](https://platform.acedata.cloud/documents/adsl-extract) die entsprechenden Inhalte ausfüllen. Im Folgenden wird gezeigt, wie man die ADSL-IP extrahiert.
