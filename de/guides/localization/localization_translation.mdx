---
title: "Integration und Nutzung der Localization Translate API"
...
Dieses Dokument wird die Integrationsanleitung der Translate API detailliert erläutern, um Ihnen zu helfen, diese leistungsstarke API einfach zu integrieren und optimal zu nutzen. Mit der Translate API können Sie den eingegebenen Text mühelos in eine bestimmte Sprache übersetzen und unterstützen spezifische Methoden zur Ausgabe der Übersetzungsergebnisse.
...
Wir nehmen ein englisches Eingangsbeispiel, um zu demonstrieren, wie man die API verwendet. Angenommen, der englische Beschreibungstext lautet: `# Title 1\n\nThis is a paragraph.\n\n## Title 2\n\nThis is another paragraph.`, im Folgenden wird gezeigt, wie man den englischen Beschreibungstext hochlädt und das chinesische Übersetzungsergebnis erhält, das gleichzeitig im Markdown-Format angezeigt wird.
...
- `model`: Das verwendete Übersetzungsmodell, standardmäßig gpt-3.5.
...
- `model`, das für diese Übersetzungsaufgabe verwendete Sprachmodell.
- `locale`, der Typ der Übersetzungssprache dieser Übersetzungsaufgabe.

## Fehlerbehandlung

Wenn bei der Nutzung der API Fehler auftreten, gibt die API die entsprechenden Fehlercodes und -informationen zurück. Zum Beispiel:
