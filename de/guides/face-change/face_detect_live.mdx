...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [Gesichtsstatischen Lebendigkeitserkennung (Hochpräzisionsversion) API](https://platform.acedata.cloud/documents/face-detect-live) gehen und den entsprechenden Dienst beantragen. Nachdem Sie die Seite betreten haben, klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
