...
Um die Face Swap API zu nutzen, müssen Sie zunächst auf die Anmeldeseite [Face Swap API](https://platform.acedata.cloud/documents/face-swap) gehen und den entsprechenden Dienst beantragen. Nachdem Sie die Seite betreten haben, klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
