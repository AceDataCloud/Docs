...
Um die Wan Tasks API zu nutzen, müssen Sie zunächst auf die Antragsseite [Wan Videos Generation API](https://platform.acedata.cloud/documents/wan-videos) gehen und den entsprechenden Dienst beantragen, dann kopieren Sie die Auftrags-ID der Wan Videos Generation API, wie im Bild gezeigt:

<p><img src="https://cdn.acedata.cloud/om6p6g.png" width="500" className="m-auto" /></p>

Gehen Sie schließlich zur Tasks API-Seite [Wan Tasks API](https://platform.acedata.cloud/documents/wan-tasks), um den entsprechenden Dienst zu beantragen. Klicken Sie nach dem Betreten der Seite auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
