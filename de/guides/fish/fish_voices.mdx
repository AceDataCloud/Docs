...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [Fish Voices Generation API](https://platform.acedata.cloud/documents/fish-voices) gehen und den entsprechenden Dienst beantragen. Nachdem Sie die Seite betreten haben, klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
