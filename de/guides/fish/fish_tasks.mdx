...
Um die Fish Tasks API zu nutzen, müssen Sie zunächst auf die Anmeldeseite [Fish Audios Generation API](https://platform.acedata.cloud/documents/fish-audios) gehen und den entsprechenden Dienst beantragen, dann kopieren Sie die Auftrags-ID der Fish Audios Generation API, wie im Bild gezeigt:
