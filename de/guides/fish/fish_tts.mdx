...
Um die API nutzen zu können, müssen Sie zunächst auf der entsprechenden Seite der [Fish TTS API](https://platform.acedata.cloud/services/fish) den Dienst beantragen. Nach dem Aufruf der Seite klicken Sie auf die Schaltfläche „Acquire“.
...
Alternativ kann auch die [Fish Tasks API](https://platform.acedata.cloud/documents/fish-tasks) verwendet werden, um den Status der Aufgabe mit `task_id` aktiv abzufragen.
