---
title: "Kimi cURL 빠른 시작"
---

## 소개

Kimi는 Ace Data Cloud에서 제공하는 AI 채팅 서비스로, 월의 어둠 Kimi 시리즈 대형 언어 모델입니다. Ace Data Cloud 통합 API를 통해 cURL을 사용하여 Kimi를 빠르게 호출할 수 있으며, 다중 대화, 시스템 프롬프트, 스트리밍 출력, JSON 출력 모드 등의 기능을 구현할 수 있습니다.
...
Kimi API 호출의 주요 엔드포인트는 다음과 같습니다:
