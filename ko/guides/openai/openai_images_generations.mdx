...
OpenAI Images Generations API를 사용하려면 먼저 [OpenAI Images Generations API](https://platform.acedata.cloud/documents/openai-images-generations) 페이지에서 「Acquire」 버튼을 클릭하여 요청에 필요한 인증 정보를 획득하세요:
