...
OpenAI Embeddings API를 사용하려면 먼저 [OpenAI Embeddings API](https://platform.acedata.cloud/documents/openai-embeddings) 페이지에서 "Acquire" 버튼을 클릭하여 요청에 필요한 자격 증명을 얻습니다:
