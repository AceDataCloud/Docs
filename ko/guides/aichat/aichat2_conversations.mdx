...
AI Chat v2 API (`/aichat2/conversations`)는 차세대 대화 인터페이스로, [AI Chat API](https://platform.acedata.cloud/documents/aichat-conversations)의 완전한 업그레이드 버전입니다. v1의 간결하고 다중 회화 호스팅 기반에 다음과 같은 확장 기능을 더했습니다:
...
API 사용을 위해 [AI Chat v2 API](https://platform.acedata.cloud/documents/aichat2-conversations) 페이지에서 서비스 신청 후, 페이지 내 「Acquire」 버튼 클릭으로 요청에 필요한 인증 정보를 획득하세요.
