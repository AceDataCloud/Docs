...
Fish Tasks API를 사용하려면 먼저 신청 페이지 [Fish Audios Generation API](https://platform.acedata.cloud/documents/fish-audios)에서 해당 서비스를 신청한 후, Fish Audios Generation API의 작업 ID를 복사해야 합니다. 아래 그림과 같이 진행합니다:
