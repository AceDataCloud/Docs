...
강화 업로드로 얻은 `audio_id`는 Cover, Samples 및 Mashup에 사용할 수 있습니다. 반주와 MIDI 추출, 전체 트랙 분리 및 보컬/반주 분리는 여전히 오디오 소속 계정의 제한을 받을 수 있으며, 나열되지 않은 작업은 계정 간 사용 지원을 보장하지 않습니다. 오디오가 짧을수록 처리 성공률이 일반적으로 높습니다.
