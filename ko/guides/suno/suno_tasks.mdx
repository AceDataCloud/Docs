...
본 문서에서는 Suno Tasks API의 연동 설명을 자세히 소개하여, 귀하가 이 API의 강력한 기능을 쉽게 통합하고 충분히 활용할 수 있도록 돕겠습니다. Suno Tasks API를 통해 Suno Lyrics Generation API 또는 Suno Audios Generation API의 작업 실행 상태를 쉽게 조회할 수 있습니다.

## 신청 절차

Suno Audios Generation API를 사용하려면 먼저 [Ace Data Cloud 콘솔](https://platform.acedata.cloud/console/applications)에서 API Token을 받아야 하며, 이를 보관해 두시기 바랍니다.
...
Suno Tasks API는 Suno Audios Generation API와 Suno Lyrics Generation API 두 API의 결과를 조회하는 데 사용할 수 있습니다. Suno Audios Generation API 사용 방법에 대한 자세한 내용은 [Suno Audios Generation API](https://platform.acedata.cloud/documents/suno-audios-integration) 문서를 참조하시기 바랍니다. Suno Lyrics Generation API 사용 방법에 대한 내용은 [Suno Lyrics Generation API](https://platform.acedata.cloud/documents/suno-lyrics-generation-integration)를 참조하시기 바랍니다.

Suno Audios Generation API 서비스에서 반환된 작업 ID를 예로 들어, 해당 API를 사용하는 방법을 시연하겠습니다. 가정해 보겠습니다. 작업 ID가 eae26f89-b64b-404d-a80c-761996660b1c인 경우, 다음과 같이 작업 ID를 전달하여 사용합니다.
