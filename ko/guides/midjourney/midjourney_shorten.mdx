...
Midjourney Shorten API를 사용하려면 먼저 신청 페이지 [Midjourney Shorten API](https://platform.acedata.cloud/documents/midjourney-shorten)에서 해당 서비스를 신청해야 하며, 페이지 접속 후 「Acquire」 버튼을 클릭합니다.
