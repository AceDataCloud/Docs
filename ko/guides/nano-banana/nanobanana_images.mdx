...
사용하기 전에, Ace Data Cloud 플랫폼에서 [나노 바나나 이미지 API](https://platform.acedata.cloud/documents/nano-banana-images)에 들어가서 Acquire를 클릭하여 개통을 신청하세요. 최초 신청 시 일반적으로 무료 할당량이 제공됩니다. 개통이 완료되면, 플랫폼에서 API 호출에 사용할 Bearer Token을 얻을 수 있습니다.
