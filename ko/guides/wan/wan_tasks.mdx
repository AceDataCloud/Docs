...
Wan Tasks API는 Wan Videos Generation API의 결과를 조회하는 데 사용할 수 있습니다. Wan Videos Generation API 사용 방법에 대한 자세한 내용은 [Wan Videos Generation API](https://platform.acedata.cloud/documents/wan-videos) 문서를 참조하십시오.

우리는 Wan Videos Generation API 서비스에서 반환된 작업 ID를 예로 들어 이 API를 사용하는 방법을 시연합니다. 가정해 보겠습니다. 작업 ID가 a4bca552-d964-46a1-8ff7-fd922f916582인 경우, 다음은 작업 ID를 전달하여 사용하는 방법입니다.
...
반환 결과는 여러 필드를 포함하고 있으며, items는 배치 비디오 작업의 구체적인 세부 정보 정보를 포함하고 있습니다. 각 비디오 작업의 구체적인 정보는 위의 필드와 동일합니다.

- `items`, 배치 비디오 작업의 모든 구체적인 세부 정보 정보입니다. 배열이며, 각 배열의 요소는 위의 단일 작업 쿼리의 반환 결과 형식과 동일합니다.
