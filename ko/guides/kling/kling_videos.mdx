...
API를 사용하려면 먼저 [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos) 페이지에서 해당 서비스를 신청해야 합니다. 페이지에 접속 후 「Acquire」 버튼을 클릭하세요. 아래와 같이 표시됩니다:
