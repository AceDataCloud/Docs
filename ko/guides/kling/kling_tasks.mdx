  ...
  "items": [
    {
      ...
      "request": {
        "action": "text2video",
        "model": "kling-v1",
        "prompt": "광택이 나는 대리석 조리대 위에 있는 흰색 세라믹 커피 머그컵과 아침 창문 빛. 카메라가 머그컵 주위를 360도 천천히 회전하며 손잡이에서 잠시 멈춥니다.",
        "callback_url": "https://webhook.site/624b2c78-6dbd-4618-9d2b-b32eade6d8c3"
      },
      "trace_id": "0a907f69-4ae2-4a08-b34c-ee15c1c47077",
      "type": "videos",
...
반환 결과는 여러 필드를 포함하고 있으며, items는 배치 비디오 작업의 구체적인 세부 정보 정보를 포함하고 있습니다. 각 비디오 작업의 구체적인 정보는 위의 필드와 동일하며, 필드 정보는 다음과 같습니다.

- `items`, 배치 비디오 작업의 모든 구체적인 세부 정보 정보. 그것은 배열이며, 각 배열의 요소는 위의 단일 작업의 반환 결과 형식과 동일합니다.
...
이 문서를 통해 Kling Tasks API를 사용하여 단일 또는 배치 비디오 작업의 모든 구체적인 세부 정보 정보를 쿼리하는 방법을 이해하셨습니다. 이 문서가 API를 더 잘 연결하고 사용하는 데 도움이 되기를 바랍니다. 질문이 있으시면 언제든지 기술 지원 팀에 문의해 주십시오.
