...
API를 사용하려면 먼저 [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos) 해당 페이지에서 서비스를 신청해야 합니다. 페이지에 접속한 후, 「Acquire」 버튼을 클릭하세요. 아래 그림과 같습니다:
