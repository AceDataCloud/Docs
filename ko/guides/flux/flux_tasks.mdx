...
Flux Images Generation API 서비스에서 반환된 작업 ID를 예로 들어, 이 API를 사용하는 방법을 시연합니다. 가정해 보겠습니다. 작업 ID가 2db0168c-2373-4367-8d9a-9dc778802e8a인 경우, 다음은 작업 ID를 전달하여 사용하는 방법입니다.
