...
Flux Images Generation API 서비스에서 반환된 작업 ID를 예로 들어 이 API를 사용하는 방법을 시연하겠습니다. 가정해 보겠습니다. 작업 ID가 2db0168c-2373-4367-8d9a-9dc778802e8a인 경우, 다음은 작업 ID를 전달하여 사용하는 방법입니다.
...
이 문서를 통해 FLux Tasks API를 사용하여 단일 또는 배치 이미지 작업의 모든 구체적인 세부 정보를 쿼리하는 방법을 이해하셨습니다. 이 문서가 API를 더 잘 연결하고 사용하는 데 도움이 되기를 바랍니다. 질문이 있으시면 언제든지 기술 지원 팀에 문의해 주십시오.
