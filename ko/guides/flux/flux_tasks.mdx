...
Flux Tasks API를 사용하려면 먼저 신청 페이지 [Flux Images Generation API](https://platform.acedata.cloud/documents/flux-images)에서 해당 서비스를 신청한 후, Flux Images Generation API의 작업 ID를 복사합니다. 아래 그림과 같이:

<p><img src="https://cdn.acedata.cloud/7furhb.png" width="500" className="m-auto" /></p>

마지막으로 Flux Tasks API 페이지 [Flux Tasks API](https://platform.acedata.cloud/documents/flux-tasks)에서 해당 서비스를 신청하고, 페이지에 들어가면 「Acquire」 버튼을 클릭합니다. 아래 그림과 같이:
