...
Luma Videos API를 사용하려면 먼저 [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) 페이지에서 "Acquire" 버튼을 클릭하여 요청에 필요한 자격 증명을 얻을 수 있습니다:
