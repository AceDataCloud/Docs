...
Luma Videos Generation API 서비스에서 반환된 작업 ID를 예로 들어, 해당 API를 사용하는 방법을 시연하겠습니다. 가정해 보겠습니다, 작업 ID가 50fc6182-fa86-4c7d-ac12-2fa27ec2f151인 경우, 다음과 같이 작업 ID를 전달하여 사용합니다.
