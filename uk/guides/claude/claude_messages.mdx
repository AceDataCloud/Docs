...
Щоб використовувати Claude Messages API, спочатку можна перейти на сторінку [Claude Messages API](https://platform.acedata.cloud/documents/claude-chat-completions) та натиснути кнопку «Acquire», щоб отримати необхідні для запиту облікові дані:
