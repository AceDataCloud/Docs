...
Щоб використовувати Claude Chat Completion API, спочатку можна перейти на сторінку [Claude Chat Completion API](https://platform.acedata.cloud/documents/claude-chat-completions) та натиснути кнопку «Acquire», щоб отримати необхідні для запиту облікові дані:
