...
Якщо ви хочете продовжити виконання каверу на завантажену вами пісню, ви можете встановити параметр `action` на `upload_cover` і ввести ID пісні, на яку потрібно продовжити виконання каверу. ID пісні можна отримати за допомогою [Producer Upload API](https://platform.acedata.cloud/documents/producer-upload), як показано на малюнку нижче:
