...
Нарешті, перейдіть на сторінку API завдань [API завдань продюсера](https://platform.acedata.cloud/documents/producer-tasks) для отримання відповідної послуги, після входу на сторінку натисніть кнопку «Отримати», як показано на малюнку:
