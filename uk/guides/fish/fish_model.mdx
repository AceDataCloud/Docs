...
Для використання API необхідно спочатку подати заявку на відповідний сервіс на сторінці [Fish Model API](https://platform.acedata.cloud/services/fish). Після переходу на сторінку натисніть кнопку «Acquire».
