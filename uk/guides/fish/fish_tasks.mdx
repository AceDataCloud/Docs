...
Fish Tasks API можна використовувати для перевірки результатів Fish Audios Generation API. Щоб дізнатися, як використовувати Fish Audios Generation API, зверніться до документації [Fish Videos Generation API](https://platform.acedata.cloud/documents/fish-tts-integration).

Розглянемо приклад з ID завдання, яке повертає сервіс Fish Audios Generation API. Припустимо, у нас є ID завдання: 2725a2d3-f87e-4905-9c53-9988d5a7b2f5, далі покажемо, як передати цей ID завдання.
