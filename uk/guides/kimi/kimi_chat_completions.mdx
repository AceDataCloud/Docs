...
Щоб використовувати Gemini Chat Completion API, спочатку можна перейти на сторінку [Kimi Chat Completion API](https://platform.acedata.cloud/documents/kimi-chat-completions) і натиснути кнопку «Acquire», щоб отримати необхідні для запиту облікові дані:
