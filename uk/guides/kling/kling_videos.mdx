...
Щоб використовувати API, спочатку потрібно подати заявку на відповідний сервіс на сторінці [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos). Після переходу на сторінку натисніть кнопку «Acquire», як показано на зображенні:
