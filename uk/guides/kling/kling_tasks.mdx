...
Розглянемо приклад з ID завдання, яке повертає сервіс Kling Videos Generation API. Припустимо, у нас є ID завдання: 20068983-0cc9-4c6a-aeb6-9c6a3c668be0, далі демонструємо, як передати це ID.
