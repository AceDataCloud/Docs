...
Щоб використовувати Kling Tasks API, спочатку потрібно перейти на сторінку подачі заявки [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos) для отримання відповідної послуги, а потім скопіювати ID завдання Kling Videos Generation API, як показано на малюнку:

<p><img src="https://cdn.acedata.cloud/om6p6g.png" width="500" className="m-auto" /></p>

Нарешті, перейдіть на сторінку Tasks API [Kling Tasks API](https://platform.acedata.cloud/documents/kling-tasks) для отримання відповідної послуги, після входу на сторінку натисніть кнопку «Acquire», як показано на малюнку:
...
Kling Tasks API можна використовувати для перевірки результатів Kling Videos Generation API. Щоб дізнатися, як використовувати Kling Videos Generation API, будь ласка, зверніться до документа [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos).
