...
AI Chat v2 API (`/aichat2/conversations`) — це нове покоління інтерфейсу для діалогів, повна модернізація [AI Chat API](https://platform.acedata.cloud/documents/aichat-conversations). Воно розширює можливості v1, який був простим і підтримував багатокрокові діалоги, за рахунок:
...
Щоб користуватися API, потрібно подати заявку на відповідний сервіс на сторінці [AI Chat v2 API](https://platform.acedata.cloud/documents/aichat2-conversations). Після переходу натисніть кнопку «Acquire», щоб отримати необхідні облікові дані для запитів.
...
Якщо ви вже використовуєте [`/aichat/conversations`](https://platform.acedata.cloud/documents/aichat-conversations), перехід на v2 майже не вимагає змін у коді:
