...
Щоб використовувати Midjourney Tasks API, спочатку потрібно перейти на сторінку подачі заявки [Midjourney Imagine API](https://platform.acedata.cloud/documents/midjourney-imagine) для отримання відповідної послуги, а потім скопіювати ID завдання Imagine API, як показано на малюнку:

<p><img src="https://cdn.acedata.cloud/lx4mwb.png" width="500" className="m-auto" /></p>

Нарешті, перейдіть на сторінку Tasks API [Midjourney Tasks API](https://platform.acedata.cloud/documents/midjourney-tasks) для отримання відповідної послуги, після входу на сторінку натисніть кнопку «Acquire», як показано на малюнку:
...
Midjourney Tasks API можна використовувати для запиту результатів як Midjourney Imagine API, так і Midjourney Describe API. Щоб дізнатися, як використовувати Midjourney Imagine API, зверніться до документа [Midjourney Imagine API](https://platform.acedata.cloud/documents/midjourney-imagine-integration). Щоб дізнатися, як використовувати Midjourney Describe, зверніться до [Midjourney Describe API](https://platform.acedata.cloud/documents/midjourney-describe-integration).
