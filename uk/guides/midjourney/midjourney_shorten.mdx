...
Щоб користуватися Midjourney Shorten API, потрібно спочатку подати заявку на сторінці [Midjourney Shorten API](https://platform.acedata.cloud/documents/midjourney-shorten). Після переходу на сторінку натисніть кнопку «Acquire».
