...
Nano Banana Tasks API можна використовувати для перевірки результатів Nano Banana Images API. Щоб дізнатися, як використовувати Nano Banana Images API, будь ласка, зверніться до документа [Nano Banana Images API](https://platform.acedata.cloud/documents/veo-videos).
