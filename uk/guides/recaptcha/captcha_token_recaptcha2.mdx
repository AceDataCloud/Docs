---
title: "Recaptcha2 протокол розпізнавання API інтеграція"
description: "Recaptcha verification code recognition service API guide - Ace Data Cloud"
---

У цьому документі буде представлено опис інтеграції API розпізнавання протоколу Recaptcha2, який дозволяє користувачам не розпізнавати та не натискати на зображення коду Recaptcha2, а лише подати Website Key для автоматичного декодування на бекенді та завершення перевірки.

## Процес подачі заявки

Щоб використовувати API розпізнавання протоколу Recaptcha2, спочатку перейдіть до [консолі Ace Data Cloud](https://platform.acedata.cloud/console/applications) для отримання вашого API Token, зберігайте його для подальшого використання.
...
> 📘 Повна документація: [API розпізнавання протоколу Recaptcha2 →](https://platform.acedata.cloud/documents/captcha-token-recaptcha2)
