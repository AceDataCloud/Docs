...
Щоб використовувати Sora Tasks API, спочатку потрібно перейти на сторінку подачі заявки [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos) та подати заявку на відповідну послугу, а потім скопіювати ID завдання Sora Videos Generation API, як показано на малюнку:

<p><img src="https://cdn.acedata.cloud/za62pb.png" width="500" className="m-auto" /></p>

Нарешті, перейдіть на сторінку Tasks API [Sora Tasks API](https://platform.acedata.cloud/documents/sora-tasks) та подайте заявку на відповідну послугу, після входу на сторінку натисніть кнопку «Acquire», як показано на малюнку:
