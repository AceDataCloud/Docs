...
Ми візьмемо ID завдання, повернуте сервісом API SeeDream Images Generation, як приклад, щоб продемонструвати, як використовувати цей API. Припустимо, у нас є ID завдання: 20068983-0cc9-4c6a-aeb6-9c6a3c668be0, далі демонструємо, як передати ID завдання.
...
Повернення результату містить кілька полів, де `items` містить конкретну інформацію про пакетні завдання, кожне завдання має таку ж інформацію, як і в попередньому запиті на одинокий завдання.

- `items`, всі конкретні деталі пакетного завдання. Це масив, кожен елемент масиву має таку ж структуру, як і результат запиту на одинокий завдання.
- `count`, кількість пакетних запитів.

Кожен об'єкт завдання в пакетному результаті також має наступні поля часу.
