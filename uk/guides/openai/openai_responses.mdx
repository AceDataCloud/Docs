...
Щоб використовувати OpenAI Responses API, спочатку можна перейти на сторінку [OpenAI Responses API](https://platform.acedata.cloud/documents/openai-responses) і натиснути кнопку «Acquire», щоб отримати необхідні для запиту облікові дані:
