---
title: "OpenAI Images Generations API: Заявка та використання"
...
Щоб використовувати OpenAI Images Generations API, спочатку можна перейти на сторінку [OpenAI Images Generations API](https://platform.acedata.cloud/documents/fd932485-90c7-45d6-8394-1e14b6f07b2b) та натиснути кнопку «Acquire», щоб отримати необхідні для запиту облікові дані:
...
Webhook — це HTTP-сервіс, який приймає запити. Розробник повинен замінити URL на свій сервер. Для демонстрації можна використати публічний сервіс https://webhook.site/, де після відкриття сайту отримуємо Webhook URL:
