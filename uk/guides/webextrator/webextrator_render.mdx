...
| `callback_url`      | string   |  ❌  | —                          | URL для зворотного виклику в асинхронному режимі, платформа надішле повний результат на цю адресу, коли завдання буде завершено.                                    |
...
| `data.finalUrl`      | string         | Остаточний URL після редиректу.                                    |
...
[`/webextrator/tasks`](development_webextrator_tasks) можна запитати активно.
