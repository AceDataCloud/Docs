...
Після отримання ID голосового персонажа можна використовувати [Suno Audios Generation API](https://platform.acedata.cloud/documents/suno-audios) для генерації музики. Встановіть `action` у `generate`, а `persona_id` — у ID створеного голосового персонажа. Згенерована пісня буде виконана клонованим голосом.
