...
SUNO дозволяє нам завантажувати референсне аудіо для повторної творчості, цей документ пояснює методи інтеграції відповідного API.

Цей API має лише один вхідний параметр, а саме `audio_url`, який є відкритою CDN адресою, що підтримує розширення mp3.

Тут ми вводимо `audio_url`, який є `https://cdn.acedata.cloud/suno_demo.mp3`, це відкрита CDN адреса.
