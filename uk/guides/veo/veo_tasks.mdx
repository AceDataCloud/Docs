...
Розглянемо приклад з ID завдання, яке повертає сервіс API Veo Videos Generation. Припустимо, у нас є ID завдання: 1ebe4f2b-59ba-4385-a4ea-0ce8a3fe12ed, далі демонструємо, як передати це ID.
...
- `items`, всі конкретні деталі пакетних відеозавдань. Це масив, кожен елемент масиву має таку ж структуру, як і результат запиту на одне завдання.
