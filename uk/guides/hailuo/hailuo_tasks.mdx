...
Щоб використовувати Hailuo Videos Generation API, спочатку перейдіть до [консолі Ace Data Cloud](https://platform.acedata.cloud/console/applications) для отримання вашого API Token, залиште його на випадок потреби.
...
Розглянемо приклад з ID завдання, яке повертає сервіс Hailuo Videos Generation API. Припустимо, у нас є ID завдання: 58cc618b-9639-4ee7-add2-d2fcf260d9a3, далі покажемо, як передати це ID.
...
- `elapsed`, час виконання завдання, в секундах (з плаваючою комою, з трьома знаками після коми). Це поле не повертається, якщо завдання не завершено.
