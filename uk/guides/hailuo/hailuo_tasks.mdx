...
Розглянемо приклад з ID завдання, яке повертає сервіс Hailuo Videos Generation API. Припустимо, у нас є ID завдання: 58cc618b-9639-4ee7-add2-d2fcf260d9a3, далі ми покажемо, як передати цей ID.
