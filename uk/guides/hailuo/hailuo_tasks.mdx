...
Щоб використовувати Hailuo Videos Generation API, спочатку перейдіть до [консолі Ace Data Cloud](https://platform.acedata.cloud/console/applications) для отримання вашого API Token, зберігши його для подальшого використання.
...
Розглянемо приклад з ID завдання, яке повертає сервіс Hailuo Videos Generation API. Припустимо, у нас є ID завдання: 58cc618b-9639-4ee7-add2-d2fcf260d9a3, далі ми покажемо, як передати це ID.
