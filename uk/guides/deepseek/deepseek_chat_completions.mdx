...
Щоб використовувати DeepSeek Chat Completion API, спочатку можна перейти на сторінку [DeepSeek Chat Completion API](https://platform.acedata.cloud/documents/deepseek-chat-completions) та натиснути кнопку «Acquire», щоб отримати необхідні для запиту облікові дані:
