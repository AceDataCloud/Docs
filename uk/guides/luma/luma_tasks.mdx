...
Розглянемо приклад з ID завдання, яке повертає сервіс Luma Videos Generation API. Припустимо, у нас є ID завдання: 50fc6182-fa86-4c7d-ac12-2fa27ec2f151, далі покажемо, як передати цей ID.
...
Повернене значення містить кілька полів, поле request є тими даними, які були надіслані під час створення завдання, а поле response є відповіддю, яка повертається після завершення завдання, результати якої збігаються з запитом та відповіддю Luma Videos Generation API. Ось опис полів.
