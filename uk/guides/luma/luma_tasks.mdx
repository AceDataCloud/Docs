...
Розглянемо приклад з ID завдання, яке повертає сервіс Luma Videos Generation API. Припустимо, у нас є ID завдання: 50fc6182-fa86-4c7d-ac12-2fa27ec2f151, далі демонструється, як передати цей ID.
...
У відповіді є кілька полів, поле request - це тіло запиту, яке було надіслано для створення завдання, а поле response - це тіло відповіді, яке повертається після завершення завдання, його результати збігаються з запитом та відповіддю Luma Videos Generation API. Ось опис полів.
