...
Щоб використовувати Luma Tasks API, спочатку потрібно перейти на сторінку подачі заявки [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) для отримання відповідної послуги, а потім скопіювати ID завдання Luma Videos Generation API, як показано на малюнку:

![](https://cdn.acedata.cloud/ynk4ow.png)

Нарешті, перейдіть на сторінку Tasks API [Luma Tasks API](https://platform.acedata.cloud/documents/luma-tasks) для отримання відповідної послуги, після входу на сторінку натисніть кнопку «Acquire», як показано на малюнку:
...
Luma Tasks API можна використовувати для перевірки результатів Luma Videos Generation API. Щоб дізнатися, як використовувати Luma Videos Generation API, будь ласка, зверніться до документа [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos-integration).
