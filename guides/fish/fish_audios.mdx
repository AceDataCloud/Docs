...
description: "Integration guide for Fish music generation on Ace Data Cloud"
---
...
要使用 API，需要先到 [Fish Audios Generation API](https://platform.acedata.cloud/documents/e681b715-54fd-4464-a59a-d7f14500e095) 对应页面申请对应的服务，进入页面之后，点击「Acquire」按钮，如图所示：
