...
| 版本  | model           | 上线时间   | prompt 限制 | lyric 限制 | style 限制 | 歌曲最长时长 |
| :---- | :-------------- | :--------- | :---------- | :--------- | :--------- | :----------- |
| v5    | chirp-v5        | 2025.09.23 | 200         | 5000       | 1000       | 8 分钟       |
| v4.5+ | chirp-v4-5-plus | 2025.07.17 | 200         | 5000       | 1000       | 8 分钟       |
| v4.5  | chirp-v4-5      | 2025.05.03 | 200         | 5000       | 1000       | 4 分钟       |
| v4    | chirp-v4        | 2024.12.17 | 200         | 3000       | 200        | 150 秒       |
| v3.5  | chirp-v3-5      | ---        | 200         | 3000       | 200        | 120 秒       |

Suno 最新已将音乐生成模型升级到 V5 版本，调用最新的 V5 只需要把 model 参数修改为`chirp-v5`，可生成 9 分钟的歌曲。
...
- `model`：此次音乐生成任务的模型，默认是 `chirp-v3-5`，主要包含：`chirp-v3`、`chirp-v4`、`chirp-v3-5`、`chirp-v4-5`、`chirp-v4-5-plus`、 `chirp-v5`。
