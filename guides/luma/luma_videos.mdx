...
description: "Integration guide for Luma Video Generation on Ace Data Cloud"
---
...
要使用 Luma Videos API，首先可以到 [Luma Videos Generation API](https://platform.acedata.cloud/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) 页面点击「Acquire」按钮，获取请求所需要的凭证：
