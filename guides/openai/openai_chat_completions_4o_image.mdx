...
description: "Integration guide for OpenAI generation on Ace Data Cloud"
---
...
要使用 OpenAI Chat Completion 4o Image API，首先可以到 [OpenAI Chat Completion 4o Image API](https://platform.acedata.cloud/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) 页面点击「Acquire」按钮，获取请求所需要的凭证：
...
其中`choices`里面的`message`就是生成完整的对话结果，图片结果也包含在对话结果里面，可以看出生成的图片确实是动漫风格的，具体的如下图所示：
