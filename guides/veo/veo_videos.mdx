...
description: "Integration guide for Veo Video Generation on Ace Data Cloud"
---
...
| **veo3-fast**           | 文生视频（无图）<br>图生视频 模式（有图）                                      | **1 张** → 首帧模式<br>**3 张** → 首尾帧模式                                  |
| **veo31-fast**          | 文生视频（无图）<br>图生视频 模式（有图）                                      | **1 张** → 首帧模式<br>**3 张** → 首尾帧模式                                  |
| **veo31-fast-ingredients** | ❌ 文生视频（不支持）<br>✅ **强制多图融合**（必须传图）                 | **1-3 张** → 多图融合模式（最多 3 张）                                        |
| **veo2**                | 文生视频（无图）<br>图生视频 模式（有图）                                      | **1 张** → 首帧模式<br>**3 张** → 首尾帧模式                                  |
| **veo3**                | 文生视频（无图）<br>图生视频 模式（有图）                                      | **1 张** → 首帧模式<br>**3 张** → 首尾帧模式                                  |
| **veo31**               | 文生视频（无图）<br>图生视频 模式（有图）                                      | **1 张** → 首帧模式<br>**3 张** → 首尾帧模式                                  |
...
- **图片数量限制**：  
  - 除 `veo31-fast-ingredients` 外，其他模型最多支持 **3 张**图片输入。
