...
Для использования Midjourney Shorten API необходимо подать заявку на странице [Midjourney Shorten API](https://platform.acedata.cloud/documents/midjourney-shorten). После перехода на страницу нажмите кнопку «Acquire».
