...
Чтобы использовать Luma Tasks API, сначала необходимо перейти на страницу заявки [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) и подать заявку на соответствующую услугу, затем скопировать ID задачи Luma Videos Generation API, как показано на рисунке:

![](https://cdn.acedata.cloud/ynk4ow.png)

Затем перейдите на страницу Tasks API [Luma Tasks API](https://platform.acedata.cloud/documents/luma-tasks) и подайте заявку на соответствующую услугу, после перехода на страницу нажмите кнопку «Acquire», как показано на рисунке:
