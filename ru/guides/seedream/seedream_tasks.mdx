...
Чтобы использовать SeeDream Images Generation API, сначала получите ваш API Token в [консоли Ace Data Cloud](https://platform.acedata.cloud/console/applications) для дальнейшего использования.
...
Мы возьмем в качестве примера ID задачи, возвращенный сервисом SeeDream Images Generation API, и продемонстрируем, как использовать этот API. Предположим, у нас есть ID задачи: 20068983-0cc9-4c6a-aeb6-9c6a3c668be0, далее мы покажем, как передать этот ID задачи.
...
- `items`, все конкретные детали пакетной задачи. Это массив, каждый элемент массива имеет такую же структуру, как и результат запроса на получение одной задачи.
...
С помощью этого документа вы узнали, как использовать SeeDream Tasks API для запроса всех конкретных деталей информации о одной или пакетной задаче. Надеемся, что этот документ поможет вам лучше интегрировать и использовать этот API. Если у вас есть какие-либо вопросы, пожалуйста, не стесняйтесь обращаться в нашу техническую поддержку.
