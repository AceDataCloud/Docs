...
Чтобы использовать API, сначала необходимо перейти на соответствующую страницу [hCaptcha Протокол Распознавания API](https://platform.acedata.cloud/documents/34806b3a-f0f6-45c5-b8b1-143ced7b9393) и подать заявку на соответствующую услугу. После перехода на страницу нажмите кнопку «Acquire», как показано на изображении:
