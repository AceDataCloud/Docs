...
Мы возьмем один ID задачи, возвращенный сервисом Hailuo Videos Generation API, в качестве примера, чтобы продемонстрировать, как использовать этот API. Предположим, у нас есть ID задачи: 58cc618b-9639-4ee7-add2-d2fcf260d9a3, далее мы покажем, как передать этот ID задачи.
