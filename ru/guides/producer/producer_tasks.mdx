...
- `id` — идентификатор задачи, используемый для уникальной идентификации данной задачи.
- `request` — информация о запросе в задаче.
- `response` — информация о возвращаемом результате в задаче.
...
Это запрос для получения деталей нескольких задач по их идентификаторам, в отличие от вышеуказанного, необходимо выбрать действие как retrieve_batch.
...
С помощью этого документа вы узнали, как использовать API Producer Tasks для запроса всех конкретных деталей о единичных или пакетных задачах. Надеемся, что этот документ поможет вам лучше интегрироваться и использовать этот API. Если у вас есть какие-либо вопросы, пожалуйста, не стесняйтесь обращаться в нашу техническую поддержку.
