...
Для использования API необходимо подать заявку на соответствующем [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos) сайте. После перехода нажмите кнопку «Acquire», как показано на рисунке:
