...
> 分页检索现有音色请参考 [Fish Model Query API](https://platform.acedata.cloud/documents/fish-model-query)；按 `_id` 查询单个音色详情请参考 [Fish Model Get API](https://platform.acedata.cloud/documents/fish-model-get)。
