...
Для использования API необходимо сначала подать заявку на соответствующую услугу на странице [Fish Model API](https://platform.acedata.cloud/services/fish), нажав кнопку «Acquire».
