...
Чтобы использовать Gemini Chat Completion API, сначала перейдите на страницу [Gemini Chat Completion API](https://platform.acedata.cloud/documents/gemini-chat-completions) и нажмите кнопку «Acquire», чтобы получить необходимые для запроса учетные данные:
