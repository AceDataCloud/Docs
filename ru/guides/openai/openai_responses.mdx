...
Чтобы использовать OpenAI Responses API, сначала перейдите на страницу [OpenAI Responses API](https://platform.acedata.cloud/documents/openai-responses) и нажмите кнопку «Acquire», чтобы получить необходимые для запроса учетные данные:
