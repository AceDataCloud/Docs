...
Для использования OpenAI Images Edits API сначала перейдите на страницу [OpenAI Images Edits API](https://platform.acedata.cloud/documents/openai-images-edits) и нажмите кнопку «Acquire», чтобы получить необходимые для запросов креденшлы:
