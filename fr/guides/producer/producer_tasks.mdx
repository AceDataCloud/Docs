...
Enfin, accédez à la page de l'API Tasks [Producer Tasks API](https://platform.acedata.cloud/documents/producer-tasks) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué dans l'image ci-dessous :
