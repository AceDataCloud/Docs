...
Prenons un exemple avec un ID de tâche retourné par le service API Producer Audios Generation, pour démontrer comment utiliser cette API. Supposons que nous ayons un ID de tâche : 1a6ac2ad-10f2-4e2b-b500-66ec27fe82ad, nous allons maintenant démontrer comment procéder en passant cet ID de tâche.
...
Les résultats contiennent plusieurs champs, où les éléments incluent les détails spécifiques des tâches en lot, chaque tâche ayant des informations spécifiques au même format que le résultat de la requête d'une seule tâche ci-dessus, les informations des champs sont les suivantes.
