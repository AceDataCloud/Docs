...
Prenons un exemple avec un ID de tâche retourné par le service Luma Videos Generation, pour démontrer comment utiliser cette API. Supposons que nous ayons un ID de tâche : 50fc6182-fa86-4c7d-ac12-2fa27ec2f151, nous allons maintenant démontrer comment procéder en passant cet ID de tâche.
