...
Pour utiliser l'API Luma Tasks, vous devez d'abord vous rendre sur la page de demande [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) pour demander le service correspondant, puis copier l'ID de tâche de l'API Luma Videos Generation, comme indiqué sur l'image :

![](https://cdn.acedata.cloud/ynk4ow.png)

Enfin, accédez à la page de l'API Tasks [Luma Tasks API](https://platform.acedata.cloud/documents/luma-tasks) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué sur l'image :
...
L'API Luma Tasks peut être utilisée pour interroger les résultats de l'API Luma Videos Generation. Pour savoir comment utiliser l'API Luma Videos Generation, veuillez consulter le document [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos-integration).
