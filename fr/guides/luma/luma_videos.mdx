...
Pour utiliser l'API Luma Videos, vous pouvez d'abord vous rendre sur la page [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) et cliquer sur le bouton « Acquire » pour obtenir les informations d'identification nécessaires à la demande :
