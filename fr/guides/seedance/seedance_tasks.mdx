...
Retourne les résultats avec plusieurs champs, où `items` contient les détails spécifiques des tâches en lot, chaque tâche ayant des informations spécifiques identiques aux champs de la requête d'une seule tâche ci-dessus.
