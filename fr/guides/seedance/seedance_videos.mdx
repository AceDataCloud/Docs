...
La génération multimodale ordinaire peut omettre `omni_reference_task_type`, le définissant sur `auto`, ou le définissant explicitement sur `reference`. L'édition et la prolongation de vidéos doivent inclure `reference_video` :

```json
{
  "model": "doubao-seedance-2-5-260628",
  "content": [
    {"type": "text", "text": "Remplacez le ciel par un coucher de soleil chaud tout en préservant le sujet et le mouvement de la caméra."},
...
payload = {
    ...
    "content": [
        {
            "type": "text",
            "text": "La femme regarde la caméra, donne un sourire naturel chaleureux et agite la main, éclairage doux en studio, léger zoom de la caméra."
        },
        {
            "type": "image_url",
...
```json
{
  ...
  "content": [
    {
      "type": "text",
      "text": "La même femme portant un manteau beige marche à travers un parc d'automne ensoleillé, des feuilles dorées tombant autour d'elle, elle sourit doucement à la caméra, plan de suivi cinématographique."
    },
    {
      "type": "image_url",
      "role": "reference_image",
