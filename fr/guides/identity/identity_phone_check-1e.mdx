...
Pour utiliser l'API, vous devez d'abord vous rendre sur la page correspondante de l'[API de vérification de l'état du numéro de téléphone](https://platform.acedata.cloud/documents/identity-phone-check-1e) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué sur l'image :
