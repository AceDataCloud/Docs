...
Pour utiliser l'API, vous devez d'abord vous rendre sur la page correspondante de l'[API de vérification des trois éléments du numéro de téléphone](https://platform.acedata.cloud/documents/identity-phone-check-3e) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué dans l'image :
