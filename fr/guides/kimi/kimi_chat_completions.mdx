...
Pour utiliser l'API Gemini Chat Completion, vous pouvez d'abord vous rendre sur la page [Kimi Chat Completion API](https://platform.acedata.cloud/documents/kimi-chat-completions) et cliquer sur le bouton « Acquire » pour obtenir les informations d'identification nécessaires à la demande :
