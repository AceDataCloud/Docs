...
Pour utiliser l'API, vous devez d'abord vous rendre sur la page correspondante de [Short URL API](https://platform.acedata.cloud/documents/shorturl) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué sur l'image :
