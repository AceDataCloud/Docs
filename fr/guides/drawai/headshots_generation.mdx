...
Pour utiliser l'API, vous devez d'abord vous rendre sur la page correspondante de l'[API de création de photos d'identité AI](https://platform.acedata.cloud/documents/headshots-generate) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué sur l'image :
