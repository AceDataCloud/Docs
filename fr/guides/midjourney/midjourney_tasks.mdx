...
Prenons un exemple avec un ID de tâche retourné par le service Midjourney Imagine API. Supposons que nous ayons un ID de tâche : 7489df4c-ef03-4de0-b598-e9a590793434, nous allons maintenant démontrer comment procéder en passant cet ID de tâche.
