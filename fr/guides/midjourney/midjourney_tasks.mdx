...
Pour utiliser l'API Midjourney Tasks, vous devez d'abord vous rendre sur la page de demande [Midjourney Imagine API](https://platform.acedata.cloud/documents/midjourney-imagine) pour demander le service correspondant, puis copier l'ID de tâche de l'API Imagine, comme indiqué dans l'image ci-dessous :

<p><img src="https://cdn.acedata.cloud/lx4mwb.png" width="500" className="m-auto" /></p>

Enfin, accédez à la page de l'API Tasks [Midjourney Tasks API](https://platform.acedata.cloud/documents/midjourney-tasks) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué dans l'image ci-dessous :
...
L'API Midjourney Tasks peut être utilisée pour interroger les résultats des API Midjourney Imagine et Midjourney Describe. Pour savoir comment utiliser l'API Midjourney Imagine, veuillez consulter le document [Midjourney Imagine API](https://platform.acedata.cloud/documents/midjourney-imagine-integration). Pour savoir comment utiliser Midjourney Describe, veuillez consulter [Midjourney Describe API](https://platform.acedata.cloud/documents/midjourney-describe-integration).
