...
Pour utiliser l’API Midjourney Shorten, il faut d’abord faire une demande sur la page [Midjourney Shorten API](https://platform.acedata.cloud/documents/midjourney-shorten). Sur la page, cliquez sur le bouton « Acquire ».
