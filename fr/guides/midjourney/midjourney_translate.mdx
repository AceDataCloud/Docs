...
Pour utiliser l'API Midjourney Translate, vous devez d'abord vous rendre sur la page de demande [Midjourney Translate API](https://platform.acedata.cloud/documents/midjourney-translate) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué dans l'image :
