...
Pour utiliser l'API Midjourney Describe, vous devez d'abord vous rendre sur la page de demande [Midjourney Describe API](https://platform.acedata.cloud/documents/midjourney-describe) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué sur l'image :
