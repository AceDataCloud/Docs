...
Pour utiliser l'API de Complétion de Chat DeepSeek, vous pouvez d'abord vous rendre sur la page [API de Complétion de Chat DeepSeek](https://platform.acedata.cloud/documents/deepseek-chat-completions) et cliquer sur le bouton « Acquire » pour obtenir les informations d'identification nécessaires à la demande :
