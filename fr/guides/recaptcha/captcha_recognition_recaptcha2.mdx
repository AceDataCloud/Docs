...
Cet article présente une documentation sur l'API de reconnaissance d'image Recaptcha2, qui peut identifier le contenu saisi par l'utilisateur et l'image du captcha Recaptcha2, puis renvoyer les coordonnées des petites images à cliquer pour compléter la vérification.
...
Après sélection, vous pouvez voir que le code correspondant est également généré à droite, comme montré ci-dessous :
...
- `solution`, le résultat de la vérification après le traitement de l'image du captcha Recaptcha2.
    ...
    - `confidences`, le niveau de confiance des zones reconnues de l'image du captcha Recaptcha2, les zones commencent à partir de 0.
