---
title: "Documentation de l'API de reconnaissance du protocole Recaptcha2"
description: "Recaptcha verification code recognition service API guide - Ace Data Cloud"
---

Cet article présente une documentation sur l'API de reconnaissance du protocole Recaptcha2, qui permet aux utilisateurs de valider sans avoir à reconnaître et à cliquer sur les images de captcha Recaptcha2, il leur suffit de soumettre la clé du site Web pour réaliser un décodage automatique en arrière-plan et compléter la validation.

## Processus de demande

Pour utiliser l'API de reconnaissance du protocole Recaptcha2, commencez par obtenir votre jeton API sur le [tableau de bord d'Ace Data Cloud](https://platform.acedata.cloud/console/applications) pour le garder en réserve.
...
> 📘 Documentation complète : [API de reconnaissance du protocole Recaptcha2 →](https://platform.acedata.cloud/documents/captcha-token-recaptcha2)
...
On peut voir que nous avons obtenu le résultat de vérification du traitement de Recaptcha2, que nous pouvons ensuite utiliser pour POST ou simuler une soumission au site cible, à usage unique, valable 120 secondes, recommandé d'utiliser dans les 60 secondes. Ensuite, nous fournirons un extrait de code Python pour soumettre le token traité au site cible afin de passer le Recaptcha2.
