...
Pour utiliser l'API, vous devez d'abord vous rendre sur la page correspondante de l'[API de reconnaissance de protocole Recaptcha2](https://platform.acedata.cloud/documents/captcha-token-recaptcha2) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué ci-dessous :
