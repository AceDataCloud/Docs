...
Pour utiliser l'API, vous devez d'abord demander le service correspondant sur la page [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos). Une fois sur la page, cliquez sur le bouton « Acquire », comme illustré ci-dessous :
