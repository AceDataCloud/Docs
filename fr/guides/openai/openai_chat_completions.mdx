...
Pour utiliser l'API de Complétion de Chat OpenAI, vous pouvez d'abord vous rendre sur la page [OpenAI Chat Completion API](https://platform.acedata.cloud/documents/openai-chat-completions) et cliquer sur le bouton « Acquire » pour obtenir les informations d'identification nécessaires à la demande :
