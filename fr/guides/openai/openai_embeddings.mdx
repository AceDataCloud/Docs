...
Pour utiliser l'API OpenAI Embeddings, vous pouvez d'abord vous rendre sur la page [OpenAI Embeddings API](https://platform.acedata.cloud/documents/openai-embeddings) et cliquer sur le bouton « Acquire » pour obtenir les informations d'identification nécessaires à la demande :
