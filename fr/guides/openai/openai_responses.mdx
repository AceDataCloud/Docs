...
Pour utiliser l'API des réponses OpenAI, vous pouvez d'abord vous rendre sur la page [API des réponses OpenAI](https://platform.acedata.cloud/documents/openai-responses) et cliquer sur le bouton « Acquérir » pour obtenir les informations d'identification nécessaires à la demande :
