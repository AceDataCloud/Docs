...
Pour utiliser l'API Claude Messages, vous pouvez d'abord vous rendre sur la page [Claude Messages API](https://platform.acedata.cloud/documents/claude-chat-completions) et cliquer sur le bouton « Acquire » pour obtenir les informations d'identification nécessaires à la demande :
