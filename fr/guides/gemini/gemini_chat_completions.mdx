...
Gemini 3.1 Pro est une version améliorée de Gemini 3.0 Pro, avec un modèle sous-jacent `gemini-3.1-pro-preview`, qui prend également en charge les entrées multimodales telles que le texte, les images et les vidéos, avec des capacités de raisonnement et de compréhension plus fortes. L'utilisation est identique à celle de Gemini 3.0 Pro, il suffit de remplacer le paramètre `model` par `gemini-3.1-pro`.
