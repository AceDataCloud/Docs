...
Nous pouvons voir que nous avons obtenu le résultat de vérification du traitement de l'image CAPTCHA numérique en anglais de longueur variable, et nous pouvons passer la vérification en fonction du contenu textuel dans le champ `text`.
