...
- `started_at`, `finished_at` : les heures de début et de fin du traitement de cette demande (ISO-8601 UTC).
- `elapsed` : le temps total de traitement (en secondes).

Nous avons obtenu le résultat de vérification du traitement de l'image CAPTCHA numérique en anglais de longueur variable, et nous pouvons passer la vérification en nous basant sur le contenu textuel du champ `text`.
