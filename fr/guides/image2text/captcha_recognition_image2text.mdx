...
Pour utiliser l'API, vous devez d'abord vous rendre sur la page correspondante de l'[API de reconnaissance de CAPTCHA numérique en anglais](https://platform.acedata.cloud/documents/captcha-recognition-image2text) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué dans l'image ci-dessous :
