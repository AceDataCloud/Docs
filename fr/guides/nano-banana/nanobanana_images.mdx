...
Avant utilisation, veuillez accéder à [Nano Banana Images API](https://platform.acedata.cloud/documents/nano-banana-images) sur la plateforme Ace Data Cloud et cliquer sur Acquire pour demander l'activation. La première demande dispose généralement d'un quota gratuit disponible. Une fois l'activation terminée, vous pourrez obtenir le Bearer Token nécessaire pour appeler l'API sur la plateforme.
