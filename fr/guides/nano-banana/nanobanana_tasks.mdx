...
L'API Nano Banana Tasks peut être utilisée pour interroger les résultats de l'API Nano Banana Images. Pour savoir comment utiliser l'API Nano Banana Images, veuillez consulter le document [API Nano Banana Images](https://platform.acedata.cloud/documents/veo-videos).
