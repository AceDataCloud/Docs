...
Prenons un exemple avec un ID de tâche retourné par le service Suno Audios Generation, pour démontrer comment utiliser cette API. Supposons que nous avons un ID de tâche : eae26f89-b64b-404d-a80c-761996660b1c, nous allons maintenant démontrer comment passer cet ID de tâche.
...
Lors de l'appel de l'API, si une erreur se produit, l'API renverra le code d'erreur et le message correspondant. Par exemple :
...
Grâce à ce document, vous avez compris comment utiliser l'API Suno Tasks pour interroger les détails spécifiques d'une tâche musicale unique ou en lot. Nous espérons que ce document vous aidera à mieux intégrer et utiliser cette API. Si vous avez des questions, n'hésitez pas à contacter notre équipe de support technique.
