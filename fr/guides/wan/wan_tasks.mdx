...
Ce document détaillera les instructions d'intégration de l'API Wan Tasks, vous aidant à intégrer facilement et à tirer pleinement parti de la puissance de cette API. Grâce à l'API Wan Tasks, vous pouvez facilement interroger l'état d'exécution des tâches de l'API Wan Videos Generation.

## Processus de demande

Pour utiliser l'API Wan Videos Generation, commencez par obtenir votre token API sur le [tableau de bord Ace Data Cloud](https://platform.acedata.cloud/console/applications) pour le conserver en réserve.
