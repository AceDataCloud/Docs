...
Pour utiliser l'API Sora Tasks, vous devez d'abord vous rendre sur la page de demande [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos) pour demander le service correspondant, puis copier l'ID de tâche de l'API Sora Videos Generation, comme indiqué sur l'image :

<p><img src="https://cdn.acedata.cloud/za62pb.png" width="500" className="m-auto" /></p>

Enfin, accédez à la page de l'API Tasks [Sora Tasks API](https://platform.acedata.cloud/documents/sora-tasks) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué sur l'image :
