...
Pour utiliser l’API, vous devez d’abord faire une demande de service sur la page correspondante de [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos). Une fois sur la page, cliquez sur le bouton « Acquire », comme illustré ci-dessous :
