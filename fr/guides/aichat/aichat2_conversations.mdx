...
L'API AI Chat v2 (`/aichat2/conversations`) est la nouvelle génération d'interface de conversation, une version entièrement améliorée de l'[API AI Chat](https://platform.acedata.cloud/documents/aichat-conversations). Elle étend la simplicité et la gestion des conversations multi-tours de la v1 avec :
...
Pour utiliser l’API, rendez-vous sur la page correspondante de l'[API AI Chat v2](https://platform.acedata.cloud/documents/aichat2-conversations) et cliquez sur le bouton « Acquire » pour obtenir les identifiants nécessaires.
...
Si vous utilisez déjà [`/aichat/conversations`](https://platform.acedata.cloud/documents/aichat-conversations), la migration vers v2 nécessite peu de modifications :
