...
Pour utiliser l'API QR Code artistique, vous pouvez d'abord vous rendre sur la page [API QR Code artistique](https://data.zhishuyun.com/documents/qrart-generate "API QR Code artistique") et cliquer sur le bouton « Obtenir » :
