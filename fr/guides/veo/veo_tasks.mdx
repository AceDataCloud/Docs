...
L'API Veo Tasks peut être utilisée pour interroger les résultats de l'API Veo Videos Generation. Pour savoir comment utiliser l'API Veo Videos Generation, veuillez consulter la documentation [Veo Videos Generation API](https://platform.acedata.cloud/documents/veo-videos).

Prenons un exemple avec un ID de tâche retourné par le service Veo Videos Generation, pour démontrer comment utiliser cette API. Supposons que nous ayons un ID de tâche : 1ebe4f2b-59ba-4385-a4ea-0ce8a3fe12ed, nous allons maintenant démontrer comment procéder en passant cet ID de tâche.
...
Ceci est destiné à interroger les détails des tâches vidéo pour plusieurs ID de tâches, contrairement à ce qui précède, il est nécessaire de sélectionner l'action comme retrieve_batch.
...
Retourne les résultats avec plusieurs champs, où les éléments contiennent les détails spécifiques des tâches vidéo en lot, chaque information spécifique de la tâche vidéo est identique aux champs ci-dessus.
