...
Pour utiliser l'API, vous devez d'abord vous rendre sur la page correspondante de l'[API de détection de vie statique du visage (version haute précision)](https://platform.acedata.cloud/documents/face-detect-live) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué dans l'image ci-dessous :
