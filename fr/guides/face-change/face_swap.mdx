...
Pour utiliser l'API Face Swap, vous devez d'abord vous rendre sur la page de demande [Face Swap API](https://platform.acedata.cloud/documents/face-swap) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué dans l'image ci-dessous :
