...
Pour utiliser l'API, vous devez d'abord vous rendre sur la page correspondante de l'[API de localisation des traits du visage](https://platform.acedata.cloud/documents/face-analyze) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué ci-dessous :
