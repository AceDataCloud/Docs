...
Pour utiliser l’API, il faut d’abord demander le service correspondant sur la page [Fish TTS API](https://platform.acedata.cloud/services/fish). Une fois sur la page, cliquez sur le bouton « Acquire ».
...
Il est également possible d’utiliser la [Fish Tasks API](https://platform.acedata.cloud/documents/fish-tasks) pour interroger activement l’état d’une tâche via `task_id`.
