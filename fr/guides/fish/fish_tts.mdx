...
`audio_url` pointe vers le CDN de cette plateforme, pouvant être téléchargé directement via GET ou joué dans `<audio>`. Le lien est valable à long terme, mais il est toujours conseillé de conserver une copie dans votre propre stockage.
