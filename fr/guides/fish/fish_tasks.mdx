...
Pour utiliser l'API Fish Tasks, vous devez d'abord vous rendre sur la page de demande [Fish Audios Generation API](https://platform.acedata.cloud/documents/fish-audios) pour demander le service correspondant, puis copier l'ID de tâche de l'API Fish Audios Generation, comme indiqué dans l'image ci-dessous :
