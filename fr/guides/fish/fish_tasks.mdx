...
Prenons un exemple avec un ID de tâche retourné par le service Fish Audios Generation. Supposons que nous ayons un ID de tâche : 2725a2d3-f87e-4905-9c53-9988d5a7b2f5, nous allons maintenant démontrer comment procéder en passant cet ID de tâche.
...
Retourne les résultats avec plusieurs champs, où les éléments contiennent les détails spécifiques des tâches en lot, chaque tâche ayant des informations spécifiques identiques aux champs de la requête précédente pour une tâche unique.
