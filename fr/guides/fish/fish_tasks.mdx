...
Pour utiliser l'API Fish Tasks, vous devez d'abord vous rendre sur la page de demande [Fish Audios Generation API](https://platform.acedata.cloud/documents/fish-tts) pour demander le service correspondant, puis copier l'ID de tâche de l'API Fish Audios Generation, comme indiqué dans l'image ci-dessous :

<p><img src="https://cdn.acedata.cloud/jxvue8.png" width="500" className="m-auto" /></p>

Enfin, accédez à la page de l'API Tasks [Fish Tasks API](https://platform.acedata.cloud/documents/fish-tasks) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué dans l'image ci-dessous :
...
L'API Fish Tasks peut être utilisée pour interroger les résultats de l'API Fish Audios Generation. Pour savoir comment utiliser l'API Fish Audios Generation, veuillez consulter le document [Fish Videos Generation API](https://platform.acedata.cloud/documents/fish-tts-integration).
