...
La API AI Chat v2 (`/aichat2/conversations`) es la nueva generación de la interfaz de conversación, una versión completamente mejorada de la [API AI Chat](https://platform.acedata.cloud/documents/aichat-conversations). Basada en la simplicidad y gestión de conversaciones múltiples de la versión v1, se ha ampliado con:
...
Para usar la API, primero debes solicitar el servicio correspondiente en la página de [AI Chat v2 API](https://platform.acedata.cloud/documents/aichat2-conversations). Al ingresar, haz clic en el botón «Acquire» para obtener las credenciales necesarias para las solicitudes.
...
Si ya usas [`/aichat/conversations`](https://platform.acedata.cloud/documents/aichat-conversations), migrar a v2 casi no requiere cambios:
