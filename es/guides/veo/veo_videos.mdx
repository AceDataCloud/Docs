...
Para utilizar la API, primero debe ir a la página correspondiente de [Veo Videos Generation API](https://platform.acedata.cloud/documents/veo-videos) para solicitar el servicio correspondiente. Una vez en la página, haga clic en el botón "Acquire", como se muestra en la imagen:
