...
- `token`, el resultado de la verificación tras procesar la tarea del captcha hCaptcha.
- `started_at` y `finished_at`: el tiempo de inicio y finalización del procesamiento de esta solicitud, en formato de marca de tiempo Unix (segundos, flotante).
- `elapsed`: el tiempo total consumido en este procesamiento (segundos).
