...
Para utilizar la API de reconocimiento del protocolo hCaptcha, primero dirígete a [la consola de Ace Data Cloud](https://platform.acedata.cloud/console/applications) para obtener tu token de API, que debes guardar como respaldo.
...
- `token`, el resultado de la verificación de la tarea del captcha hCaptcha.
- `started_at`, `finished_at`: el tiempo de inicio y finalización de esta solicitud (ISO-8601 UTC).
