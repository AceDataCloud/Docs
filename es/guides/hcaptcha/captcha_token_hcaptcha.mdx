...
- `rqdata`: opcional. El desafío de hCaptcha Enterprise puede proporcionar `data-rqdata` en la página, si te enfrentas a este tipo de desafío, completa su valor original; no es necesario para el hCaptcha normal.
...
- `started_at`, `finished_at`: el tiempo de inicio y finalización de esta solicitud, en formato de marca de tiempo Unix (segundos, flotante).
