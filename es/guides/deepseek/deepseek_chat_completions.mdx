...
Para usar la API de Finalización de Chat de DeepSeek, primero puedes ir a la página de [API de Finalización de Chat de DeepSeek](https://platform.acedata.cloud/documents/deepseek-chat-completions) y hacer clic en el botón "Acquire" para obtener las credenciales necesarias para la solicitud:
