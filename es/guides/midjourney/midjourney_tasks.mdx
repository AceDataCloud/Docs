...
Para utilizar la API de Tareas de Midjourney, primero debe ir a la página de solicitud [Midjourney Imagine API](https://platform.acedata.cloud/documents/midjourney-imagine) para solicitar el servicio correspondiente, y luego copiar el ID de tarea de la API Imagine, como se muestra en la imagen:

<p><img src="https://cdn.acedata.cloud/lx4mwb.png" width="500" className="m-auto" /></p>

Finalmente, acceda a la página de la API de Tareas [Midjourney Tasks API](https://platform.acedata.cloud/documents/midjourney-tasks) para solicitar el servicio correspondiente. Una vez en la página, haga clic en el botón "Acquire", como se muestra en la imagen:
...
La API de Tareas de Midjourney se puede utilizar para consultar los resultados de las APIs de Midjourney Imagine y Midjourney Describe. Para saber cómo utilizar la API de Midjourney Imagine, consulte el documento [Midjourney Imagine API](https://platform.acedata.cloud/documents/midjourney-imagine-integration). Para saber cómo utilizar Midjourney Describe, consulte [Midjourney Describe API](https://platform.acedata.cloud/documents/midjourney-describe-integration).
