...
Para usar la API Midjourney Shorten, primero debe solicitar el servicio correspondiente en la página [Midjourney Shorten API](https://platform.acedata.cloud/documents/midjourney-shorten). Al ingresar, haga clic en el botón «Acquire».
