...
Para usar la API de OpenAI Chat Completion, primero puedes ir a la página de [OpenAI Chat Completion API](https://platform.acedata.cloud/documents/openai-chat-completions) y hacer clic en el botón "Acquire" para obtener las credenciales necesarias para la solicitud:
