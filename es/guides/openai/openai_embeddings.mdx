...
Para utilizar la API de Embeddings de OpenAI, primero puede ir a la página de [API de Embeddings de OpenAI](https://platform.acedata.cloud/documents/openai-embeddings) y hacer clic en el botón "Acquire" para obtener las credenciales necesarias para la solicitud:
