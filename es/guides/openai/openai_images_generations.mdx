...
Para usar la API de Generación de Imágenes de OpenAI, primero puede ir a la página [OpenAI Images Generations API](https://platform.acedata.cloud/documents/openai-images-generations) y hacer clic en el botón "Acquire" para obtener las credenciales necesarias para realizar solicitudes:
