...
Para usar la API de Respuestas de OpenAI, primero puede ir a la página de [API de Respuestas de OpenAI](https://platform.acedata.cloud/documents/openai-responses) y hacer clic en el botón "Adquirir" para obtener las credenciales necesarias para la solicitud:
