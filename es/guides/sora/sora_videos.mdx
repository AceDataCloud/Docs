...
Para usar la API, primero debe solicitar el servicio correspondiente en la página [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos). Al ingresar a la página, haga clic en el botón "Acquire", como se muestra en la imagen:
