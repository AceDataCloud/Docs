...
Para utilizar la extracción de la IP de ADSL y agregar IPs a la lista blanca del Proxy ADSL, primero puedes ir a las páginas de [API de Extracción de Proxy ADSL](https://platform.acedata.cloud/documents/adsl-extract) y [API de Lista Blanca de Proxy ADSL](https://platform.acedata.cloud/documents/adsl-whitelist) y hacer clic en el botón "Adquirir" para obtener las credenciales necesarias para la solicitud:
...
A continuación, puedes completar el contenido correspondiente en la interfaz de [API de Extracción de Proxy ADSL](https://platform.acedata.cloud/documents/adsl-extract), a continuación se muestra cómo extraer la IP de ADSL.
