...
Para utilizar la API de Wan Videos Generation, primero debe obtener su token de API en el [panel de control de Ace Data Cloud](https://platform.acedata.cloud/console/applications) y guardarlo para uso futuro.

![](https://cdn.acedata.cloud/5hmkdg.jpg)

Si aún no ha iniciado sesión o registrado, será redirigido automáticamente a la página de inicio de sesión que le invitará a registrarse e iniciar sesión; una vez completado, regresará automáticamente a la página actual.
...
- `id`, el ID que generó esta tarea de video, utilizado para identificar de manera única esta tarea de generación de video.
