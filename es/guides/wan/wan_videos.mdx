...
Para utilizar la API, primero debe ir a la página correspondiente de [Wan Videos Generation API](https://platform.acedata.cloud/documents/wan-videos) para solicitar el servicio correspondiente. Una vez en la página, haga clic en el botón "Acquire", como se muestra en la imagen:
