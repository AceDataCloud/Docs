...
Este documento detallará las instrucciones de integración de la API de Luma Tasks, ayudándole a integrar fácilmente y aprovechar al máximo las potentes funciones de esta API. A través de la API de Luma Tasks, puede consultar fácilmente el estado de ejecución de las tareas de la API de Luma Videos Generation.
