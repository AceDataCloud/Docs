...
Para usar la API de Luma Videos, primero puedes ir a la página de [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) y hacer clic en el botón "Acquire" para obtener las credenciales necesarias para la solicitud:
