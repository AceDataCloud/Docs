...
Con el ID del personaje de voz, podemos usar la [Suno Audios Generation API](https://platform.acedata.cloud/documents/suno-audios) para generar música. Establece `action` a `generate` y `persona_id` al ID del personaje de voz obtenido arriba; la canción generada usará la voz clonada para la interpretación.
