...
Para usar la API de código QR artístico, primero puedes ir a la página de [API de código QR artístico](https://data.zhishuyun.com/documents/qrart-generate "API de código QR artístico") y hacer clic en el botón "Obtener":
