...
## Ejemplo 2: Usando tono de voz clonado `reference_id`
...
También se puede usar [Fish Tasks API](https://platform.acedata.cloud/documents/fish-tasks) para obtener resultados activamente por `task_id`, ver la documentación para más detalles.
