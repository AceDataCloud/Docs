...
Para usar la API, primero debe solicitar el servicio correspondiente en la página de [Fish TTS API](https://platform.acedata.cloud/services/fish). Al ingresar a la página, haga clic en el botón «Acquire».
...
También puede usar la [Fish Tasks API](https://platform.acedata.cloud/documents/fish-tasks) para consultar el estado de la tarea mediante `task_id`.
