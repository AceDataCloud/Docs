...
Primero, entendamos la forma básica de uso. Necesitamos capturar la imagen del código de verificación Recaptcha2 desde el sitio web, el URL del sitio de ejemplo es: `https://www.google.com/recaptcha/api2/demo`, la página específica se muestra en la siguiente imagen:

<p><img src="https://cdn.acedata.cloud/3mgkjk.png" width="500" className="m-auto" /></p>

Necesitamos hacer clic en la casilla de verificación del código de verificación para que aparezca la imagen del código de verificación. En la imagen anterior, la flecha amarilla apunta a un texto, este texto es el valor de `question` que se menciona más adelante. Primero, necesitamos pasar un campo `image`, que es la imagen específica del código de verificación Recaptcha2, esta imagen es la que apunta la flecha roja en la imagen anterior, y debe ser escalada a un tamaño estándar (100x100, 300x300, 450x450), de esta manera el servicio podrá determinar el tipo de imagen. La compresión de la imagen debe ser realizada por ti mismo, en este documento se recomienda un [sitio de compresión](https://www.photopea.com/), donde puedes ajustar el tamaño y la dimensión de la imagen, el resultado comprimido se muestra en la imagen a continuación:
