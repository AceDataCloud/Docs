...
Para utilizar el API, primero debe ir a la página correspondiente del [API de Reconocimiento del Protocolo Recaptcha3](https://platform.acedata.cloud/documents/captcha-token-recaptcha3) para solicitar el servicio correspondiente. Una vez en la página, haga clic en el botón "Acquire", como se muestra en la imagen:
