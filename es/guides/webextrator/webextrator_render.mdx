...
cuando la tarea se complete, la plataforma enviará los resultados completos a tu `callback_url`.
...
- **`block_resources` es el camino más rápido para reducir la latencia.** Por defecto, ya se han bloqueado imágenes / fuentes / medios; si tu extracción no depende del diseño CSS, agregar `stylesheet` puede hacerlo aún más rápido.
