...
Si desea continuar reemplazando fragmentos de la canción que ha subido, puede establecer el parámetro `action` en `upload_replace_section` e ingresar el ID de la canción que necesita continuar escribiendo. El ID de la canción se obtiene utilizando la [API de carga de productores](https://platform.acedata.cloud/documents/producer-upload) como se muestra en la imagen a continuación:
