...
Primero, debes entender la forma básica de uso, que consiste en ingresar la imagen del CAPTCHA alfanumérico de longitud variable que deseas procesar para obtener el resultado procesado. Primero, necesitas pasar un campo `image`, que es la imagen específica del CAPTCHA alfanumérico, como se muestra en la imagen:

<p><img src="https://cdn.acedata.cloud/c50hi9.png" width="500" className="m-auto" /></p>

Luego, necesitamos convertir la imagen del CAPTCHA en una imagen codificada en Base64. Se recomienda utilizar la extensión de Google Chrome FeHelper para realizar la conversión; puedes consultar la siguiente imagen para ver cómo usarla:
...
Después, puedes copiar el código Base64 obtenido de la extensión FeHelper, recuerda que no debe incluir el prefijo data:image/png;base64, el contenido específico es el siguiente:
...
Al llamar a la API, si encuentras un error, la API devolverá el código de error correspondiente y la información. Por ejemplo:
