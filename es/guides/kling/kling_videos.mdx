...
Para usar la API, primero debe solicitar el servicio en la página correspondiente de [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos). Al ingresar, haga clic en el botón «Acquire», como se muestra en la imagen:
