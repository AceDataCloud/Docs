...
Para utilizar la API, primero debes ir a la página correspondiente de la [API de creación de fotos de identificación con IA](https://platform.acedata.cloud/documents/headshots-generate) para solicitar el servicio correspondiente. Una vez en la página, haz clic en el botón "Acquire", como se muestra en la imagen:
