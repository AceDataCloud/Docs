...
- `request`, información de la solicitud en la tarea de imagen.
- `response`, información de la respuesta en la tarea de imagen.
...
- `finished_at`, tiempo de finalización de la tarea, marca de tiempo Unix (segundos, punto flotante). Este campo no se devuelve si la tarea no se ha completado.
