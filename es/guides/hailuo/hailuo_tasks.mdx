...
Tomaremos como ejemplo un ID de tarea devuelto por el servicio de API de Generación de Videos de Hailuo, para demostrar cómo utilizar esta API. Supongamos que tenemos un ID de tarea: 58cc618b-9639-4ee7-add2-d2fcf260d9a3, a continuación, se demostrará cómo pasar un ID de tarea.
...
- `ids`: array de IDs de tarea cargados.
- `action`: el método de operación sobre la tarea.
