...
Para utilizar la API, primero debe ir a la página correspondiente de la [API de detección de vida estática de rostros (versión de alta precisión)](https://platform.acedata.cloud/documents/face-detect-live) para solicitar el servicio correspondiente. Una vez en la página, haga clic en el botón "Acquire", como se muestra en la imagen:
