...
Para usar la API de Claude Messages, primero puedes ir a la página de [Claude Messages API](https://platform.acedata.cloud/documents/claude-chat-completions) y hacer clic en el botón "Acquire" para obtener las credenciales necesarias para la solicitud:
