...
Para usar la API de Finalización de Chat de Claude, primero puedes ir a la página de [API de Finalización de Chat de Claude](https://platform.acedata.cloud/documents/claude-chat-completions) y hacer clic en el botón "Acquire" para obtener las credenciales necesarias para la solicitud:
