...
Para utilizar la API, primero debe ir a la página correspondiente de la [API de verificación de dos elementos de la tarjeta bancaria](https://platform.acedata.cloud/documents/identity-bankcard-check-2e) para solicitar el servicio correspondiente. Una vez en la página, haga clic en el botón "Acquire", como se muestra en la imagen:
