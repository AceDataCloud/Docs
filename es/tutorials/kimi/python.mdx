---
title: "Kimi Python Guía Rápida"
---

## Introducción

Kimi es un servicio de chat AI proporcionado por Ace Data Cloud, basado en la serie de modelos de lenguaje grande Kimi de Moon's Dark Side. A través de la API unificada de Ace Data Cloud, puedes integrar rápidamente Kimi usando Python para lograr funciones como diálogo multi-turno, indicaciones del sistema, salida en streaming, modo de salida JSON, entre otras.
