...
Aby korzystać z API, należy najpierw zarejestrować odpowiednią usługę na stronie [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos). Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na poniższym obrazku:
