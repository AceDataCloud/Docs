...
API Kling Tasks może być używane do zapytania o wyniki API Kling Videos Generation. Aby dowiedzieć się, jak korzystać z API Kling Videos Generation, zapoznaj się z dokumentem [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos).

Posłużymy się przykładem ID zadania zwróconego przez usługę API Kling Videos Generation. Załóżmy, że mamy ID zadania: 20068983-0cc9-4c6a-aeb6-9c6a3c668be0, a następnie pokażemy, jak to zrobić, przekazując ID zadania.
...
```json
{
  ...
  "request": {
    "action": "text2video",
    "model": "kling-v1",
    "prompt": "Biały ceramiczny kubek do kawy na błyszczącej marmurowej powierzchni z porannym światłem wpadającym przez okno. Kamera powoli obraca się o 360 stopni wokół kubka, zatrzymując się na chwilę przy uchwycie.",
...
Dzięki temu dokumentowi zrozumiałeś, jak korzystać z API Kling Tasks do zapytań o szczegółowe informacje o pojedynczych lub zbiorczych zadaniach wideo. Mamy nadzieję, że ten dokument pomoże Ci lepiej zintegrować i korzystać z tego API. W razie jakichkolwiek pytań, prosimy o kontakt z naszym zespołem wsparcia technicznego.
