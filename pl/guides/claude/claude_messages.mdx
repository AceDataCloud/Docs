...
Aby korzystać z Claude Messages API, najpierw można przejść na stronę [Claude Messages API](https://platform.acedata.cloud/documents/claude-chat-completions) i kliknąć przycisk „Acquire”, aby uzyskać potrzebne poświadczenia do żądania:
