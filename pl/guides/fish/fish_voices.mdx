...
Aby korzystać z API, należy najpierw przejść do strony [Fish Voices Generation API](https://platform.acedata.cloud/documents/fish-voices) i złożyć wniosek o odpowiednią usługę, po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
