...
`audio_url` wskazuje na CDN tej platformy, można bezpośrednio pobrać za pomocą GET lub odtworzyć w `<audio>`. Link jest długoterminowy, ale nadal zaleca się przechowywanie kopii w swoim własnym magazynie.
