...
Aby korzystać z API, należy najpierw złożyć wniosek o odpowiednią usługę na stronie [Fish TTS API](https://platform.acedata.cloud/services/fish). Po wejściu na stronę kliknij przycisk „Acquire”.
...
Możesz też użyć [Fish Tasks API](https://platform.acedata.cloud/documents/fish-tasks) do aktywnego sprawdzania statusu zadania po `task_id`.
