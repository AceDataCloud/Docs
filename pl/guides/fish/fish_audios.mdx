...
Aby skorzystać z API, należy najpierw przejść do strony [Fish Audios Generation API](https://platform.acedata.cloud/documents/fish-audios) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
