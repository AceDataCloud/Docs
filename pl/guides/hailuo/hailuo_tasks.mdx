...
Posłużymy się przykładem ID zadania zwróconego przez usługę Hailuo Videos Generation API, aby pokazać, jak używać tego API. Załóżmy, że mamy ID zadania: 58cc618b-9639-4ee7-add2-d2fcf260d9a3, a następnie pokażemy, jak to zrobić, przekazując ID zadania.
