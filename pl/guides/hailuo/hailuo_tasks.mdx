...
Użyjemy jako przykładu ID zadania zwróconego przez usługę Hailuo Videos Generation API. Załóżmy, że mamy ID zadania: 58cc618b-9639-4ee7-add2-d2fcf260d9a3, a następnie pokażemy, jak to zrobić, przekazując ID zadania.
...
Dzięki temu dokumentowi zrozumieliście, jak korzystać z API Hailuo Tasks do zapytań o szczegółowe informacje o pojedynczych lub zbiorczych zadaniach wideo. Mamy nadzieję, że ten dokument pomoże Wam lepiej zintegrować i korzystać z tego API. W razie jakichkolwiek pytań, prosimy o kontakt z naszym zespołem wsparcia technicznego.
