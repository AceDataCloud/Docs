...
Aby skorzystać z DeepSeek Chat Completion API, najpierw można przejść na stronę [DeepSeek Chat Completion API](https://platform.acedata.cloud/documents/deepseek-chat-completions) i kliknąć przycisk „Acquire”, aby uzyskać potrzebne poświadczenia:
