...
Aby korzystać z OpenAI Chat Completion API, najpierw można przejść na stronę [OpenAI Chat Completion API](https://platform.acedata.cloud/documents/openai-chat-completions) i kliknąć przycisk „Acquire”, aby uzyskać potrzebne poświadczenia do żądania:
