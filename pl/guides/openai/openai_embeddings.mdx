...
Aby korzystać z OpenAI Embeddings API, najpierw można przejść na stronę [OpenAI Embeddings API](https://platform.acedata.cloud/documents/openai-embeddings) i kliknąć przycisk „Acquire”, aby uzyskać potrzebne poświadczenia:
