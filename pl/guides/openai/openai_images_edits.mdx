...
Aby korzystać z OpenAI Images Edits API, należy najpierw przejść na stronę [OpenAI Images Edits API](https://platform.acedata.cloud/documents/251f1efa-aaa6-462e-8af4-66854b1bc94d) i kliknąć przycisk „Acquire”, aby uzyskać niezbędne poświadczenia do żądań:
