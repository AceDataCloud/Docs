...
Aby korzystać z OpenAI Chat Completion 4o Image API, najpierw przejdź na stronę [OpenAI Chat Completion 4o Image API](https://platform.acedata.cloud/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) i kliknij przycisk „Acquire”, aby uzyskać wymagane poświadczenia do żądania:
