...
Aby korzystać z OpenAI Responses API, najpierw można przejść na stronę [OpenAI Responses API](https://platform.acedata.cloud/documents/openai-responses) i kliknąć przycisk „Acquire”, aby uzyskać potrzebne poświadczenia do żądania:
