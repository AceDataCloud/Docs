...
Przed użyciem, proszę przejść na platformę Ace Data Cloud i wejść do [Nano Banana Images API](https://platform.acedata.cloud/documents/nano-banana-images) oraz kliknąć "Acquire", aby złożyć wniosek o aktywację. Przy pierwszym wniosku zazwyczaj dostępny jest darmowy limit. Po zakończeniu aktywacji, można uzyskać Bearer Token do wywoływania API na platformie.
