...
Aby korzystać z API, należy najpierw przejść do odpowiedniej strony [AI Chat API](https://platform.acedata.cloud/documents/aichat-conversations) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
