...
> 📘 Pełna dokumentacja: [API Veo Videos Generation →](https://platform.acedata.cloud/documents/veo-videos)

## Przykład żądania

API Veo Tasks można wykorzystać do zapytania o wyniki API Veo Videos Generation. Aby dowiedzieć się, jak korzystać z API Veo Videos Generation, zapoznaj się z dokumentacją [API Veo Videos Generation](https://platform.acedata.cloud/documents/veo-videos).

Posłużymy się przykładem ID zadania zwróconego przez usługę API Veo Videos Generation, aby pokazać, jak korzystać z tego API. Załóżmy, że mamy ID zadania: 1ebe4f2b-59ba-4385-a4ea-0ce8a3fe12ed, a następnie pokażemy, jak to zrobić, przekazując ID zadania.
