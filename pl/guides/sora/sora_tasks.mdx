...
Aby korzystać z API Sora Tasks, należy najpierw przejść do strony aplikacji [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos) i złożyć wniosek o odpowiednią usługę, a następnie skopiować ID zadania API Sora Videos Generation, jak pokazano na obrazku:

<p><img src="https://cdn.acedata.cloud/za62pb.png" width="500" className="m-auto" /></p>

Na koniec przejdź do strony API Tasks [Sora Tasks API](https://platform.acedata.cloud/documents/sora-tasks) i złóż wniosek o odpowiednią usługę, po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
