...
Aby korzystać z API, należy najpierw złożyć wniosek o usługę na stronie [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos). Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
