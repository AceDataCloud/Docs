...
Aby skorzystać z API, należy najpierw przejść do odpowiedniej strony [API do zmiany płci na podstawie twarzy](https://platform.acedata.cloud/documents/face-change-gender) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
