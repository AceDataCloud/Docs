...
Aby skorzystać z API, należy najpierw przejść do odpowiedniej strony [API detekcji statycznej żywej twarzy (wersja o wysokiej precyzji)](https://platform.acedata.cloud/documents/face-detect-live) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
