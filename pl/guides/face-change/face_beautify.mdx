...
Aby skorzystać z API, należy najpierw przejść na stronę [API do upiększania twarzy](https://platform.acedata.cloud/documents/face-beautify) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na poniższym obrazku:
