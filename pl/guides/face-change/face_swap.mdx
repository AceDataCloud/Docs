...
Aby korzystać z API Face Swap, należy najpierw przejść do strony aplikacji [Face Swap API](https://platform.acedata.cloud/documents/face-swap), klikając przycisk „Acquire”, jak pokazano na poniższym obrazku:
