...
Aby skorzystać z API, należy najpierw przejść do strony [AI Wytwarzanie zdjęć identyfikacyjnych API](https://platform.acedata.cloud/documents/headshots-generate) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
