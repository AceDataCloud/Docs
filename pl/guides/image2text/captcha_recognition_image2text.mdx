...
Można zauważyć, że uzyskaliśmy wynik weryfikacji przetworzonego obrazu zmiennej długości angielskiego kodu numerycznego, wystarczy, że na podstawie treści tekstowej w wyniku `text` przejdziemy przez weryfikację.
