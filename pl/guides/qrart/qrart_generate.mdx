...
Aby używać API kodów QR artystycznych, najpierw przejdź do strony [API kodów QR artystycznych](https://data.zhishuyun.com/documents/qrart-generate "API kodów QR artystycznych") i kliknij przycisk „Uzyskaj”:
