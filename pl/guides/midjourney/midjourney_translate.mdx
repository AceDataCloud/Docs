...
Aby korzystać z Midjourney Translate API, należy najpierw przejść do strony aplikacji [Midjourney Translate API](https://platform.acedata.cloud/documents/midjourney-translate) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
