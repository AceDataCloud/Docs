...
Aby korzystać z Midjourney Shorten API, należy najpierw złożyć wniosek na stronie [Midjourney Shorten API](https://platform.acedata.cloud/documents/midjourney-shorten). Po wejściu na stronę kliknij przycisk „Acquire”.
