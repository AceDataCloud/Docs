...
Aby skorzystać z API, należy najpierw przejść do odpowiedniej strony [API do rozpoznawania obrazów hCaptcha](https://platform.acedata.cloud/documents/recognition-hcaptcha-integration) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
