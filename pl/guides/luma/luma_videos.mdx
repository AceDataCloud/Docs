...
Aby korzystać z Luma Videos API, najpierw można przejść na stronę [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) i kliknąć przycisk „Acquire”, aby uzyskać potrzebne poświadczenia:
