...
Aby skorzystać z API, należy najpierw przejść do strony [Krótkie URL API](https://platform.acedata.cloud/documents/shorturl) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
