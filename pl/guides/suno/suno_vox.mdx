...
Możemy zobaczyć, że pole `id` w `data` to nasze pożądane `vox_audio_id`, a następnie przechodzimy do [API Persona](https://platform.acedata.cloud/documents/suno-persona), aby stworzyć nową wersję Persona-v2-vox: styl piosenkarza, konkretne dane wejściowe są następujące:
