...
Aby korzystać z API Flux Tasks, należy najpierw przejść do strony aplikacji [Flux Images Generation API](https://platform.acedata.cloud/documents/flux-images) i złożyć wniosek o odpowiednią usługę, a następnie skopiować identyfikator zadania API Flux Images Generation, jak pokazano na obrazku:

<p><img src="https://cdn.acedata.cloud/7furhb.png" width="500" className="m-auto" /></p>

Na koniec przejdź do strony API Flux Tasks [Flux Tasks API](https://platform.acedata.cloud/documents/flux-tasks) i złóż wniosek o odpowiednią usługę, po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku.
