...
Aby skorzystać z API, należy najpierw przejść do strony [Flux Images Generation API](https://platform.acedata.cloud/documents/flux-images) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
