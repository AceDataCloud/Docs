...
Posłużymy się przykładem ID zadania zwróconego przez usługę Wan Videos Generation API, aby pokazać, jak używać tego API. Załóżmy, że mamy ID zadania: a4bca552-d964-46a1-8ff7-fd922f916582, a następnie pokażemy, jak to zrobić, przekazując ID zadania.
...
Po pomyślnym złożeniu żądania, API zwróci szczegółowe informacje o tym zadaniu wideo. Na przykład:
