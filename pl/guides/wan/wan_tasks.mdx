...
Aby korzystać z Wan Tasks API, najpierw należy przejść do strony aplikacji [Wan Videos Generation API](https://platform.acedata.cloud/documents/wan-videos) i złożyć wniosek o odpowiednią usługę, a następnie skopiować ID zadania z Wan Videos Generation API, jak pokazano na obrazku:

<p><img src="https://cdn.acedata.cloud/om6p6g.png" width="500" className="m-auto" /></p>

Na koniec przejdź do strony Tasks API [Wan Tasks API](https://platform.acedata.cloud/documents/wan-tasks) i złóż wniosek o odpowiednią usługę, po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
...
Wan Tasks API może być używane do sprawdzania wyników Wan Videos Generation API. Aby dowiedzieć się, jak korzystać z Wan Videos Generation API, zapoznaj się z dokumentem [Wan Videos Generation API](https://platform.acedata.cloud/documents/wan-videos).
