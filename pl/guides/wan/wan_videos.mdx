...
Aby skorzystać z API, należy najpierw przejść do strony [Wan Videos Generation API](https://platform.acedata.cloud/documents/wan-videos) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
