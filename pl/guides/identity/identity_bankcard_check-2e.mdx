...
Aby skorzystać z API, należy najpierw przejść do strony [API weryfikacji dwóch elementów karty bankowej](https://platform.acedata.cloud/documents/identity-bankcard-check-2e) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
