...
Aby skorzystać z API, należy najpierw przejść do strony [API weryfikacji zdjęć z dowodu osobistego](https://platform.acedata.cloud/documents/identity-idcard-check-1e) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
