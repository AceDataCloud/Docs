...
Aby skorzystać z API, należy najpierw przejść do strony [API weryfikacji danych osobowych i okresu ważności](https://platform.acedata.cloud/documents/identity-idcard-check-2e) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
