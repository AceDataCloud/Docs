...
Aby skorzystać z API, należy najpierw przejść do strony [API do zapytania o podstawowe informacje o karcie bankowej](https://platform.acedata.cloud/documents/identity-bankcard-check-1e) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
