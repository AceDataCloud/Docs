...
Aby skorzystać z API, należy najpierw przejść do odpowiedniej strony [API rozpoznawania dowodu osobistego i weryfikacji informacji](https://platform.acedata.cloud/documents/identity-idcard-ocr) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
