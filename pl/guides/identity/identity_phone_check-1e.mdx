...
W tym artykule przedstawimy sposób integracji API do sprawdzania statusu numeru telefonu, które można wykorzystać do weryfikacji statusu numeru telefonu. Możesz wprowadzić numer telefonu, aby przeprowadzić zapytanie.

## Proces aplikacji

Aby skorzystać z API do sprawdzania statusu numeru telefonu, najpierw przejdź do [konsoli Ace Data Cloud](https://platform.acedata.cloud/console/applications), aby uzyskać swój token API, który należy zachować na przyszłość.

![](https://cdn.acedata.cloud/dvc3cg.jpg)

Jeśli nie jesteś zalogowany lub zarejestrowany, automatycznie zostaniesz przekierowany na stronę logowania, aby zarejestrować się i zalogować. Po zakończeniu procesu zostaniesz automatycznie przekierowany z powrotem na bieżącą stronę.
...
> 📘 Pełna dokumentacja: [API do sprawdzania statusu numeru telefonu →](https://platform.acedata.cloud/documents/identity-phone-check-1e)

## Podstawowe użycie

Najpierw zapoznaj się z podstawowym sposobem użycia, polegającym na wprowadzeniu numeru telefonu, aby uzyskać przetworzony wynik. Należy najpierw przekazać prosty parametr `mobile`. Następnie możemy wypełnić odpowiednie pola na interfejsie, jak pokazano na rysunku:
...
- `result`, kod wyniku weryfikacji, sytuacja dotycząca opłat jest następująca.
    ...
    - Kody wyników bezpłatnych:
        ...
        - -3: Usługa centrum weryfikacji jest zajęta
