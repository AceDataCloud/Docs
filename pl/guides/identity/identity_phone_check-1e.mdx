...
Aby skorzystać z API, należy najpierw przejść do strony [API do sprawdzania statusu numeru telefonu](https://platform.acedata.cloud/documents/identity-phone-check-1e) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
