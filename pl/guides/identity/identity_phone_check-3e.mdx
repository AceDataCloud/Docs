...
Aby skorzystać z API, należy najpierw przejść do odpowiedniej strony [API weryfikacji trzech elementów numeru telefonu](https://platform.acedata.cloud/documents/identity-phone-check-3e) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
