...
Aby skorzystać z API, należy najpierw przejść do strony [API rozpoznawania protokołu Recaptcha2](https://platform.acedata.cloud/documents/captcha-token-recaptcha2) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
