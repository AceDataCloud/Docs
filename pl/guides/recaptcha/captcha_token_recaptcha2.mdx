...
W tym artykule przedstawimy sposób integracji API rozpoznawania protokołu Recaptcha2, które pozwala użytkownikom na automatyczne dekodowanie w tle bez konieczności rozpoznawania i klikania na obrazy kodów weryfikacyjnych Recaptcha2, wystarczy przesłać klucz witryny.

## Proces aplikacji

Aby skorzystać z API rozpoznawania protokołu Recaptcha2, najpierw przejdź do [konsoli Ace Data Cloud](https://platform.acedata.cloud/console/applications), aby uzyskać swój token API, który należy zachować na przyszłość.
...
- Najpierw ręcznie przejdź przez weryfikację, szczegóły przedstawione na poniższym obrazku:

<p><img src="https://cdn.acedata.cloud/gwiflr.png" width="500" className="m-auto" /></p>

- Następnie kliknij submit, aby obserwować zmiany w konsoli sieciowej, szczegóły przedstawione na poniższym obrazku:

<p><img src="https://cdn.acedata.cloud/6hm5kj.png" width="500" className="m-auto" /></p>

- Analizuj konstrukcję żądania POST, a na końcu możesz kliknąć prawym przyciskiem myszy na to żądanie, aby skopiować kod CURL, szczegóły przedstawione na poniższym obrazku:
...
Opis rozliczeń: w trybie asynchronicznym, tworzenie zadań i cykliczne sprawdzanie „w trakcie przetwarzania” nie jest obciążane kosztami; **opłata jest naliczana tylko raz, gdy uzyskasz wynik** (w tej samej cenie co w trybie synchronicznym). Dlatego anulowanie zadań, które jeszcze się nie zakończyły, nie generuje kosztów. `/captcha/tasks` jest uniwersalne dla wszystkich interfejsów CAPTCHA (token i seria rozpoznawania), wystarczy użyć tego samego `task_id` do cyklicznego sprawdzania.
