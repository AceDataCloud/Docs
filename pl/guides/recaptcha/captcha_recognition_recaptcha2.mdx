...
Aby skorzystać z API, należy najpierw przejść do odpowiedniej strony [API rozpoznawania obrazów Recaptcha2](https://platform.acedata.cloud/documents/captcha-recognition-recaptcha2) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na poniższym obrazku:
