...
Aby skorzystać z API, należy najpierw przejść do odpowiedniej strony [API rozpoznawania protokołu Recaptcha3](https://platform.acedata.cloud/documents/captcha-token-recaptcha3) i złożyć wniosek o odpowiednią usługę, po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
