...
För att använda Lokalisering Översätt API, behöver du först gå till ansökningssidan [Lokalisering Översätt API](https://platform.acedata.cloud/documents/localization-translate) för att ansöka om motsvarande tjänst. När du kommer till sidan, klicka på "Acquire"-knappen, som visas i bilden nedan:
