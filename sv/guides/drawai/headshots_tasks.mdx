...
För att använda AI ID-foto Task API, behöver du först gå till ansökningssidan [AI ID-foto skapande API](https://platform.acedata.cloud/documents/headshots-generate) för att ansöka om den aktuella tjänsten, och sedan kopiera uppdrag ID från AI ID-foto skapande API, som visas i bilden:

<p><img src="https://cdn.acedata.cloud/7ezmmn.png" width="500" className="m-auto" /></p>

Slutligen går du till Tasks API-sidan [AI ID-foto Task API](https://platform.acedata.cloud/documents/headshots-tasks) för att ansöka om den aktuella tjänsten, när du kommer in på sidan, klicka på knappen "Acquire", som visas i bilden:
...
AI ID-foto Task API kan användas för att kontrollera resultaten från AI ID-foto skapande API. För information om hur man använder AI ID-foto skapande API, vänligen se dokumentet [AI ID-foto skapande API](https://platform.acedata.cloud/documents/drawai-headshots-generation-integration).
