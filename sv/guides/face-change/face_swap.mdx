...
För att använda Face Swap API måste du först gå till ansökningssidan [Face Swap API](https://platform.acedata.cloud/documents/face-swap) för att ansöka om den aktuella tjänsten. När du kommer till sidan klickar du på knappen "Acquire", som visas i bilden nedan:
