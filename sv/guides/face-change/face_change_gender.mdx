...
För att använda API:et måste du först gå till [API för ansikts könsbyte](https://platform.acedata.cloud/documents/face-change-gender) och ansöka om den tjänst som motsvarar sidan. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden nedan:
