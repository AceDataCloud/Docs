...
För att använda API:et måste du först gå till [ansiktsförbättrings-API](https://platform.acedata.cloud/documents/face-beautify) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden nedan:
