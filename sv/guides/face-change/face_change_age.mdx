...
För att använda API:et måste du först gå till [API för ansiktsåldersförändring](https://platform.acedata.cloud/documents/face-change-age) och ansöka om den tjänst som motsvarar. När du kommer till sidan klickar du på knappen "Acquire", som visas i bilden nedan:
