...
För att använda Midjourney Translate API måste du först gå till ansökningssidan [Midjourney Translate API](https://platform.acedata.cloud/documents/midjourney-translate) för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden:
