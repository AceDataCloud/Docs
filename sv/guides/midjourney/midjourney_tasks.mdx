...
För att använda Midjourney Tasks API måste du först gå till ansökningssidan [Midjourney Imagine API](https://platform.acedata.cloud/documents/midjourney-imagine) för att ansöka om den aktuella tjänsten, och sedan kopiera Imagine API:s uppgifts-ID, som visas i bilden:

<p><img src="https://cdn.acedata.cloud/lx4mwb.png" width="500" className="m-auto" /></p>

Slutligen går du till Tasks API-sidan [Midjourney Tasks API](https://platform.acedata.cloud/documents/midjourney-tasks) för att ansöka om den aktuella tjänsten. När du kommer till sidan klickar du på knappen "Acquire", som visas i bilden:
...
Midjourney Tasks API kan användas för att fråga om resultaten från både Midjourney Imagine API och Midjourney Describe API. För information om hur du använder Midjourney Imagine API, se dokumentet [Midjourney Imagine API](https://platform.acedata.cloud/documents/midjourney-imagine-integration). För information om hur du använder Midjourney Describe, se [Midjourney Describe API](https://platform.acedata.cloud/documents/midjourney-describe-integration).
