...
För att använda Midjourney Describe API måste du först gå till ansökningssidan [Midjourney Describe API](https://platform.acedata.cloud/documents/midjourney-describe) för att ansöka om den aktuella tjänsten. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden nedan:
