...
För att använda extraheringen av ADSL:s IP och lägga till IP-whitelist för ADSL Proxy, kan du först gå till [ADSL Proxy Extract API](https://platform.acedata.cloud/documents/adsl-extract) och [ADSL Proxy Whitelist API](https://platform.acedata.cloud/documents/adsl-whitelist) sidorna och klicka på "Acquire"-knappen för att få de nödvändiga autentiseringsuppgifterna:
...
Därefter kan du fylla i motsvarande innehåll på sidan [ADSL Proxy Extract API](https://platform.acedata.cloud/documents/adsl-extract), här visas hur man extraherar ADSL:s IP.
