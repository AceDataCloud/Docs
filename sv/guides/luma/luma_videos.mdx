...
För att använda Luma Videos API kan du först gå till [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) sidan och klicka på "Acquire" knappen för att få de nödvändiga autentiseringsuppgifterna:
