...
För att använda Veo Tasks API måste du först gå till ansökningssidan [Veo Videos Generation API](https://platform.acedata.cloud/documents/veo-videos) för att ansöka om den aktuella tjänsten, och sedan kopiera uppgiftens ID från Veo Videos Generation API, som visas i bilden:

<p><img src="https://cdn.acedata.cloud/txlg6g.png" width="500" className="m-auto" /></p>

Slutligen går du till Tasks API-sidan [Veo Tasks API](https://platform.acedata.cloud/documents/veo-tasks) för att ansöka om den aktuella tjänsten. När du kommer till sidan klickar du på "Acquire"-knappen, som visas i bilden:
...
Veo Tasks API kan användas för att kontrollera resultaten från Veo Videos Generation API. För information om hur man använder Veo Videos Generation API, se dokumentet [Veo Videos Generation API](https://platform.acedata.cloud/documents/veo-videos).
