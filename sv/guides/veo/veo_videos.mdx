...
För att använda API:et måste du först gå till [Veo Videos Generation API](https://platform.acedata.cloud/documents/veo-videos) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden:
