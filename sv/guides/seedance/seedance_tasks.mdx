...
SeeDance Tasks API:s huvudfunktion är att genom att ange det uppdragets ID som genererats av SeeDance Video Generation API för att kontrollera statusen för det uppdraget.

Detta dokument kommer att ge en detaljerad beskrivning av integrationen av SeeDance Tasks API, vilket hjälper dig att enkelt integrera och fullt utnyttja den kraftfulla funktionen av detta API. Genom SeeDance Tasks API kan du enkelt kontrollera statusen för uppdrag som utförs av SeeDance Video Generation API.

## Ansökningsprocess

För att använda SeeDance Video Generation API, börja med att gå till [Ace Data Cloud-konsolen](https://platform.acedata.cloud/console/applications) för att få din API-token, som du kan spara för framtida bruk.
...
> 📘 Fullständig dokumentation: [SeeDance Video Generation API →](https://platform.acedata.cloud/documents/seedance-videos)

## Begärningsexempel

SeeDance Tasks API kan användas för att kontrollera resultaten från SeeDance Video Generation API. För information om hur man använder SeeDance Video Generation API, se dokumentationen [SeeDance Video Generation API](https://platform.acedata.cloud/documents/seedance-videos-integration).

Vi tar ett exempel med ett uppdragets ID som returnerats av SeeDance Video Generation API och visar hur man använder detta API. Anta att vi har ett uppdragets ID: 20068983-0cc9-4c6a-aeb6-9c6a3c668be0, och vi visar hur man gör detta genom att ange ett uppdragets ID.
...
Detta är för att fråga detaljer om flera uppdragets ID:n, och till skillnad från ovan måste `action` väljas som `retrieve_batch`.
...
Genom detta dokument har du fått en förståelse för hur du använder SeeDance Tasks API för att fråga om specifika detaljer för enskilda eller batchuppgifter. Vi hoppas att detta dokument kan hjälpa dig att bättre integrera och använda API:et. Om du har några frågor, tveka inte att kontakta vårt tekniska supportteam.
