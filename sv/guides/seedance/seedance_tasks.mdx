...
Vi tar ett exempel med ett uppdrag ID som returnerats av SeeDance Video Generation API och visar hur man använder detta API. Anta att vi har ett uppdrag ID: 20068983-0cc9-4c6a-aeb6-9c6a3c668be0, och vi visar hur man skickar in detta uppdrag ID.
