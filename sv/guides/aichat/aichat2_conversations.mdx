...
AI Chat v2 API (`/aichat2/conversations`) är nästa generations konversationsgränssnitt och en fullständig uppgradering av [AI Chat API](https://platform.acedata.cloud/documents/aichat-conversations). Det bygger vidare på v1:s enkla och hanterade flerrundiga konversationer och utökar med:
...
För att använda API:t behöver du först ansöka om tjänsten på motsvarande sida för [AI Chat v2 API](https://platform.acedata.cloud/documents/aichat2-conversations). När du kommer till sidan klickar du på knappen "Acquire" för att få de autentiseringsuppgifter som krävs för anrop.
...
Om du redan använder [`/aichat/conversations`](https://platform.acedata.cloud/documents/aichat-conversations) krävs nästan inga kodändringar för att migrera till v2:
