...
För att använda API:t måste du först gå till [AI-fråge- och svar-API](https://platform.acedata.cloud/documents/aichat-conversations) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden:
