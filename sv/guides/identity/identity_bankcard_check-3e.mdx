...
För att använda bankkort tre element verifiering API, börja med att gå till [Ace Data Cloud-konsolen](https://platform.acedata.cloud/console/applications) för att få din API-token, som du kan spara för framtida bruk.
...
**En API-token kan användas för att anropa alla tjänster på plattformen, du behöver inte ansöka separat för varje tjänst.** Första ansökan ger en gratis kvot, så att du kan prova gratis; när kvoten är otillräcklig kan du ladda på allmän balans i [konsolen](https://platform.acedata.cloud/console/coin).

> 📘 Fullständig dokumentation: [Bankkort tre element verifiering API →](https://platform.acedata.cloud/documents/identity-bankcard-check-3e)
...
Klicka på "Try" knappen för att utföra tester, som visas i bilden ovan, här fick vi följande resultat:
