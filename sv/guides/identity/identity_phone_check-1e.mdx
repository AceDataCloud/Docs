...
För att använda API:et måste du först gå till [Mobilnummerstatuskontroll API](https://platform.acedata.cloud/documents/identity-phone-check-1e) motsvarande sida för att ansöka om den tjänst som behövs, när du kommer in på sidan, klicka på "Acquire"-knappen, som visas i bilden:
