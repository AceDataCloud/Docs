...
För att använda API:et måste du först gå till [Bankkortets grundläggande informationssökning API](https://platform.acedata.cloud/documents/identity-bankcard-check-1e) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden:
