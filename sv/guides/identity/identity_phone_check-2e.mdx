...
För att använda API:et måste du först gå till [Mobilnummer tvåfaktorsverifiering API](https://platform.acedata.cloud/documents/identity-phone-check-2e) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på "Acquire" knappen, som visas i bilden:
