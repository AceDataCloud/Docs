...
För att använda API:et måste du först gå till [bankkort tvåfaktorsverifiering API](https://platform.acedata.cloud/documents/identity-bankcard-check-2e) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på "Acquire" knappen, som visas i bilden:
