...
För att använda API:et måste du först gå till [Identitetsinformation och giltighetsverifiering API](https://platform.acedata.cloud/documents/identity-idcard-check-2e) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på "Acquire" knappen, som visas i bilden nedan:
