...
För att använda Claude Messages API kan du först gå till [Claude Messages API](https://platform.acedata.cloud/documents/claude-chat-completions) sidan och klicka på "Acquire"-knappen för att få de nödvändiga autentiseringsuppgifterna:
