...
För att använda API:et måste du först gå till [Digital English CAPTCHA Recognition API](https://platform.acedata.cloud/documents/captcha-recognition-image2text) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på "Acquire"-knappen, som visas i bilden:
