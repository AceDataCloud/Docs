...
Som standard är API:et synkront och blockerande: en begäran väntar tills tokenbehandlingen är klar innan den returneras. Om du gör en multipel lösare rotation och vill "få task_id omedelbart efter att ha skickat uppgiften, först schemalägga andra lösare och sedan återkomma för att hämta resultatet", kan du skicka `async: true` i begärningskroppen.
