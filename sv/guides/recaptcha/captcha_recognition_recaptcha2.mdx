...
Som standard är API:et synkront och blockerande: en begäran väntar tills igenkänningsresultatet har behandlats innan det returneras. Om du gör en rotation av flera lösare (multi-solver rotation) och vill "skicka uppgiften och omedelbart få task_id, först schemalägga andra lösare och senare återkomma för att hämta resultatet", kan du skicka `async: true` i begärningskroppen.
