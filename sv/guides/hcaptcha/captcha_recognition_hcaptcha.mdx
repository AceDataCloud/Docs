...
Som standard är API:et synkront blockerande: en begäran kommer att vänta tills identifieringsresultatet har bearbetats klart innan det returneras. Om du gör en multipel kodare rotation och vill "få task_id omedelbart efter att ha skickat uppgiften, först schemalägga andra kodare och sedan återkomma för att hämta resultatet", kan du skicka in `async: true` i begärningskroppen.
