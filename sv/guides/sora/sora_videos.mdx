...
För att använda API:et måste du först ansöka om tjänsten på [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos). När du kommer till sidan klickar du på knappen "Acquire", som visas nedan:
