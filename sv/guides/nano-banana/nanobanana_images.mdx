...
### Framgångsrik återvändningsexempel
...
Till exempel kan vi här ge en bild av en person och en bild av en tröja, och låta personen ha på sig denna tröja, så kan vi samtidigt skicka in bildlänkar och ange åtgärden som `edit`, URL:er kan vara HTTP-URL:er, offentligt tillgängliga länkar med `https` eller `http` protokoll, eller så kan det vara Base64-kodade bilder, som `data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAA+gAAAVGCAMAAAA6u2FyAAADAFBMVEXq6uwdHCEeHyMdHS....`
...
**Exempel på callback-last** (fältstrukturen är densamma som för synkron framgångsrikt svar):
