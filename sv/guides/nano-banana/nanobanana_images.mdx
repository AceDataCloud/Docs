...
Innan användning, vänligen gå till [Nano Banana Images API](https://platform.acedata.cloud/documents/nano-banana-images) på Ace Data Cloud-plattformen och klicka på Acquire för att ansöka om aktivering. Första gången du ansöker finns det vanligtvis en gratis kvot tillgänglig. När aktiveringen är klar kan du hämta Bearer Token som används för att anropa API:et.
