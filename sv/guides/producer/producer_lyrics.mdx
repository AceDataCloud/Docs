---
title: "Producer låttextgenererings-API integration"
description: "Producer Music Generation API guide - Ace Data Cloud"
---

Producer tillåter oss att generera låttexter genom att använda promptord. Detta dokument förklarar hur man integrerar med den relaterade API:n.

Denna API har endast en inparametrar, nämligen `prompt`, som är promptordet för att generera låttext.

Här är vår inmatade `prompt`: `A song about winter`, som är promptordet för att generera låttext.
...
Man kan se att `data` fältet `lyrics` är den genererade låttexten.
