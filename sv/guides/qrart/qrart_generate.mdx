...
För att använda konst QR-kod API, kan du först gå till [Konst QR-kod API](https://data.zhishuyun.com/documents/qrart-generate "Konst QR-kod API") sidan och klicka på "Få" knappen:
