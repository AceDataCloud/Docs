...
För att använda Flux Tasks API måste du först gå till ansökningssidan [Flux Images Generation API](https://platform.acedata.cloud/documents/flux-images) för att ansöka om den aktuella tjänsten, och sedan kopiera uppdragets ID från Flux Images Generation API, som visas i bilden nedan:

<p><img src="https://cdn.acedata.cloud/7furhb.png" width="500" className="m-auto" /></p>

Slutligen går du till Flux Tasks API-sidan [Flux Tasks API](https://platform.acedata.cloud/documents/flux-tasks) för att ansöka om den aktuella tjänsten. När du kommer till sidan klickar du på knappen "Acquire", som visas i bilden nedan.
