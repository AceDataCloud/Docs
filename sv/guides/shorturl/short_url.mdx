...
För att använda API:et måste du först gå till [Kort URL API](https://platform.acedata.cloud/documents/shorturl) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden nedan:
...
Det kan ses att den ursprungliga längre URL:en `https://platform.acedata.cloud/documents/shorturl` har framgångsrikt konverterats till den korta URL:en `https://surl.id/1uHCs01xa5`.
