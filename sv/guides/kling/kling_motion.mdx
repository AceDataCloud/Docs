...
För att använda API:et måste du först gå till [Kling Motion Generation API](https://platform.acedata.cloud/documents/kling-motion) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden:
