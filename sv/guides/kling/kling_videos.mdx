...
För att använda API:et måste du först ansöka om tjänsten på motsvarande sida för [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos). När du är på sidan klickar du på knappen “Acquire”, som visas nedan:
