...
För att använda DeepSeek Chat Completion API kan du först gå till [DeepSeek Chat Completion API](https://platform.acedata.cloud/documents/deepseek-chat-completions) sidan och klicka på "Acquire"-knappen för att få de nödvändiga autentiseringsuppgifterna:
