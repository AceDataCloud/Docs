...
För att använda API:et måste du först ansöka om motsvarande tjänst på sidan [Fish TTS API](https://platform.acedata.cloud/services/fish). När du är på sidan klickar du på knappen „Acquire“.
...
Du kan även använda [Fish Tasks API](https://platform.acedata.cloud/documents/fish-tasks) för att aktivt poll:a status via `task_id`.
