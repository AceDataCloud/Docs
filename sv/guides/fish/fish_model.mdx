...
För att använda API:et måste du först ansöka om motsvarande tjänst på [Fish Model API](https://platform.acedata.cloud/services/fish). När du går in på sidan klickar du på knappen "Acquire".
