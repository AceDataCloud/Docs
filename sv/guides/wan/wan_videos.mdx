...
För att använda API:et måste du först gå till [Wan Videos Generation API](https://platform.acedata.cloud/documents/wan-videos) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på "Acquire"-knappen, som visas i bilden nedan:
