...
För att använda OpenAI Chat Completion 4o Image API kan du först gå till sidan [OpenAI Chat Completion 4o Image API](https://platform.acedata.cloud/documents/openai-chat-completions) och klicka på knappen "Acquire" för att få de nödvändiga autentiseringsuppgifterna för förfrågningar:
