...
För att använda OpenAI Images Generations API kan du först gå till sidan [OpenAI Images Generations API](https://platform.acedata.cloud/documents/openai-images-generations) och klicka på knappen "Acquire" för att få de nödvändiga autentiseringsuppgifterna:
