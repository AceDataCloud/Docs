...
För att använda OpenAI Responses API kan du först gå till [OpenAI Responses API](https://platform.acedata.cloud/documents/openai-responses) sidan och klicka på "Acquire" knappen för att få de nödvändiga autentiseringsuppgifterna:
