---
title: "Identity Python 快速入门"
---

## 简介

Identity 是 Ace Data Cloud 提供的身份验证服务，身份证/银行卡/手机号实名验证。通过 Ace Data Cloud 统一 API，你可以使用 Python 快速集成 Identity，实现身份证 OCR、身份证核验、银行卡核验、手机号核验等功能。
