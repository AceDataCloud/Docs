---
title: "Producer Python 快速入门"
---

## 简介

Producer 是 Ace Data Cloud 提供的AI 音频服务，FUZZ Producer AI 音乐生成。通过 Ace Data Cloud 统一 API，你可以使用 Python 快速集成 Producer，实现文本生成音乐、自定义歌词、歌曲续写、翻唱、人声分离、MV 生成等功能。
