---
title: "hCaptcha Python 快速入门"
---

## 简介

hCaptcha 是 Ace Data Cloud 提供的验证码服务，hCaptcha 解决方案。通过 Ace Data Cloud 统一 API，你可以使用 Python 快速集成 hCaptcha，实现hCaptcha Token 获取、hCaptcha 图片识别等功能。
