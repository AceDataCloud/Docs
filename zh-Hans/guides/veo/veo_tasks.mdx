...
## 请求示例
Veo Tasks API 可以用于查询 Veo Videos Generation API 的结果。关于怎样使用 Veo Videos Generation API，请参考文档 [Veo Videos Generation API ](https://platform.acedata.cloud/documents/veo-videos)。
