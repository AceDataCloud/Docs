...
要使用 Fish Voices Generation API，首先到 [Ace Data Cloud 控制台](https://platform.acedata.cloud/console/applications) 获取您的 API Token，留作备用。
...
> 📘 完整文档：[Fish Voices Generation API →](https://platform.acedata.cloud/documents/55e61b64-ac7d-4710-a7f1-57a4ba786b17)
