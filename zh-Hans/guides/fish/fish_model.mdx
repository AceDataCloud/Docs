...
仅本接口 `POST /fish/model` 计费——按「创建一次音色」结算。后续的查询接口（[Fish Model Query](https://platform.acedata.cloud/documents/fish-model-query)、[Fish Model Get](https://platform.acedata.cloud/documents/fish-model-get)）均不计费。
