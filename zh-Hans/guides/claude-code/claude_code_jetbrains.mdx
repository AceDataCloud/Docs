...
要使用 Claude Messages 服务页面，首先到 [Ace Data Cloud 控制台](https://platform.acedata.cloud/console/applications) 获取您的 API Token，留作备用。
...
> 📘 完整文档：[Claude Messages 服务页面 →](https://platform.acedata.cloud/documents/claude-messages)
