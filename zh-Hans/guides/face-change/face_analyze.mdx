...
要使用 五官定位 API，首先到 [Ace Data Cloud 控制台](https://platform.acedata.cloud/console/applications) 获取您的 API Token，留作备用。
...
> 📘 完整文档：[五官定位 API →](https://platform.acedata.cloud/documents/20945baf-b263-457b-be5f-0332c2180a57)
