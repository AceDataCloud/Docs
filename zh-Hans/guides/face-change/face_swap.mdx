...
要使用 Face Swap API，首先到 [Ace Data Cloud 控制台](https://platform.acedata.cloud/console/applications) 获取您的 API Token，留作备用。
...
> 📘 完整文档：[Face Swap API →](https://platform.acedata.cloud/documents/d10df07a-66a6-4c37-b114-3a003fc9bd55)
