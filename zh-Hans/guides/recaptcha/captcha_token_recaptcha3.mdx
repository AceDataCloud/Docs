...
要使用 Recaptcha3 协议识别 API，首先到 [Ace Data Cloud 控制台](https://platform.acedata.cloud/console/applications) 获取您的 API Token，留作备用。
...
> 📘 完整文档：[Recaptcha3 协议识别 API →](https://platform.acedata.cloud/documents/captcha-token-recaptcha3)
