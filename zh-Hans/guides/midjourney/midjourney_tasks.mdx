...
> 📘 完整文档：[Midjourney Imagine API →](https://platform.acedata.cloud/documents/midjourney-imagine)

## 请求示例
MIdjourney Tasks API 可以用于查询 MIdjourney Imagine API 和 MIdjourney Describe API 两个 API 的结果。关于怎样使用 MIdjourney Imagine API，请参考文档 [Midjourney Imagine API ](https://platform.acedata.cloud/documents/midjourney-imagine-integration)。关于怎样使用 Midjourney Describe，请参考 [Midjourney Describe API ](https://platform.acedata.cloud/documents/midjourney-describe-integration)。
