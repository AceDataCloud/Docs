...
## 请求示例
Wan Tasks API 可以用于查询 Wan Videos Generation API 的结果。关于怎样使用 Wan Videos Generation API，请参考文档 [Wan Videos Generation API ](https://platform.acedata.cloud/documents/wan-videos)。
