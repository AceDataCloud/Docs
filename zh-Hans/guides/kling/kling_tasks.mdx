...
Kling Tasks API 可以用于查询 Kling Videos Generation API 的结果。关于怎样使用 Kling Videos Generation API，请参考文档 [Kling Videos Generation API ](https://platform.acedata.cloud/documents/kling-videos)。
