...
要使用 银行卡四要素核验 API，首先到 [Ace Data Cloud 控制台](https://platform.acedata.cloud/console/applications) 获取您的 API Token，留作备用。
...
> 📘 完整文档：[银行卡四要素核验 API →](https://platform.acedata.cloud/documents/02f77369-ec7b-4218-a956-d7a84982a626)
