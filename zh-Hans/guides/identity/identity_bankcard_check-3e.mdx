...
要使用 银行卡三要素核验 API，首先到 [Ace Data Cloud 控制台](https://platform.acedata.cloud/console/applications) 获取您的 API Token，留作备用。
...
> 📘 完整文档：[银行卡三要素核验 API →](https://platform.acedata.cloud/documents/eb9c6677-68db-4549-a207-41f8a1084634)
