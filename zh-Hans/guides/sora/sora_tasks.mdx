...
要使用 Sora Videos Generation API，首先到 [Ace Data Cloud 控制台](https://platform.acedata.cloud/console/applications) 获取您的 API Token，留作备用。
...
> 📘 完整文档：[Sora Videos Generation API →](https://platform.acedata.cloud/documents/sora-videos)
...
```json
{
  ...
  "started_at": 1760105642.105,
  "finished_at": 1760105730.705,
  "elapsed": 88.6,
