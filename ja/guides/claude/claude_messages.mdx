...
Claude Messages API を使用するには、まず [Claude Messages API](https://platform.acedata.cloud/documents/claude-chat-completions) ページにアクセスし、「Acquire」ボタンをクリックして、リクエストに必要な資格情報を取得します：
