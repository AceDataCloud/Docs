...
API を使用するには、まず [hCaptcha 画像認識 API](https://platform.acedata.cloud/documents/recognition-hcaptcha-integration) の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
