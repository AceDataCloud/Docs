...
Kling Tasks API を使用するには、まず申請ページ [Kling Videos Generation API](https://platform.acedata.cloud/documents/kling-videos) にアクセスして、該当するサービスを申請し、その後、Kling Videos Generation API のタスクIDをコピーします。以下の図のように：

<p><img src="https://cdn.acedata.cloud/om6p6g.png" width="500" className="m-auto" /></p>

最後に、Tasks API ページ [Kling Tasks API](https://platform.acedata.cloud/documents/kling-tasks) にアクセスして、該当するサービスを申請します。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
