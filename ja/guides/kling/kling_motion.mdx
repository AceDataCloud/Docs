...
APIを使用するには、まず [Kling Motion Generation API](https://platform.acedata.cloud/documents/kling-motion) の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
