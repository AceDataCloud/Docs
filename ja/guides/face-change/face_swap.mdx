...
Face Swap API を使用するには、まず申請ページ [Face Swap API](https://platform.acedata.cloud/documents/face-swap) にアクセスして、該当するサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
