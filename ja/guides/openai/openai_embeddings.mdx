...
OpenAI Embeddings API を使用するには、まず [OpenAI Embeddings API](https://platform.acedata.cloud/documents/openai-embeddings) ページにアクセスし、「Acquire」ボタンをクリックして、リクエストに必要な資格情報を取得します：
