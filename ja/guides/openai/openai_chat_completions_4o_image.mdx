...
OpenAI Chat Completion 4o Image API を使用するには、まず [OpenAI Chat Completion 4o Image API](https://platform.acedata.cloud/documents/openai-chat-completions) ページで「Acquire」ボタンをクリックし、リクエストに必要な認証情報を取得します：
