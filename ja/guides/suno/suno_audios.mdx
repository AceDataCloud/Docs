...
| バージョン | model           | リリース日       | prompt 制限 | lyric 制限 | style 制限 | 曲の最長時間 |
| ----- | --------------- | ---------- | --------- | --------- | -------- | ------ |
| v5    | chirp-v5        | 2025.09.23 | 200       | 5000      | 1000     | 8 分   |
| v4.5+ | chirp-v4-5-plus | 2025.07.17 | 200       | 5000      | 1000     | 8 分   |
| v4.5  | chirp-v4-5      | 2025.05.03 | 200       | 5000      | 1000     | 4 分   |
