...
Suno Tasks API を使用するには、まず申請ページ [Suno Audios Generation API ](https://platform.acedata.cloud/documents/suno-audios) で該当するサービスを申請し、その後、Suno Audios Generation API のタスクIDをコピーします。以下の図のように：

<p><img src="https://cdn.acedata.cloud/bc6754.png" width="500" className="m-auto" /></p>

最後に、Tasks API ページ [Suno Tasks API ](https://platform.acedata.cloud/documents/suno-tasks) にアクセスし、該当するサービスを申請します。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
...
Suno Tasks API は、Suno Audios Generation API と Suno Lyrics Generation API の結果を照会するために使用できます。Suno Audios Generation API の使用方法については、文書 [Suno Audios Generation API ](https://platform.acedata.cloud/documents/suno-audios-integration) を参照してください。Suno Lyrics Generation API の使用方法については、[Suno Lyrics Generation API ](https://platform.acedata.cloud/documents/suno-lyrics-generation-integration) を参照してください。
