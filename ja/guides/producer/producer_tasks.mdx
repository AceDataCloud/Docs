...
最後に、Tasks API ページ [Producer Tasks API ](https://platform.acedata.cloud/documents/producer-tasks) にアクセスし、該当するサービスを申請します。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
