...
APIを使用するには、まず[Wan Videos Generation API](https://platform.acedata.cloud/documents/wan-videos)の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
