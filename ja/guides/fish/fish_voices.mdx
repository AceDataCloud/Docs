...
API を使用するには、まず [Fish Voices Generation API](https://platform.acedata.cloud/documents/fish-voices) の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
