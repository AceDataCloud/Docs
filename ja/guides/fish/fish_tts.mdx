...
APIを使用するには、まず [Fish TTS API](https://platform.acedata.cloud/services/fish) の対応ページからサービスを申請します。ページにアクセスしたら、「Acquire」ボタンをクリックしてください。
...
また、[Fish Tasks API](https://platform.acedata.cloud/documents/fish-tasks) を利用して `task_id` でステータスをポーリングすることも可能です。
