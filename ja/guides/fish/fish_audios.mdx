...
APIを使用するには、まず [Fish Audios Generation API](https://platform.acedata.cloud/documents/fish-audios) の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
