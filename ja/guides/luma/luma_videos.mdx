...
Luma Videos API を使用するには、まず [Luma Videos Generation API](https://platform.acedata.cloud/documents/luma-videos) ページにアクセスし、「Acquire」ボタンをクリックして、リクエストに必要な認証情報を取得します：
