...
この文書では、Hailuo Tasks API の接続説明を詳しく紹介し、簡単に統合し、この API の強力な機能を十分に活用できるようにします。Hailuo Tasks API を使用することで、Hailuo Videos Generation API のタスク実行状況を簡単に照会できます。
...
> 📘 完全な文書：[Hailuo Videos Generation API →](https://platform.acedata.cloud/documents/hailuo-videos-integration)

## リクエスト例

Hailuo Tasks API は、Hailuo Videos Generation API の結果を照会するために使用できます。Hailuo Videos Generation API の使用方法については、文書 [Hailuo Videos Generation API ](https://platform.acedata.cloud/documents/hailuo-videos-generation-integration) を参照してください。
...
本ドキュメントを通じて、Hailuo Tasks APIを使用して単一またはバッチのビデオタスクのすべての具体的な詳細情報を照会する方法を理解しました。このドキュメントがAPIの接続と使用に役立つことを願っています。ご不明な点がございましたら、いつでも技術サポートチームにお問い合わせください。
