...
SeeDance Video Generation API サービスから返されたタスクIDを例に、どのようにこの API を使用するかを示します。タスクID：20068983-0cc9-4c6a-aeb6-9c6a3c668be0 があると仮定し、次にタスクIDを渡す方法を示します。
...
```json
{
    ...
    "request": {
        ...
        "content": [
            {
                "type": "text",
                "text": "複数のショット。一人の探偵が薄暗い部屋に入る。彼はテーブルの上の手がかりを調べ、テーブルの上の何かを手に取る。カメラは彼が考え込んでいるところに切り替わる。 --ratio 16:9"
            }
        ],
        "callback_url": "dummy"
    },
    ...
    "items": [
        {
            ...
            "request": {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": "複数のショット。探偵が薄暗い部屋に入る。彼はテーブルの手がかりを調べ、テーブルの上の物を手に取る。カメラは彼が考え込んでいる様子に切り替わる。 --ratio 16:9"
                    }
                ],
                "callback_url": "dummy"
            },
