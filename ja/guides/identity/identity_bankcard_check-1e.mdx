...
API を使用するには、まず [銀行カード基本情報照会 API](https://platform.acedata.cloud/documents/identity-bankcard-check-1e) の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
