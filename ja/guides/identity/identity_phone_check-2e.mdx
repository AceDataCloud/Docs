...
API を使用するには、まず [携帯番号二要素確認 API](https://platform.acedata.cloud/documents/identity-phone-check-2e) の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
