...
APIを使用するには、まず [銀行カード二要素確認 API](https://platform.acedata.cloud/documents/identity-bankcard-check-2e) の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
