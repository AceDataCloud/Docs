...
API を使用するには、まず [身分証識別及び情報検証 API](https://platform.acedata.cloud/documents/identity-idcard-ocr) の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
