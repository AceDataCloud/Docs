...
API を使用するには、まず [Recaptcha3 プロトコル認識 API](https://platform.acedata.cloud/documents/captcha-token-recaptcha3) の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
