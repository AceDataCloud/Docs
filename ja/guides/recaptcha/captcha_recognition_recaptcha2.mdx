...
API を使用するには、まず [Recaptcha2 画像認識 API](https://platform.acedata.cloud/documents/captcha-recognition-recaptcha2) の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
