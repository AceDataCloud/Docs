...
Midjourney Shorten APIを利用するには、まず申請ページ [Midjourney Shorten API](https://platform.acedata.cloud/documents/midjourney-shorten) で該当サービスを申請してください。ページに入ったら、「Acquire」ボタンをクリックします。
