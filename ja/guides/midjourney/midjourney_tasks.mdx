...
Midjourney Tasks API を使用するには、まず申請ページ [Midjourney Imagine API ](https://platform.acedata.cloud/documents/midjourney-imagine) で該当するサービスを申請し、次に Imagine API のタスクIDをコピーします。以下の図のように：

<p><img src="https://cdn.acedata.cloud/lx4mwb.png" width="500" className="m-auto" /></p>

最後に、Tasks API ページ [Midjourney Tasks API ](https://platform.acedata.cloud/documents/midjourney-tasks) にアクセスし、該当するサービスを申請します。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
