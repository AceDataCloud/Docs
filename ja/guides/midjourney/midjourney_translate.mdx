...
Midjourney Translate API を使用するには、まず申請ページ [Midjourney Translate API](https://platform.acedata.cloud/documents/midjourney-translate) にアクセスして、該当するサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
