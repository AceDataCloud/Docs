...
API を使用するには、まず [Sora Videos Generation API](https://platform.acedata.cloud/documents/sora-videos) の該当ページでサービスを申請してください。ページにアクセス後、「Acquire」ボタンをクリックします。以下の画像のように表示されます：
